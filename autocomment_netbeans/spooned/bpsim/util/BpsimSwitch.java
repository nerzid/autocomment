            ...
            case BpsimPackage.BETA_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(betaDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(betaDistributionType);
            ...
            case BpsimPackage.BINOMIAL_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(binomialDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(binomialDistributionType);
            ...
            case BpsimPackage.BOOLEAN_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseConstantParameter(booleanParameterType);
                    
                    if (result == null)
                        result = caseParameterValue(booleanParameterType);
            ...
            case BpsimPackage.CONSTANT_PARAMETER :
                {
                    ...
                    if (result == null)
                        result = caseParameterValue(constantParameter);
            ...
            case BpsimPackage.DATE_TIME_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseConstantParameter(dateTimeParameterType);
                    
                    if (result == null)
                        result = caseParameterValue(dateTimeParameterType);
            ...
            case BpsimPackage.DISTRIBUTION_PARAMETER :
                {
                    ...
                    if (result == null)
                        result = caseParameterValue(distributionParameter);
            ...
            case BpsimPackage.DURATION_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseConstantParameter(durationParameterType);
                    
                    if (result == null)
                        result = caseParameterValue(durationParameterType);
            ...
            case BpsimPackage.ELEMENT_PARAMETERS_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseElementParameters(elementParametersType);
            ...
            case BpsimPackage.ENUM_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseParameterValue(enumParameterType);
            ...
            case BpsimPackage.ERLANG_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(erlangDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(erlangDistributionType);
            ...
            case BpsimPackage.EXPRESSION_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseParameterValue(expressionParameterType);
            ...
            case BpsimPackage.FLOATING_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseConstantParameter(floatingParameterType);
                    
                    if (result == null)
                        result = caseParameterValue(floatingParameterType);
            ...
            case BpsimPackage.GAMMA_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(gammaDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(gammaDistributionType);
            ...
            case BpsimPackage.LOG_NORMAL_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(logNormalDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(logNormalDistributionType);
            ...
            case BpsimPackage.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(negativeExponentialDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(negativeExponentialDistributionType);
            ...
            case BpsimPackage.NORMAL_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(normalDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(normalDistributionType);
            ...
            case BpsimPackage.NUMERIC_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseConstantParameter(numericParameterType);
                    
                    if (result == null)
                        result = caseParameterValue(numericParameterType);
            ...
            case BpsimPackage.POISSON_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(poissonDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(poissonDistributionType);
            ...
            case BpsimPackage.PROPERTY_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseParameter(propertyType);
            ...
            case BpsimPackage.SCENARIO_PARAMETERS_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseScenarioParameters(scenarioParametersType);
            ...
            case BpsimPackage.STRING_PARAMETER_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseConstantParameter(stringParameterType);
                    
                    if (result == null)
                        result = caseParameterValue(stringParameterType);
            ...
            case BpsimPackage.TRIANGULAR_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(triangularDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(triangularDistributionType);
            ...
            case BpsimPackage.TRUNCATED_NORMAL_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(truncatedNormalDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(truncatedNormalDistributionType);
            ...
            case BpsimPackage.UNIFORM_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(uniformDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(uniformDistributionType);
            ...
            case BpsimPackage.USER_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(userDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(userDistributionType);
            ...
            case BpsimPackage.WEIBULL_DISTRIBUTION_TYPE :
                {
                    ...
                    if (result == null)
                        result = caseDistributionParameter(weibullDistributionType);
                    
                    if (result == null)
                        result = caseParameterValue(weibullDistributionType);
