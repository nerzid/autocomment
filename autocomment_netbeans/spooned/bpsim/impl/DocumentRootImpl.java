...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
    ...
    public FeatureMap getMixed() {
        if ((mixed) == null) {
            mixed = new org.eclipse.emf.ecore.util.BasicFeatureMap(DocumentRootImpl.this, BpsimPackage.DOCUMENT_ROOT__MIXED);
        } 
        return mixed;
    }
    ...
    public EMap<String, String> getXMLNSPrefixMap() {
        if ((xMLNSPrefixMap) == null) {
            xMLNSPrefixMap = new org.eclipse.emf.ecore.util.EcoreEMap<String, String>(Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, DocumentRootImpl.this, BpsimPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
        } 
    ...
    public EMap<String, String> getXSISchemaLocation() {
        if ((xSISchemaLocation) == null) {
            xSISchemaLocation = new org.eclipse.emf.ecore.util.EcoreEMap<String, String>(Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, DocumentRootImpl.this, BpsimPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
        } 
