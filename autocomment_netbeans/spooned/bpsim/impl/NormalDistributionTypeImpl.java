...
public class NormalDistributionTypeImpl extends DistributionParameterImpl implements NormalDistributionType {
     ...
     * @ordered
     */
    protected double mean = NormalDistributionTypeImpl.MEAN_EDEFAULT;
     ...
     * @ordered
     */
    protected double standardDeviation = NormalDistributionTypeImpl.STANDARD_DEVIATION_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.NORMAL_DISTRIBUTION_TYPE;
    }
    ...
    public void setMean(double newMean) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(NormalDistributionTypeImpl.this, Notification.SET, BpsimPackage.NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, (!oldMeanESet)));
    ...
    public void unsetMean() {
        double oldMean = mean;
        boolean oldMeanESet = meanESet;
        mean = NormalDistributionTypeImpl.MEAN_EDEFAULT;
        meanESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(NormalDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, NormalDistributionTypeImpl.MEAN_EDEFAULT, oldMeanESet));
    ...
    public void setStandardDeviation(double newStandardDeviation) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(NormalDistributionTypeImpl.this, Notification.SET, BpsimPackage.NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation, (!oldStandardDeviationESet)));
    ...
    public void unsetStandardDeviation() {
        double oldStandardDeviation = standardDeviation;
        boolean oldStandardDeviationESet = standardDeviationESet;
        standardDeviation = NormalDistributionTypeImpl.STANDARD_DEVIATION_EDEFAULT;
        standardDeviationESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(NormalDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, NormalDistributionTypeImpl.STANDARD_DEVIATION_EDEFAULT, oldStandardDeviationESet));
