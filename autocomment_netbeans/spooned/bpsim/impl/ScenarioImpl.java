...
public class ScenarioImpl extends EObjectImpl implements Scenario {
     ...
     * @ordered
     */
    protected String author = ScenarioImpl.AUTHOR_EDEFAULT;
     ...
     * @ordered
     */
    protected Object created = ScenarioImpl.CREATED_EDEFAULT;
     ...
     * @ordered
     */
    protected String description = ScenarioImpl.DESCRIPTION_EDEFAULT;
     ...
     * @ordered
     */
    protected String id = ScenarioImpl.ID_EDEFAULT;
     ...
     * @ordered
     */
    protected String inherits = ScenarioImpl.INHERITS_EDEFAULT;
     ...
     * @ordered
     */
    protected Object modified = ScenarioImpl.MODIFIED_EDEFAULT;
     ...
     * @ordered
     */
    protected String name = ScenarioImpl.NAME_EDEFAULT;
     ...
     * @ordered
     */
    protected String result = ScenarioImpl.RESULT_EDEFAULT;
     ...
     * @ordered
     */
    protected String vendor = ScenarioImpl.VENDOR_EDEFAULT;
     ...
     * @ordered
     */
    protected String version = ScenarioImpl.VERSION_EDEFAULT;
    ...
    public NotificationChain basicSetScenarioParameters(ScenarioParameters newScenarioParameters, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__SCENARIO_PARAMETERS, oldScenarioParameters, newScenarioParameters);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setScenarioParameters(ScenarioParameters newScenarioParameters) {
        if (newScenarioParameters != (scenarioParameters)) {
            ...
            if ((scenarioParameters) != null)
                msgs = ((InternalEObject) (scenarioParameters)).eInverseRemove(ScenarioImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO__SCENARIO_PARAMETERS)), null, msgs);
            
            if (newScenarioParameters != null)
                msgs = ((InternalEObject) (newScenarioParameters)).eInverseAdd(ScenarioImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO__SCENARIO_PARAMETERS)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__SCENARIO_PARAMETERS, newScenarioParameters, newScenarioParameters));
    ...
    public EList<ElementParameters> getElementParameters() {
        if ((elementParameters) == null) {
            elementParameters = new org.eclipse.emf.ecore.util.EObjectContainmentEList<ElementParameters>(ElementParameters.class, ScenarioImpl.this, BpsimPackage.SCENARIO__ELEMENT_PARAMETERS);
        } 
    ...
    public EList<Calendar> getCalendar() {
        if ((calendar) == null) {
            calendar = new org.eclipse.emf.ecore.util.EObjectContainmentEList<Calendar>(Calendar.class, ScenarioImpl.this, BpsimPackage.SCENARIO__CALENDAR);
        } 
        return calendar;
    }
    ...
    public EList<VendorExtension> getVendorExtension() {
        if ((vendorExtension) == null) {
            vendorExtension = new org.eclipse.emf.ecore.util.EObjectContainmentEList<VendorExtension>(VendorExtension.class, ScenarioImpl.this, BpsimPackage.SCENARIO__VENDOR_EXTENSION);
        } 
    ...
    public void setAuthor(String newAuthor) {
        ...
        author = newAuthor;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__AUTHOR, oldAuthor, author));
    ...
    public void setCreated(Object newCreated) {
        ...
        created = newCreated;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__CREATED, oldCreated, created));
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__DESCRIPTION, oldDescription, description));
    ...
    public void setId(String newId) {
        ...
        id = newId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__ID, oldId, id));
    ...
    public void setInherits(String newInherits) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__INHERITS, oldInherits, inherits));
    ...
    public void setModified(Object newModified) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__MODIFIED, oldModified, modified));
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__NAME, oldName, name));
    ...
    public void setResult(String newResult) {
        ...
        result = newResult;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__RESULT, oldResult, result));
    ...
    public void setVendor(String newVendor) {
        ...
        vendor = newVendor;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__VENDOR, oldVendor, vendor));
    ...
    public void setVersion(String newVersion) {
        ...
        version = newVersion;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioImpl.this, Notification.SET, BpsimPackage.SCENARIO__VERSION, oldVersion, version));
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case BpsimPackage.SCENARIO__VENDOR_EXTENSION :
                ...
                return ;
            case BpsimPackage.SCENARIO__AUTHOR :
                setAuthor(ScenarioImpl.AUTHOR_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__CREATED :
                setCreated(ScenarioImpl.CREATED_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__DESCRIPTION :
                setDescription(ScenarioImpl.DESCRIPTION_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__ID :
                setId(ScenarioImpl.ID_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__INHERITS :
                setInherits(ScenarioImpl.INHERITS_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__MODIFIED :
                setModified(ScenarioImpl.MODIFIED_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__NAME :
                setName(ScenarioImpl.NAME_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__RESULT :
                setResult(ScenarioImpl.RESULT_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__VENDOR :
                setVendor(ScenarioImpl.VENDOR_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO__VERSION :
                setVersion(ScenarioImpl.VERSION_EDEFAULT);
                return ;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case BpsimPackage.SCENARIO__AUTHOR :
                return (ScenarioImpl.AUTHOR_EDEFAULT) == null ? (author) != null : !(ScenarioImpl.AUTHOR_EDEFAULT.equals(author));
            case BpsimPackage.SCENARIO__CREATED :
                return (ScenarioImpl.CREATED_EDEFAULT) == null ? (created) != null : !(ScenarioImpl.CREATED_EDEFAULT.equals(created));
            case BpsimPackage.SCENARIO__DESCRIPTION :
                return (ScenarioImpl.DESCRIPTION_EDEFAULT) == null ? (description) != null : !(ScenarioImpl.DESCRIPTION_EDEFAULT.equals(description));
            case BpsimPackage.SCENARIO__ID :
                return (ScenarioImpl.ID_EDEFAULT) == null ? (id) != null : !(ScenarioImpl.ID_EDEFAULT.equals(id));
            case BpsimPackage.SCENARIO__INHERITS :
                return (ScenarioImpl.INHERITS_EDEFAULT) == null ? (inherits) != null : !(ScenarioImpl.INHERITS_EDEFAULT.equals(inherits));
            case BpsimPackage.SCENARIO__MODIFIED :
                return (ScenarioImpl.MODIFIED_EDEFAULT) == null ? (modified) != null : !(ScenarioImpl.MODIFIED_EDEFAULT.equals(modified));
            case BpsimPackage.SCENARIO__NAME :
                return (ScenarioImpl.NAME_EDEFAULT) == null ? (name) != null : !(ScenarioImpl.NAME_EDEFAULT.equals(name));
            case BpsimPackage.SCENARIO__RESULT :
                return (ScenarioImpl.RESULT_EDEFAULT) == null ? (result) != null : !(ScenarioImpl.RESULT_EDEFAULT.equals(result));
            case BpsimPackage.SCENARIO__VENDOR :
                return (ScenarioImpl.VENDOR_EDEFAULT) == null ? (vendor) != null : !(ScenarioImpl.VENDOR_EDEFAULT.equals(vendor));
            case BpsimPackage.SCENARIO__VERSION :
                return (ScenarioImpl.VERSION_EDEFAULT) == null ? (version) != null : !(ScenarioImpl.VERSION_EDEFAULT.equals(version));
        }
