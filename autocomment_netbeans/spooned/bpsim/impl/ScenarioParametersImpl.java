...
public class ScenarioParametersImpl extends EObjectImpl implements ScenarioParameters {
     ...
     * @ordered
     */
    protected String baseCurrencyUnit = ScenarioParametersImpl.BASE_CURRENCY_UNIT_EDEFAULT;
     ...
     * @ordered
     */
    protected TimeUnit baseTimeUnit = ScenarioParametersImpl.BASE_TIME_UNIT_EDEFAULT;
     ...
     * @ordered
     */
    protected int replication = ScenarioParametersImpl.REPLICATION_EDEFAULT;
     ...
     * @ordered
     */
    protected long seed = ScenarioParametersImpl.SEED_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.SCENARIO_PARAMETERS;
    }
    ...
    public NotificationChain basicSetStart(Parameter newStart, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__START, oldStart, newStart);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setStart(Parameter newStart) {
        if (newStart != (start)) {
            ...
            if ((start) != null)
                msgs = ((InternalEObject) (start)).eInverseRemove(ScenarioParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO_PARAMETERS__START)), null, msgs);
            
            if (newStart != null)
                msgs = ((InternalEObject) (newStart)).eInverseAdd(ScenarioParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO_PARAMETERS__START)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__START, newStart, newStart));
    ...
    public NotificationChain basicSetDuration(Parameter newDuration, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__DURATION, oldDuration, newDuration);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDuration(Parameter newDuration) {
        if (newDuration != (duration)) {
            NotificationChain msgs = null;
            if ((duration) != null)
                msgs = ((InternalEObject) (duration)).eInverseRemove(ScenarioParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO_PARAMETERS__DURATION)), null, msgs);
            
            if (newDuration != null)
                msgs = ((InternalEObject) (newDuration)).eInverseAdd(ScenarioParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO_PARAMETERS__DURATION)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__DURATION, newDuration, newDuration));
    ...
    public NotificationChain basicSetPropertyParameters(PropertyParameters newPropertyParameters, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS, oldPropertyParameters, newPropertyParameters);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setPropertyParameters(PropertyParameters newPropertyParameters) {
        if (newPropertyParameters != (propertyParameters)) {
            ...
            if ((propertyParameters) != null)
                msgs = ((InternalEObject) (propertyParameters)).eInverseRemove(ScenarioParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS)), null, msgs);
            
            if (newPropertyParameters != null)
                msgs = ((InternalEObject) (newPropertyParameters)).eInverseAdd(ScenarioParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS, newPropertyParameters, newPropertyParameters));
    ...
    public void setBaseCurrencyUnit(String newBaseCurrencyUnit) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__BASE_CURRENCY_UNIT, oldBaseCurrencyUnit, baseCurrencyUnit));
    ...
    public void setBaseTimeUnit(TimeUnit newBaseTimeUnit) {
        ...
        baseTimeUnit = (newBaseTimeUnit == null) ? ScenarioParametersImpl.BASE_TIME_UNIT_EDEFAULT : newBaseTimeUnit;
        boolean oldBaseTimeUnitESet = baseTimeUnitESet;
        baseTimeUnitESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__BASE_TIME_UNIT, oldBaseTimeUnit, baseTimeUnit, (!oldBaseTimeUnitESet)));
    ...
    public void unsetBaseTimeUnit() {
        TimeUnit oldBaseTimeUnit = baseTimeUnit;
        boolean oldBaseTimeUnitESet = baseTimeUnitESet;
        baseTimeUnit = ScenarioParametersImpl.BASE_TIME_UNIT_EDEFAULT;
        baseTimeUnitESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.UNSET, BpsimPackage.SCENARIO_PARAMETERS__BASE_TIME_UNIT, oldBaseTimeUnit, ScenarioParametersImpl.BASE_TIME_UNIT_EDEFAULT, oldBaseTimeUnitESet));
    ...
    public void setReplication(int newReplication) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__REPLICATION, oldReplication, replication, (!oldReplicationESet)));
    ...
    public void unsetReplication() {
        int oldReplication = replication;
        boolean oldReplicationESet = replicationESet;
        replication = ScenarioParametersImpl.REPLICATION_EDEFAULT;
        replicationESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.UNSET, BpsimPackage.SCENARIO_PARAMETERS__REPLICATION, oldReplication, ScenarioParametersImpl.REPLICATION_EDEFAULT, oldReplicationESet));
    ...
    public void setSeed(long newSeed) {
        ...
        seedESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.SET, BpsimPackage.SCENARIO_PARAMETERS__SEED, oldSeed, seed, (!oldSeedESet)));
    ...
    public void unsetSeed() {
        long oldSeed = seed;
        boolean oldSeedESet = seedESet;
        seed = ScenarioParametersImpl.SEED_EDEFAULT;
        seedESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(ScenarioParametersImpl.this, Notification.UNSET, BpsimPackage.SCENARIO_PARAMETERS__SEED, oldSeed, ScenarioParametersImpl.SEED_EDEFAULT, oldSeedESet));
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case BpsimPackage.SCENARIO_PARAMETERS__PROPERTY_PARAMETERS :
                ...
                return ;
            case BpsimPackage.SCENARIO_PARAMETERS__BASE_CURRENCY_UNIT :
                setBaseCurrencyUnit(ScenarioParametersImpl.BASE_CURRENCY_UNIT_EDEFAULT);
                return ;
            case BpsimPackage.SCENARIO_PARAMETERS__BASE_TIME_UNIT :
                unsetBaseTimeUnit();
                return ;
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case BpsimPackage.SCENARIO_PARAMETERS__BASE_CURRENCY_UNIT :
                return (ScenarioParametersImpl.BASE_CURRENCY_UNIT_EDEFAULT) == null ? (baseCurrencyUnit) != null : !(ScenarioParametersImpl.BASE_CURRENCY_UNIT_EDEFAULT.equals(baseCurrencyUnit));
            case BpsimPackage.SCENARIO_PARAMETERS__BASE_TIME_UNIT :
