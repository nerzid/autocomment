...
public class BinomialDistributionTypeImpl extends DistributionParameterImpl implements BinomialDistributionType {
     ...
     * @ordered
     */
    protected double probability = BinomialDistributionTypeImpl.PROBABILITY_EDEFAULT;
     ...
     * @ordered
     */
    protected long trials = BinomialDistributionTypeImpl.TRIALS_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.BINOMIAL_DISTRIBUTION_TYPE;
    }
    ...
    public void setProbability(double newProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(BinomialDistributionTypeImpl.this, Notification.SET, BpsimPackage.BINOMIAL_DISTRIBUTION_TYPE__PROBABILITY, oldProbability, probability, (!oldProbabilityESet)));
    ...
    public void unsetProbability() {
        double oldProbability = probability;
        boolean oldProbabilityESet = probabilityESet;
        probability = BinomialDistributionTypeImpl.PROBABILITY_EDEFAULT;
        probabilityESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(BinomialDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.BINOMIAL_DISTRIBUTION_TYPE__PROBABILITY, oldProbability, BinomialDistributionTypeImpl.PROBABILITY_EDEFAULT, oldProbabilityESet));
    ...
    public void setTrials(long newTrials) {
        ...
        trialsESet = true;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(BinomialDistributionTypeImpl.this, Notification.SET, BpsimPackage.BINOMIAL_DISTRIBUTION_TYPE__TRIALS, oldTrials, trials, (!oldTrialsESet)));
    ...
    public void unsetTrials() {
        long oldTrials = trials;
        boolean oldTrialsESet = trialsESet;
        trials = BinomialDistributionTypeImpl.TRIALS_EDEFAULT;
        trialsESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(BinomialDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.BINOMIAL_DISTRIBUTION_TYPE__TRIALS, oldTrials, BinomialDistributionTypeImpl.TRIALS_EDEFAULT, oldTrialsESet));
