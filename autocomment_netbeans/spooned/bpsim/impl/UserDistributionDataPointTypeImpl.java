...
public class UserDistributionDataPointTypeImpl extends EObjectImpl implements UserDistributionDataPointType {
     ...
     * @ordered
     */
    protected float probability = UserDistributionDataPointTypeImpl.PROBABILITY_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.USER_DISTRIBUTION_DATA_POINT_TYPE;
    }
    ...
    public FeatureMap getParameterValueGroup() {
        if ((parameterValueGroup) == null) {
            parameterValueGroup = new org.eclipse.emf.ecore.util.BasicFeatureMap(UserDistributionDataPointTypeImpl.this, BpsimPackage.USER_DISTRIBUTION_DATA_POINT_TYPE__PARAMETER_VALUE_GROUP);
        } 
    ...
    public void setProbability(float newProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(UserDistributionDataPointTypeImpl.this, Notification.SET, BpsimPackage.USER_DISTRIBUTION_DATA_POINT_TYPE__PROBABILITY, oldProbability, probability, (!oldProbabilityESet)));
    ...
    public void unsetProbability() {
        float oldProbability = probability;
        boolean oldProbabilityESet = probabilityESet;
        probability = UserDistributionDataPointTypeImpl.PROBABILITY_EDEFAULT;
        probabilityESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(UserDistributionDataPointTypeImpl.this, Notification.UNSET, BpsimPackage.USER_DISTRIBUTION_DATA_POINT_TYPE__PROBABILITY, oldProbability, UserDistributionDataPointTypeImpl.PROBABILITY_EDEFAULT, oldProbabilityESet));
