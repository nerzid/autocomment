...
public class LogNormalDistributionTypeImpl extends DistributionParameterImpl implements LogNormalDistributionType {
     ...
     * @ordered
     */
    protected double mean = LogNormalDistributionTypeImpl.MEAN_EDEFAULT;
     ...
     * @ordered
     */
    protected double standardDeviation = LogNormalDistributionTypeImpl.STANDARD_DEVIATION_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.LOG_NORMAL_DISTRIBUTION_TYPE;
    }
    ...
    public void setMean(double newMean) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(LogNormalDistributionTypeImpl.this, Notification.SET, BpsimPackage.LOG_NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, (!oldMeanESet)));
    ...
    public void unsetMean() {
        double oldMean = mean;
        boolean oldMeanESet = meanESet;
        mean = LogNormalDistributionTypeImpl.MEAN_EDEFAULT;
        meanESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(LogNormalDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.LOG_NORMAL_DISTRIBUTION_TYPE__MEAN, oldMean, LogNormalDistributionTypeImpl.MEAN_EDEFAULT, oldMeanESet));
    ...
    public void setStandardDeviation(double newStandardDeviation) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(LogNormalDistributionTypeImpl.this, Notification.SET, BpsimPackage.LOG_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation, (!oldStandardDeviationESet)));
    ...
    public void unsetStandardDeviation() {
        double oldStandardDeviation = standardDeviation;
        boolean oldStandardDeviationESet = standardDeviationESet;
        standardDeviation = LogNormalDistributionTypeImpl.STANDARD_DEVIATION_EDEFAULT;
        standardDeviationESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(LogNormalDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.LOG_NORMAL_DISTRIBUTION_TYPE__STANDARD_DEVIATION, oldStandardDeviation, LogNormalDistributionTypeImpl.STANDARD_DEVIATION_EDEFAULT, oldStandardDeviationESet));
