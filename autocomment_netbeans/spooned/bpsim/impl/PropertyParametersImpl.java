...
public class PropertyParametersImpl extends EObjectImpl implements PropertyParameters {
    ...
    protected EClass eStaticClass() {
        return Literals.PROPERTY_PARAMETERS;
    }
    ...
    public EList<PropertyType> getProperty() {
        if ((property) == null) {
            property = new org.eclipse.emf.ecore.util.EObjectContainmentEList<PropertyType>(PropertyType.class, PropertyParametersImpl.this, BpsimPackage.PROPERTY_PARAMETERS__PROPERTY);
        } 
        return property;
    }
