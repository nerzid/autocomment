...
public class EnumParameterTypeImpl extends ParameterValueImpl implements EnumParameterType {
    ...
    protected EClass eStaticClass() {
        return Literals.ENUM_PARAMETER_TYPE;
    }
    ...
    public FeatureMap getGroup() {
        if ((group) == null) {
            group = new org.eclipse.emf.ecore.util.BasicFeatureMap(EnumParameterTypeImpl.this, BpsimPackage.ENUM_PARAMETER_TYPE__GROUP);
        } 
        return group;
    }
    ...
    public FeatureMap getParameterValueGroup() {
        return ((FeatureMap) (getGroup().<FeatureMap>list(BpsimPackage.Literals.ENUM_PARAMETER_TYPE__PARAMETER_VALUE_GROUP)));
    }
