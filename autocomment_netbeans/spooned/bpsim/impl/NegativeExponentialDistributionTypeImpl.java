...
public class NegativeExponentialDistributionTypeImpl extends DistributionParameterImpl implements NegativeExponentialDistributionType {
     ...
     * @ordered
     */
    protected double mean = NegativeExponentialDistributionTypeImpl.MEAN_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE;
    }
    ...
    public void setMean(double newMean) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(NegativeExponentialDistributionTypeImpl.this, Notification.SET, BpsimPackage.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, (!oldMeanESet)));
    ...
    public void unsetMean() {
        double oldMean = mean;
        boolean oldMeanESet = meanESet;
        mean = NegativeExponentialDistributionTypeImpl.MEAN_EDEFAULT;
        meanESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(NegativeExponentialDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE__MEAN, oldMean, NegativeExponentialDistributionTypeImpl.MEAN_EDEFAULT, oldMeanESet));
