...
public class PoissonDistributionTypeImpl extends DistributionParameterImpl implements PoissonDistributionType {
     ...
     * @ordered
     */
    protected double mean = PoissonDistributionTypeImpl.MEAN_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.POISSON_DISTRIBUTION_TYPE;
    }
    ...
    public void setMean(double newMean) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(PoissonDistributionTypeImpl.this, Notification.SET, BpsimPackage.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, mean, (!oldMeanESet)));
    ...
    public void unsetMean() {
        double oldMean = mean;
        boolean oldMeanESet = meanESet;
        mean = PoissonDistributionTypeImpl.MEAN_EDEFAULT;
        meanESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(PoissonDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, PoissonDistributionTypeImpl.MEAN_EDEFAULT, oldMeanESet));
