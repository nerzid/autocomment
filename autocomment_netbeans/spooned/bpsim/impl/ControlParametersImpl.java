...
public class ControlParametersImpl extends EObjectImpl implements ControlParameters {
    ...
    protected EClass eStaticClass() {
        return Literals.CONTROL_PARAMETERS;
    }
    ...
    public NotificationChain basicSetProbability(Parameter newProbability, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__PROBABILITY, oldProbability, newProbability);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setProbability(Parameter newProbability) {
        if (newProbability != (probability)) {
            ...
            if ((probability) != null)
                msgs = ((InternalEObject) (probability)).eInverseRemove(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__PROBABILITY)), null, msgs);
            
            if (newProbability != null)
                msgs = ((InternalEObject) (newProbability)).eInverseAdd(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__PROBABILITY)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__PROBABILITY, newProbability, newProbability));
    ...
    public NotificationChain basicSetCondition(Parameter newCondition, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__CONDITION, oldCondition, newCondition);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCondition(Parameter newCondition) {
        if (newCondition != (condition)) {
            NotificationChain msgs = null;
            if ((condition) != null)
                msgs = ((InternalEObject) (condition)).eInverseRemove(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__CONDITION)), null, msgs);
            
            if (newCondition != null)
                msgs = ((InternalEObject) (newCondition)).eInverseAdd(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__CONDITION)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__CONDITION, newCondition, newCondition));
    ...
    public NotificationChain basicSetInterTriggerTimer(Parameter newInterTriggerTimer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER, oldInterTriggerTimer, newInterTriggerTimer);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setInterTriggerTimer(Parameter newInterTriggerTimer) {
        if (newInterTriggerTimer != (interTriggerTimer)) {
            ...
            if ((interTriggerTimer) != null)
                msgs = ((InternalEObject) (interTriggerTimer)).eInverseRemove(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER)), null, msgs);
            
            if (newInterTriggerTimer != null)
                msgs = ((InternalEObject) (newInterTriggerTimer)).eInverseAdd(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__INTER_TRIGGER_TIMER, newInterTriggerTimer, newInterTriggerTimer));
    ...
    public NotificationChain basicSetTriggerCount(Parameter newTriggerCount, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__TRIGGER_COUNT, oldTriggerCount, newTriggerCount);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setTriggerCount(Parameter newTriggerCount) {
        if (newTriggerCount != (triggerCount)) {
            ...
            if ((triggerCount) != null)
                msgs = ((InternalEObject) (triggerCount)).eInverseRemove(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__TRIGGER_COUNT)), null, msgs);
            
            if (newTriggerCount != null)
                msgs = ((InternalEObject) (newTriggerCount)).eInverseAdd(ControlParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.CONTROL_PARAMETERS__TRIGGER_COUNT)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ControlParametersImpl.this, Notification.SET, BpsimPackage.CONTROL_PARAMETERS__TRIGGER_COUNT, newTriggerCount, newTriggerCount));
