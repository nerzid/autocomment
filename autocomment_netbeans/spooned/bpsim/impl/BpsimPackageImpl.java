...
public class BpsimPackageImpl extends EPackageImpl implements BpsimPackage {
    ...
    public static BpsimPackage init() {
        ...
        BpsimPackageImpl.isInited = true;
    ...
    public void initializePackageContents() {
        ...
        betaDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        binomialDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        booleanParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getConstantParameter());
        constantParameterEClass.getESuperTypes().add(BpsimPackageImpl.this.getParameterValue());
        dateTimeParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getConstantParameter());
        distributionParameterEClass.getESuperTypes().add(BpsimPackageImpl.this.getParameterValue());
        durationParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getConstantParameter());
        elementParametersTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getElementParameters());
        enumParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getParameterValue());
        erlangDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        expressionParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getParameterValue());
        floatingParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getConstantParameter());
        gammaDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        logNormalDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        negativeExponentialDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        normalDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        numericParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getConstantParameter());
        poissonDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        propertyTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getParameter());
        scenarioParametersTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getScenarioParameters());
        stringParameterTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getConstantParameter());
        triangularDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        truncatedNormalDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        uniformDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        userDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        weibullDistributionTypeEClass.getESuperTypes().add(BpsimPackageImpl.this.getDistributionParameter());
        ...
        initEReference(getBPSimDataType_Scenario(), BpsimPackageImpl.this.getScenario(), null, "scenario", null, 1, (-1), BPSimDataType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getControlParameters_Probability(), BpsimPackageImpl.this.getParameter(), null, "probability", null, 0, 1, ControlParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getControlParameters_Condition(), BpsimPackageImpl.this.getParameter(), null, "condition", null, 0, 1, ControlParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getControlParameters_InterTriggerTimer(), BpsimPackageImpl.this.getParameter(), null, "interTriggerTimer", null, 0, 1, ControlParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getControlParameters_TriggerCount(), BpsimPackageImpl.this.getParameter(), null, "triggerCount", null, 0, 1, ControlParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEClass(costParametersEClass, CostParameters.class, "CostParameters", (!(IS_ABSTRACT)), (!(IS_INTERFACE)), IS_GENERATED_INSTANCE_CLASS);
        initEReference(getCostParameters_FixedCost(), BpsimPackageImpl.this.getParameter(), null, "fixedCost", null, 0, 1, CostParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getCostParameters_UnitCost(), BpsimPackageImpl.this.getParameter(), null, "unitCost", null, 0, 1, CostParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEAttribute(getDistributionParameter_TimeUnit(), BpsimPackageImpl.this.getTimeUnit(), "timeUnit", null, 0, 1, DistributionParameter.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_UNSETTABLE, (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getDocumentRoot_BetaDistribution(), BpsimPackageImpl.this.getBetaDistributionType(), null, "betaDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_ParameterValue(), BpsimPackageImpl.this.getParameterValue(), null, "parameterValue", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_BinomialDistribution(), BpsimPackageImpl.this.getBinomialDistributionType(), null, "binomialDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_BooleanParameter(), BpsimPackageImpl.this.getBooleanParameterType(), null, "booleanParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_BPSimData(), BpsimPackageImpl.this.getBPSimDataType(), null, "bPSimData", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_DateTimeParameter(), BpsimPackageImpl.this.getDateTimeParameterType(), null, "dateTimeParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_DurationParameter(), BpsimPackageImpl.this.getDurationParameterType(), null, "durationParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_EnumParameter(), BpsimPackageImpl.this.getEnumParameterType(), null, "enumParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_ErlangDistribution(), BpsimPackageImpl.this.getErlangDistributionType(), null, "erlangDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_ExpressionParameter(), BpsimPackageImpl.this.getExpressionParameterType(), null, "expressionParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_FloatingParameter(), BpsimPackageImpl.this.getFloatingParameterType(), null, "floatingParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_GammaDistribution(), BpsimPackageImpl.this.getGammaDistributionType(), null, "gammaDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_LogNormalDistribution(), BpsimPackageImpl.this.getLogNormalDistributionType(), null, "logNormalDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_NegativeExponentialDistribution(), BpsimPackageImpl.this.getNegativeExponentialDistributionType(), null, "negativeExponentialDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_NormalDistribution(), BpsimPackageImpl.this.getNormalDistributionType(), null, "normalDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_NumericParameter(), BpsimPackageImpl.this.getNumericParameterType(), null, "numericParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_PoissonDistribution(), BpsimPackageImpl.this.getPoissonDistributionType(), null, "poissonDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_StringParameter(), BpsimPackageImpl.this.getStringParameterType(), null, "stringParameter", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_TriangularDistribution(), BpsimPackageImpl.this.getTriangularDistributionType(), null, "triangularDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_TruncatedNormalDistribution(), BpsimPackageImpl.this.getTruncatedNormalDistributionType(), null, "truncatedNormalDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_UniformDistribution(), BpsimPackageImpl.this.getUniformDistributionType(), null, "uniformDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_UserDistribution(), BpsimPackageImpl.this.getUserDistributionType(), null, "userDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_UserDistributionDataPoint(), BpsimPackageImpl.this.getUserDistributionDataPointType(), null, "userDistributionDataPoint", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_WeibullDistribution(), BpsimPackageImpl.this.getWeibullDistributionType(), null, "weibullDistribution", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getElementParameters_TimeParameters(), BpsimPackageImpl.this.getTimeParameters(), null, "timeParameters", null, 0, 1, ElementParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getElementParameters_ControlParameters(), BpsimPackageImpl.this.getControlParameters(), null, "controlParameters", null, 0, 1, ElementParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getElementParameters_ResourceParameters(), BpsimPackageImpl.this.getResourceParameters(), null, "resourceParameters", null, 0, 1, ElementParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getElementParameters_PriorityParameters(), BpsimPackageImpl.this.getPriorityParameters(), null, "priorityParameters", null, 0, 1, ElementParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getElementParameters_CostParameters(), BpsimPackageImpl.this.getCostParameters(), null, "costParameters", null, 0, 1, ElementParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getElementParameters_PropertyParameters(), BpsimPackageImpl.this.getPropertyParameters(), null, "propertyParameters", null, 0, 1, ElementParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getElementParameters_VendorExtension(), BpsimPackageImpl.this.getVendorExtension(), null, "vendorExtension", null, 0, (-1), ElementParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getEnumParameterType_ParameterValue(), BpsimPackageImpl.this.getParameterValue(), null, "parameterValue", null, 1, (-1), EnumParameterType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getFloatingParameterType_TimeUnit(), BpsimPackageImpl.this.getTimeUnit(), "timeUnit", null, 0, 1, FloatingParameterType.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_UNSETTABLE, (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEAttribute(getNumericParameterType_TimeUnit(), BpsimPackageImpl.this.getTimeUnit(), "timeUnit", null, 0, 1, NumericParameterType.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_UNSETTABLE, (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEAttribute(getParameter_ResultRequest(), BpsimPackageImpl.this.getResultType(), "resultRequest", null, 0, (-1), Parameter.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), (!(IS_UNIQUE)), (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getParameter_ParameterValue(), BpsimPackageImpl.this.getParameterValue(), null, "parameterValue", null, 0, (-1), Parameter.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getParameterValue_Result(), BpsimPackageImpl.this.getResultType(), "result", null, 0, 1, ParameterValue.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_UNSETTABLE, (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getPriorityParameters_Interruptible(), BpsimPackageImpl.this.getParameter(), null, "interruptible", null, 0, 1, PriorityParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getPriorityParameters_Priority(), BpsimPackageImpl.this.getParameter(), null, "priority", null, 0, 1, PriorityParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getPropertyParameters_Property(), BpsimPackageImpl.this.getPropertyType(), null, "property", null, 0, (-1), PropertyParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getResourceParameters_Selection(), BpsimPackageImpl.this.getParameter(), null, "selection", null, 0, 1, ResourceParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getResourceParameters_Availability(), BpsimPackageImpl.this.getParameter(), null, "availability", null, 0, 1, ResourceParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getResourceParameters_Quantity(), BpsimPackageImpl.this.getParameter(), null, "quantity", null, 0, 1, ResourceParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getResourceParameters_Role(), BpsimPackageImpl.this.getParameter(), null, "role", null, 0, (-1), ResourceParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEClass(scenarioEClass, Scenario.class, "Scenario", (!(IS_ABSTRACT)), (!(IS_INTERFACE)), IS_GENERATED_INSTANCE_CLASS);
        initEReference(getScenario_ScenarioParameters(), BpsimPackageImpl.this.getScenarioParameters(), null, "scenarioParameters", null, 0, 1, Scenario.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getScenario_ElementParameters(), BpsimPackageImpl.this.getElementParameters(), null, "elementParameters", null, 0, (-1), Scenario.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getScenario_Calendar(), BpsimPackageImpl.this.getCalendar(), null, "calendar", null, 0, (-1), Scenario.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getScenario_VendorExtension(), BpsimPackageImpl.this.getVendorExtension(), null, "vendorExtension", null, 0, (-1), Scenario.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getScenarioParameters_Start(), BpsimPackageImpl.this.getParameter(), null, "start", null, 0, 1, ScenarioParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getScenarioParameters_Duration(), BpsimPackageImpl.this.getParameter(), null, "duration", null, 0, 1, ScenarioParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getScenarioParameters_PropertyParameters(), BpsimPackageImpl.this.getPropertyParameters(), null, "propertyParameters", null, 0, 1, ScenarioParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEAttribute(getScenarioParameters_BaseTimeUnit(), BpsimPackageImpl.this.getTimeUnit(), "baseTimeUnit", null, 0, 1, ScenarioParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_UNSETTABLE, (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getTimeParameters_TransferTime(), BpsimPackageImpl.this.getParameter(), null, "transferTime", null, 0, 1, TimeParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getTimeParameters_QueueTime(), BpsimPackageImpl.this.getParameter(), null, "queueTime", null, 0, 1, TimeParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getTimeParameters_WaitTime(), BpsimPackageImpl.this.getParameter(), null, "waitTime", null, 0, 1, TimeParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getTimeParameters_SetUpTime(), BpsimPackageImpl.this.getParameter(), null, "setUpTime", null, 0, 1, TimeParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getTimeParameters_ProcessingTime(), BpsimPackageImpl.this.getParameter(), null, "processingTime", null, 0, 1, TimeParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getTimeParameters_ValidationTime(), BpsimPackageImpl.this.getParameter(), null, "validationTime", null, 0, 1, TimeParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEReference(getTimeParameters_ReworkTime(), BpsimPackageImpl.this.getParameter(), null, "reworkTime", null, 0, 1, TimeParameters.class, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        ...
        initEReference(getUserDistributionDataPointType_ParameterValue(), BpsimPackageImpl.this.getParameterValue(), null, "parameterValue", null, 1, 1, UserDistributionDataPointType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getUserDistributionType_UserDistributionDataPoint(), BpsimPackageImpl.this.getUserDistributionDataPointType(), null, "userDistributionDataPoint", null, 1, (-1), UserDistributionType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    protected void createExtendedMetaDataAnnotations() {
        ...
        addAnnotation(betaDistributionTypeEClass, source, new String[]{ "name" , "BetaDistribution_._type" , "kind" , "empty" });
        addAnnotation(getBetaDistributionType_Scale(), source, new String[]{ "kind" , "attribute" , "name" , "scale" });
        addAnnotation(getBetaDistributionType_Shape(), source, new String[]{ "kind" , "attribute" , "name" , "shape" });
        addAnnotation(binomialDistributionTypeEClass, source, new String[]{ "name" , "BinomialDistribution_._type" , "kind" , "empty" });
        addAnnotation(getBinomialDistributionType_Probability(), source, new String[]{ "kind" , "attribute" , "name" , "probability" });
        addAnnotation(getBinomialDistributionType_Trials(), source, new String[]{ "kind" , "attribute" , "name" , "trials" });
        addAnnotation(booleanParameterTypeEClass, source, new String[]{ "name" , "BooleanParameter_._type" , "kind" , "empty" });
        addAnnotation(getBooleanParameterType_Value(), source, new String[]{ "kind" , "attribute" , "name" , "value" });
        addAnnotation(bpSimDataTypeEClass, source, new String[]{ "name" , "BPSimData_._type" , "kind" , "elementOnly" });
        addAnnotation(getBPSimDataType_Group(), source, new String[]{ "kind" , "group" , "name" , "group:0" });
        addAnnotation(getBPSimDataType_Scenario(), source, new String[]{ "kind" , "element" , "name" , "Scenario" , "namespace" , "##targetNamespace" , "group" , "#group:0" });
        addAnnotation(calendarEClass, source, new String[]{ "name" , "Calendar" , "kind" , "simple" });
        addAnnotation(getCalendar_Value(), source, new String[]{ "name" , ":0" , "kind" , "simple" });
        addAnnotation(getCalendar_Id(), source, new String[]{ "kind" , "attribute" , "name" , "id" });
        addAnnotation(getCalendar_Name(), source, new String[]{ "kind" , "attribute" , "name" , "name" });
        addAnnotation(constantParameterEClass, source, new String[]{ "name" , "ConstantParameter" , "kind" , "empty" });
        addAnnotation(controlParametersEClass, source, new String[]{ "name" , "ControlParameters" , "kind" , "elementOnly" });
        addAnnotation(getControlParameters_Probability(), source, new String[]{ "kind" , "element" , "name" , "Probability" , "namespace" , "##targetNamespace" });
        addAnnotation(getControlParameters_Condition(), source, new String[]{ "kind" , "element" , "name" , "Condition" , "namespace" , "##targetNamespace" });
        addAnnotation(getControlParameters_InterTriggerTimer(), source, new String[]{ "kind" , "element" , "name" , "InterTriggerTimer" , "namespace" , "##targetNamespace" });
        addAnnotation(getControlParameters_TriggerCount(), source, new String[]{ "kind" , "element" , "name" , "TriggerCount" , "namespace" , "##targetNamespace" });
        addAnnotation(costParametersEClass, source, new String[]{ "name" , "CostParameters" , "kind" , "elementOnly" });
        addAnnotation(getCostParameters_FixedCost(), source, new String[]{ "kind" , "element" , "name" , "FixedCost" , "namespace" , "##targetNamespace" });
        addAnnotation(getCostParameters_UnitCost(), source, new String[]{ "kind" , "element" , "name" , "UnitCost" , "namespace" , "##targetNamespace" });
        addAnnotation(dateTimeParameterTypeEClass, source, new String[]{ "name" , "DateTimeParameter_._type" , "kind" , "empty" });
        addAnnotation(getDateTimeParameterType_Value(), source, new String[]{ "kind" , "attribute" , "name" , "value" });
        addAnnotation(distributionParameterEClass, source, new String[]{ "name" , "DistributionParameter" , "kind" , "empty" });
        addAnnotation(getDistributionParameter_CurrencyUnit(), source, new String[]{ "kind" , "attribute" , "name" , "currencyUnit" });
        addAnnotation(getDistributionParameter_TimeUnit(), source, new String[]{ "kind" , "attribute" , "name" , "timeUnit" });
        ...
        addAnnotation(getDocumentRoot_BetaDistribution(), source, new String[]{ "kind" , "element" , "name" , "BetaDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_ParameterValue(), source, new String[]{ "kind" , "element" , "name" , "ParameterValue" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_BinomialDistribution(), source, new String[]{ "kind" , "element" , "name" , "BinomialDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_BooleanParameter(), source, new String[]{ "kind" , "element" , "name" , "BooleanParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_BPSimData(), source, new String[]{ "kind" , "element" , "name" , "BPSimData" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_DateTimeParameter(), source, new String[]{ "kind" , "element" , "name" , "DateTimeParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_DurationParameter(), source, new String[]{ "kind" , "element" , "name" , "DurationParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_EnumParameter(), source, new String[]{ "kind" , "element" , "name" , "EnumParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_ErlangDistribution(), source, new String[]{ "kind" , "element" , "name" , "ErlangDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_ExpressionParameter(), source, new String[]{ "kind" , "element" , "name" , "ExpressionParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_FloatingParameter(), source, new String[]{ "kind" , "element" , "name" , "FloatingParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_GammaDistribution(), source, new String[]{ "kind" , "element" , "name" , "GammaDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_LogNormalDistribution(), source, new String[]{ "kind" , "element" , "name" , "LogNormalDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_NegativeExponentialDistribution(), source, new String[]{ "kind" , "element" , "name" , "NegativeExponentialDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_NormalDistribution(), source, new String[]{ "kind" , "element" , "name" , "NormalDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_NumericParameter(), source, new String[]{ "kind" , "element" , "name" , "NumericParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_PoissonDistribution(), source, new String[]{ "kind" , "element" , "name" , "PoissonDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_StringParameter(), source, new String[]{ "kind" , "element" , "name" , "StringParameter" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_TriangularDistribution(), source, new String[]{ "kind" , "element" , "name" , "TriangularDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_TruncatedNormalDistribution(), source, new String[]{ "kind" , "element" , "name" , "TruncatedNormalDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_UniformDistribution(), source, new String[]{ "kind" , "element" , "name" , "UniformDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_UserDistribution(), source, new String[]{ "kind" , "element" , "name" , "UserDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(getDocumentRoot_UserDistributionDataPoint(), source, new String[]{ "kind" , "element" , "name" , "UserDistributionDataPoint" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_WeibullDistribution(), source, new String[]{ "kind" , "element" , "name" , "WeibullDistribution" , "namespace" , "##targetNamespace" , "affiliation" , "ParameterValue" });
        addAnnotation(durationParameterTypeEClass, source, new String[]{ "name" , "DurationParameter_._type" , "kind" , "empty" });
        addAnnotation(getDurationParameterType_Value(), source, new String[]{ "kind" , "attribute" , "name" , "value" });
        addAnnotation(elementParametersEClass, source, new String[]{ "name" , "ElementParameters" , "kind" , "elementOnly" });
        addAnnotation(getElementParameters_TimeParameters(), source, new String[]{ "kind" , "element" , "name" , "TimeParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getElementParameters_ControlParameters(), source, new String[]{ "kind" , "element" , "name" , "ControlParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getElementParameters_ResourceParameters(), source, new String[]{ "kind" , "element" , "name" , "ResourceParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getElementParameters_PriorityParameters(), source, new String[]{ "kind" , "element" , "name" , "PriorityParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getElementParameters_CostParameters(), source, new String[]{ "kind" , "element" , "name" , "CostParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getElementParameters_PropertyParameters(), source, new String[]{ "kind" , "element" , "name" , "PropertyParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getElementParameters_VendorExtension(), source, new String[]{ "kind" , "element" , "name" , "VendorExtension" , "namespace" , "##targetNamespace" });
        addAnnotation(getElementParameters_ElementRef(), source, new String[]{ "kind" , "attribute" , "name" , "elementRef" });
        addAnnotation(getElementParameters_Id(), source, new String[]{ "kind" , "attribute" , "name" , "id" });
        addAnnotation(elementParametersTypeEClass, source, new String[]{ "name" , "ElementParametersType" , "kind" , "elementOnly" });
        addAnnotation(enumParameterTypeEClass, source, new String[]{ "name" , "EnumParameter_._type" , "kind" , "elementOnly" });
        addAnnotation(getEnumParameterType_Group(), source, new String[]{ "kind" , "group" , "name" , "group:3" });
        addAnnotation(getEnumParameterType_ParameterValueGroup(), source, new String[]{ "kind" , "group" , "name" , "ParameterValue:group" , "namespace" , "##targetNamespace" , "group" , "#group:3" });
        addAnnotation(getEnumParameterType_ParameterValue(), source, new String[]{ "kind" , "element" , "name" , "ParameterValue" , "namespace" , "##targetNamespace" , "group" , "ParameterValue:group" });
        addAnnotation(erlangDistributionTypeEClass, source, new String[]{ "name" , "ErlangDistribution_._type" , "kind" , "empty" });
        addAnnotation(getErlangDistributionType_K(), source, new String[]{ "kind" , "attribute" , "name" , "k" });
        addAnnotation(getErlangDistributionType_Mean(), source, new String[]{ "kind" , "attribute" , "name" , "mean" });
        addAnnotation(expressionParameterTypeEClass, source, new String[]{ "name" , "ExpressionParameter_._type" , "kind" , "empty" });
        addAnnotation(getExpressionParameterType_Value(), source, new String[]{ "kind" , "attribute" , "name" , "value" });
        addAnnotation(floatingParameterTypeEClass, source, new String[]{ "name" , "FloatingParameter_._type" , "kind" , "empty" });
        addAnnotation(getFloatingParameterType_CurrencyUnit(), source, new String[]{ "kind" , "attribute" , "name" , "currencyUnit" });
        addAnnotation(getFloatingParameterType_TimeUnit(), source, new String[]{ "kind" , "attribute" , "name" , "timeUnit" });
        addAnnotation(getFloatingParameterType_Value(), source, new String[]{ "kind" , "attribute" , "name" , "value" });
        addAnnotation(gammaDistributionTypeEClass, source, new String[]{ "name" , "GammaDistribution_._type" , "kind" , "empty" });
        addAnnotation(getGammaDistributionType_Scale(), source, new String[]{ "kind" , "attribute" , "name" , "scale" });
        addAnnotation(getGammaDistributionType_Shape(), source, new String[]{ "kind" , "attribute" , "name" , "shape" });
        addAnnotation(logNormalDistributionTypeEClass, source, new String[]{ "name" , "LogNormalDistribution_._type" , "kind" , "empty" });
        addAnnotation(getLogNormalDistributionType_Mean(), source, new String[]{ "kind" , "attribute" , "name" , "mean" });
        addAnnotation(getLogNormalDistributionType_StandardDeviation(), source, new String[]{ "kind" , "attribute" , "name" , "standardDeviation" });
        addAnnotation(negativeExponentialDistributionTypeEClass, source, new String[]{ "name" , "NegativeExponentialDistribution_._type" , "kind" , "empty" });
        addAnnotation(getNegativeExponentialDistributionType_Mean(), source, new String[]{ "kind" , "attribute" , "name" , "mean" });
        addAnnotation(normalDistributionTypeEClass, source, new String[]{ "name" , "NormalDistribution_._type" , "kind" , "empty" });
        addAnnotation(getNormalDistributionType_Mean(), source, new String[]{ "kind" , "attribute" , "name" , "mean" });
        addAnnotation(getNormalDistributionType_StandardDeviation(), source, new String[]{ "kind" , "attribute" , "name" , "standardDeviation" });
        addAnnotation(numericParameterTypeEClass, source, new String[]{ "name" , "NumericParameter_._type" , "kind" , "empty" });
        addAnnotation(getNumericParameterType_CurrencyUnit(), source, new String[]{ "kind" , "attribute" , "name" , "currencyUnit" });
        addAnnotation(getNumericParameterType_TimeUnit(), source, new String[]{ "kind" , "attribute" , "name" , "timeUnit" });
        addAnnotation(getNumericParameterType_Value(), source, new String[]{ "kind" , "attribute" , "name" , "value" });
        addAnnotation(parameterEClass, source, new String[]{ "name" , "Parameter" , "kind" , "elementOnly" });
        addAnnotation(getParameter_ResultRequest(), source, new String[]{ "kind" , "element" , "name" , "ResultRequest" , "namespace" , "##targetNamespace" });
        addAnnotation(getParameter_ParameterValueGroup(), source, new String[]{ "kind" , "group" , "name" , "ParameterValue:group" , "namespace" , "##targetNamespace" });
        addAnnotation(getParameter_ParameterValue(), source, new String[]{ "kind" , "element" , "name" , "ParameterValue" , "namespace" , "##targetNamespace" , "group" , "ParameterValue:group" });
        addAnnotation(getParameter_Kpi(), source, new String[]{ "kind" , "attribute" , "name" , "kpi" });
        addAnnotation(getParameter_Sla(), source, new String[]{ "kind" , "attribute" , "name" , "sla" });
        addAnnotation(parameterValueEClass, source, new String[]{ "name" , "ParameterValue" , "kind" , "empty" });
        addAnnotation(getParameterValue_Instance(), source, new String[]{ "kind" , "attribute" , "name" , "instance" });
        addAnnotation(getParameterValue_Result(), source, new String[]{ "kind" , "attribute" , "name" , "result" });
        addAnnotation(getParameterValue_ValidFor(), source, new String[]{ "kind" , "attribute" , "name" , "validFor" });
        addAnnotation(poissonDistributionTypeEClass, source, new String[]{ "name" , "PoissonDistribution_._type" , "kind" , "empty" });
        addAnnotation(getPoissonDistributionType_Mean(), source, new String[]{ "kind" , "attribute" , "name" , "mean" });
        addAnnotation(priorityParametersEClass, source, new String[]{ "name" , "PriorityParameters" , "kind" , "elementOnly" });
        addAnnotation(getPriorityParameters_Interruptible(), source, new String[]{ "kind" , "element" , "name" , "Interruptible" , "namespace" , "##targetNamespace" });
        addAnnotation(getPriorityParameters_Priority(), source, new String[]{ "kind" , "element" , "name" , "Priority" , "namespace" , "##targetNamespace" });
        addAnnotation(propertyParametersEClass, source, new String[]{ "name" , "PropertyParameters" , "kind" , "elementOnly" });
        addAnnotation(getPropertyParameters_Property(), source, new String[]{ "kind" , "element" , "name" , "Property" , "namespace" , "##targetNamespace" });
        addAnnotation(propertyTypeEClass, source, new String[]{ "name" , "Property_._type" , "kind" , "elementOnly" });
        addAnnotation(getPropertyType_Name(), source, new String[]{ "kind" , "attribute" , "name" , "name" });
        addAnnotation(resourceParametersEClass, source, new String[]{ "name" , "ResourceParameters" , "kind" , "elementOnly" });
        addAnnotation(getResourceParameters_Selection(), source, new String[]{ "kind" , "element" , "name" , "Selection" , "namespace" , "##targetNamespace" });
        addAnnotation(getResourceParameters_Availability(), source, new String[]{ "kind" , "element" , "name" , "Availability" , "namespace" , "##targetNamespace" });
        addAnnotation(getResourceParameters_Quantity(), source, new String[]{ "kind" , "element" , "name" , "Quantity" , "namespace" , "##targetNamespace" });
        addAnnotation(getResourceParameters_Role(), source, new String[]{ "kind" , "element" , "name" , "Role" , "namespace" , "##targetNamespace" });
        addAnnotation(resultTypeEEnum, source, new String[]{ "name" , "ResultType" });
        addAnnotation(resultTypeObjectEDataType, source, new String[]{ "name" , "ResultType:Object" , "baseType" , "ResultType" });
        addAnnotation(scenarioEClass, source, new String[]{ "name" , "Scenario" , "kind" , "elementOnly" });
        addAnnotation(getScenario_ScenarioParameters(), source, new String[]{ "kind" , "element" , "name" , "ScenarioParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getScenario_ElementParameters(), source, new String[]{ "kind" , "element" , "name" , "ElementParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getScenario_Calendar(), source, new String[]{ "kind" , "element" , "name" , "Calendar" , "namespace" , "##targetNamespace" });
        addAnnotation(getScenario_VendorExtension(), source, new String[]{ "kind" , "element" , "name" , "VendorExtension" , "namespace" , "##targetNamespace" });
        addAnnotation(getScenario_Author(), source, new String[]{ "kind" , "attribute" , "name" , "author" });
        addAnnotation(getScenario_Created(), source, new String[]{ "kind" , "attribute" , "name" , "created" });
        addAnnotation(getScenario_Description(), source, new String[]{ "kind" , "attribute" , "name" , "description" });
        addAnnotation(getScenario_Id(), source, new String[]{ "kind" , "attribute" , "name" , "id" });
        addAnnotation(getScenario_Inherits(), source, new String[]{ "kind" , "attribute" , "name" , "inherits" });
        addAnnotation(getScenario_Modified(), source, new String[]{ "kind" , "attribute" , "name" , "modified" });
        addAnnotation(getScenario_Name(), source, new String[]{ "kind" , "attribute" , "name" , "name" });
        addAnnotation(getScenario_Result(), source, new String[]{ "kind" , "attribute" , "name" , "result" });
        addAnnotation(getScenario_Vendor(), source, new String[]{ "kind" , "attribute" , "name" , "vendor" });
        addAnnotation(getScenario_Version(), source, new String[]{ "kind" , "attribute" , "name" , "version" });
        addAnnotation(scenarioParametersEClass, source, new String[]{ "name" , "ScenarioParameters" , "kind" , "elementOnly" });
        addAnnotation(getScenarioParameters_Start(), source, new String[]{ "kind" , "element" , "name" , "Start" , "namespace" , "##targetNamespace" });
        addAnnotation(getScenarioParameters_Duration(), source, new String[]{ "kind" , "element" , "name" , "Duration" , "namespace" , "##targetNamespace" });
        addAnnotation(getScenarioParameters_PropertyParameters(), source, new String[]{ "kind" , "element" , "name" , "PropertyParameters" , "namespace" , "##targetNamespace" });
        addAnnotation(getScenarioParameters_BaseCurrencyUnit(), source, new String[]{ "kind" , "attribute" , "name" , "baseCurrencyUnit" });
        addAnnotation(getScenarioParameters_BaseTimeUnit(), source, new String[]{ "kind" , "attribute" , "name" , "baseTimeUnit" });
        addAnnotation(getScenarioParameters_Replication(), source, new String[]{ "kind" , "attribute" , "name" , "replication" });
        addAnnotation(getScenarioParameters_Seed(), source, new String[]{ "kind" , "attribute" , "name" , "seed" });
        addAnnotation(scenarioParametersTypeEClass, source, new String[]{ "name" , "ScenarioParameters_._type" , "kind" , "elementOnly" });
        addAnnotation(stringParameterTypeEClass, source, new String[]{ "name" , "StringParameter_._type" , "kind" , "empty" });
        addAnnotation(getStringParameterType_Value(), source, new String[]{ "kind" , "attribute" , "name" , "value" });
        addAnnotation(timeParametersEClass, source, new String[]{ "name" , "TimeParameters" , "kind" , "elementOnly" });
        addAnnotation(getTimeParameters_TransferTime(), source, new String[]{ "kind" , "element" , "name" , "TransferTime" , "namespace" , "##targetNamespace" });
        addAnnotation(getTimeParameters_QueueTime(), source, new String[]{ "kind" , "element" , "name" , "QueueTime" , "namespace" , "##targetNamespace" });
        addAnnotation(getTimeParameters_WaitTime(), source, new String[]{ "kind" , "element" , "name" , "WaitTime" , "namespace" , "##targetNamespace" });
        addAnnotation(getTimeParameters_SetUpTime(), source, new String[]{ "kind" , "element" , "name" , "SetUpTime" , "namespace" , "##targetNamespace" });
        addAnnotation(getTimeParameters_ProcessingTime(), source, new String[]{ "kind" , "element" , "name" , "ProcessingTime" , "namespace" , "##targetNamespace" });
        addAnnotation(getTimeParameters_ValidationTime(), source, new String[]{ "kind" , "element" , "name" , "ValidationTime" , "namespace" , "##targetNamespace" });
        addAnnotation(getTimeParameters_ReworkTime(), source, new String[]{ "kind" , "element" , "name" , "ReworkTime" , "namespace" , "##targetNamespace" });
        addAnnotation(timeUnitEEnum, source, new String[]{ "name" , "TimeUnit" });
        addAnnotation(timeUnitObjectEDataType, source, new String[]{ "name" , "TimeUnit:Object" , "baseType" , "TimeUnit" });
        addAnnotation(triangularDistributionTypeEClass, source, new String[]{ "name" , "TriangularDistribution_._type" , "kind" , "empty" });
        addAnnotation(getTriangularDistributionType_Max(), source, new String[]{ "kind" , "attribute" , "name" , "max" });
        addAnnotation(getTriangularDistributionType_Min(), source, new String[]{ "kind" , "attribute" , "name" , "min" });
        addAnnotation(getTriangularDistributionType_Mode(), source, new String[]{ "kind" , "attribute" , "name" , "mode" });
        addAnnotation(truncatedNormalDistributionTypeEClass, source, new String[]{ "name" , "TruncatedNormalDistribution_._type" , "kind" , "empty" });
        addAnnotation(getTruncatedNormalDistributionType_Max(), source, new String[]{ "kind" , "attribute" , "name" , "max" });
        addAnnotation(getTruncatedNormalDistributionType_Mean(), source, new String[]{ "kind" , "attribute" , "name" , "mean" });
        addAnnotation(getTruncatedNormalDistributionType_Min(), source, new String[]{ "kind" , "attribute" , "name" , "min" });
        addAnnotation(getTruncatedNormalDistributionType_StandardDeviation(), source, new String[]{ "kind" , "attribute" , "name" , "standardDeviation" });
        addAnnotation(uniformDistributionTypeEClass, source, new String[]{ "name" , "UniformDistribution_._type" , "kind" , "empty" });
        addAnnotation(getUniformDistributionType_Max(), source, new String[]{ "kind" , "attribute" , "name" , "max" });
        addAnnotation(getUniformDistributionType_Min(), source, new String[]{ "kind" , "attribute" , "name" , "min" });
        addAnnotation(userDistributionDataPointTypeEClass, source, new String[]{ "name" , "UserDistributionDataPoint_._type" , "kind" , "elementOnly" });
        addAnnotation(getUserDistributionDataPointType_ParameterValueGroup(), source, new String[]{ "kind" , "group" , "name" , "ParameterValue:group" , "namespace" , "##targetNamespace" });
        addAnnotation(getUserDistributionDataPointType_ParameterValue(), source, new String[]{ "kind" , "element" , "name" , "ParameterValue" , "namespace" , "##targetNamespace" , "group" , "ParameterValue:group" });
        addAnnotation(getUserDistributionDataPointType_Probability(), source, new String[]{ "kind" , "attribute" , "name" , "probability" });
        addAnnotation(userDistributionTypeEClass, source, new String[]{ "name" , "UserDistribution_._type" , "kind" , "elementOnly" });
        addAnnotation(getUserDistributionType_Group(), source, new String[]{ "kind" , "group" , "name" , "group:5" });
        addAnnotation(getUserDistributionType_UserDistributionDataPoint(), source, new String[]{ "kind" , "element" , "name" , "UserDistributionDataPoint" , "namespace" , "##targetNamespace" , "group" , "#group:5" });
        addAnnotation(getUserDistributionType_Discrete(), source, new String[]{ "kind" , "attribute" , "name" , "discrete" });
        addAnnotation(vendorExtensionEClass, source, new String[]{ "name" , "VendorExtension" , "kind" , "elementOnly" });
        addAnnotation(getVendorExtension_Any(), source, new String[]{ "kind" , "elementWildcard" , "wildcards" , "##other" , "name" , ":0" , "processing" , "strict" });
        addAnnotation(getVendorExtension_Name(), source, new String[]{ "kind" , "attribute" , "name" , "name" });
        addAnnotation(getVendorExtension_AnyAttribute(), source, new String[]{ "kind" , "attributeWildcard" , "wildcards" , "##other" , "name" , ":2" , "processing" , "strict" });
        addAnnotation(weibullDistributionTypeEClass, source, new String[]{ "name" , "WeibullDistribution_._type" , "kind" , "empty" });
        addAnnotation(getWeibullDistributionType_Scale(), source, new String[]{ "kind" , "attribute" , "name" , "scale" });
        addAnnotation(getWeibullDistributionType_Shape(), source, new String[]{ "kind" , "attribute" , "name" , "shape" });
    }
}
