...
public class ResourceParametersImpl extends EObjectImpl implements ResourceParameters {
    ...
    protected EClass eStaticClass() {
        return Literals.RESOURCE_PARAMETERS;
    }
    ...
    public NotificationChain basicSetSelection(Parameter newSelection, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ResourceParametersImpl.this, Notification.SET, BpsimPackage.RESOURCE_PARAMETERS__SELECTION, oldSelection, newSelection);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSelection(Parameter newSelection) {
        if (newSelection != (selection)) {
            ...
            if ((selection) != null)
                msgs = ((InternalEObject) (selection)).eInverseRemove(ResourceParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.RESOURCE_PARAMETERS__SELECTION)), null, msgs);
            
            if (newSelection != null)
                msgs = ((InternalEObject) (newSelection)).eInverseAdd(ResourceParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.RESOURCE_PARAMETERS__SELECTION)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ResourceParametersImpl.this, Notification.SET, BpsimPackage.RESOURCE_PARAMETERS__SELECTION, newSelection, newSelection));
    ...
    public NotificationChain basicSetAvailability(Parameter newAvailability, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ResourceParametersImpl.this, Notification.SET, BpsimPackage.RESOURCE_PARAMETERS__AVAILABILITY, oldAvailability, newAvailability);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setAvailability(Parameter newAvailability) {
        if (newAvailability != (availability)) {
            ...
            if ((availability) != null)
                msgs = ((InternalEObject) (availability)).eInverseRemove(ResourceParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.RESOURCE_PARAMETERS__AVAILABILITY)), null, msgs);
            
            if (newAvailability != null)
                msgs = ((InternalEObject) (newAvailability)).eInverseAdd(ResourceParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.RESOURCE_PARAMETERS__AVAILABILITY)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ResourceParametersImpl.this, Notification.SET, BpsimPackage.RESOURCE_PARAMETERS__AVAILABILITY, newAvailability, newAvailability));
    ...
    public NotificationChain basicSetQuantity(Parameter newQuantity, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(ResourceParametersImpl.this, Notification.SET, BpsimPackage.RESOURCE_PARAMETERS__QUANTITY, oldQuantity, newQuantity);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setQuantity(Parameter newQuantity) {
        if (newQuantity != (quantity)) {
            NotificationChain msgs = null;
            if ((quantity) != null)
                msgs = ((InternalEObject) (quantity)).eInverseRemove(ResourceParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.RESOURCE_PARAMETERS__QUANTITY)), null, msgs);
            
            if (newQuantity != null)
                msgs = ((InternalEObject) (newQuantity)).eInverseAdd(ResourceParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.RESOURCE_PARAMETERS__QUANTITY)), null, msgs);
            ...
            eNotify(new ENotificationImpl(ResourceParametersImpl.this, Notification.SET, BpsimPackage.RESOURCE_PARAMETERS__QUANTITY, newQuantity, newQuantity));
    ...
    public EList<Parameter> getRole() {
        if ((role) == null) {
            role = new org.eclipse.emf.ecore.util.EObjectContainmentEList<Parameter>(Parameter.class, ResourceParametersImpl.this, BpsimPackage.RESOURCE_PARAMETERS__ROLE);
        } 
        return role;
    }
