...
public class PriorityParametersImpl extends EObjectImpl implements PriorityParameters {
    ...
    protected EClass eStaticClass() {
        return Literals.PRIORITY_PARAMETERS;
    }
    ...
    public NotificationChain basicSetInterruptible(Parameter newInterruptible, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(PriorityParametersImpl.this, Notification.SET, BpsimPackage.PRIORITY_PARAMETERS__INTERRUPTIBLE, oldInterruptible, newInterruptible);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setInterruptible(Parameter newInterruptible) {
        if (newInterruptible != (interruptible)) {
            ...
            if ((interruptible) != null)
                msgs = ((InternalEObject) (interruptible)).eInverseRemove(PriorityParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.PRIORITY_PARAMETERS__INTERRUPTIBLE)), null, msgs);
            
            if (newInterruptible != null)
                msgs = ((InternalEObject) (newInterruptible)).eInverseAdd(PriorityParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.PRIORITY_PARAMETERS__INTERRUPTIBLE)), null, msgs);
            ...
            eNotify(new ENotificationImpl(PriorityParametersImpl.this, Notification.SET, BpsimPackage.PRIORITY_PARAMETERS__INTERRUPTIBLE, newInterruptible, newInterruptible));
    ...
    public NotificationChain basicSetPriority(Parameter newPriority, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(PriorityParametersImpl.this, Notification.SET, BpsimPackage.PRIORITY_PARAMETERS__PRIORITY, oldPriority, newPriority);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setPriority(Parameter newPriority) {
        if (newPriority != (priority)) {
            NotificationChain msgs = null;
            if ((priority) != null)
                msgs = ((InternalEObject) (priority)).eInverseRemove(PriorityParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.PRIORITY_PARAMETERS__PRIORITY)), null, msgs);
            
            if (newPriority != null)
                msgs = ((InternalEObject) (newPriority)).eInverseAdd(PriorityParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.PRIORITY_PARAMETERS__PRIORITY)), null, msgs);
            ...
            eNotify(new ENotificationImpl(PriorityParametersImpl.this, Notification.SET, BpsimPackage.PRIORITY_PARAMETERS__PRIORITY, newPriority, newPriority));
