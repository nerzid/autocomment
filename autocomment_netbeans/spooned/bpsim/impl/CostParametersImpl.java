...
public class CostParametersImpl extends EObjectImpl implements CostParameters {
    ...
    protected EClass eStaticClass() {
        return Literals.COST_PARAMETERS;
    }
    ...
    public NotificationChain basicSetFixedCost(Parameter newFixedCost, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(CostParametersImpl.this, Notification.SET, BpsimPackage.COST_PARAMETERS__FIXED_COST, oldFixedCost, newFixedCost);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setFixedCost(Parameter newFixedCost) {
        if (newFixedCost != (fixedCost)) {
            ...
            if ((fixedCost) != null)
                msgs = ((InternalEObject) (fixedCost)).eInverseRemove(CostParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.COST_PARAMETERS__FIXED_COST)), null, msgs);
            
            if (newFixedCost != null)
                msgs = ((InternalEObject) (newFixedCost)).eInverseAdd(CostParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.COST_PARAMETERS__FIXED_COST)), null, msgs);
            ...
            eNotify(new ENotificationImpl(CostParametersImpl.this, Notification.SET, BpsimPackage.COST_PARAMETERS__FIXED_COST, newFixedCost, newFixedCost));
    ...
    public NotificationChain basicSetUnitCost(Parameter newUnitCost, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(CostParametersImpl.this, Notification.SET, BpsimPackage.COST_PARAMETERS__UNIT_COST, oldUnitCost, newUnitCost);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setUnitCost(Parameter newUnitCost) {
        if (newUnitCost != (unitCost)) {
            NotificationChain msgs = null;
            if ((unitCost) != null)
                msgs = ((InternalEObject) (unitCost)).eInverseRemove(CostParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.COST_PARAMETERS__UNIT_COST)), null, msgs);
            
            if (newUnitCost != null)
                msgs = ((InternalEObject) (newUnitCost)).eInverseAdd(CostParametersImpl.this, ((EOPPOSITE_FEATURE_BASE) - (BpsimPackage.COST_PARAMETERS__UNIT_COST)), null, msgs);
            ...
            eNotify(new ENotificationImpl(CostParametersImpl.this, Notification.SET, BpsimPackage.COST_PARAMETERS__UNIT_COST, newUnitCost, newUnitCost));
