...
public class UserDistributionTypeImpl extends DistributionParameterImpl implements UserDistributionType {
     ...
     * @ordered
     */
    protected boolean discrete = UserDistributionTypeImpl.DISCRETE_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.USER_DISTRIBUTION_TYPE;
    }
    ...
    public FeatureMap getGroup() {
        if ((group) == null) {
            group = new org.eclipse.emf.ecore.util.BasicFeatureMap(UserDistributionTypeImpl.this, BpsimPackage.USER_DISTRIBUTION_TYPE__GROUP);
        } 
        return group;
    }
    ...
    public void setDiscrete(boolean newDiscrete) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(UserDistributionTypeImpl.this, Notification.SET, BpsimPackage.USER_DISTRIBUTION_TYPE__DISCRETE, oldDiscrete, discrete, (!oldDiscreteESet)));
    ...
    public void unsetDiscrete() {
        boolean oldDiscrete = discrete;
        boolean oldDiscreteESet = discreteESet;
        discrete = UserDistributionTypeImpl.DISCRETE_EDEFAULT;
        discreteESet = false;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(UserDistributionTypeImpl.this, Notification.UNSET, BpsimPackage.USER_DISTRIBUTION_TYPE__DISCRETE, oldDiscrete, UserDistributionTypeImpl.DISCRETE_EDEFAULT, oldDiscreteESet));
