...
public class DocumentStorageServiceProvider {
    ...
    private synchronized void discover() {
        for (DocumentStorageService foundService : DocumentStorageServiceProvider.storageServices) {
        ...
        if ((documentStorageService) == null) {
            documentStorageService = new org.jbpm.document.service.impl.DocumentStorageServiceImpl();
        } 
    }

    public static DocumentStorageServiceProvider get() {
        return DocumentStorageServiceProvider.INSTANCE;
    }
