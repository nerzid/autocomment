...
public abstract class AbstractProcessInstanceMarshaller implements ProcessInstanceMarshaller {
    ...
    public Object writeProcessInstance(MarshallerWriteContext context, ProcessInstance processInstance) throws IOException {
        ...
        for (String key : keys) {
            ...
            if (object != null) {
                ...
                ObjectMarshallingStrategy strategy = context.getStrategyObject(object);
    ...
    public ProcessInstance readProcessInstance(MarshallerReaderContext context) throws IOException {
        ...
        InternalKnowledgeBase kBase = context;
        ...
        if (nbVariables > 0) {
            ...
            for (int i = 0; i < nbVariables; i++) {
                ...
                try {
                    ...
                    if (index >= 0) {
                        strategy = context.getStrategy(index);
                    } else // This is the new way
                    if (index == (-2)) {
                        String strategyClassName = context.readUTF();
                        if (!(StringUtils.isEmpty(strategyClassName))) {
                            strategy = context.getStrategyObject(strategyClassName);
                            if (strategy == null) {
