...
public class QueryLockStringCommand<T> implements GenericCommand<T> {
    ...
    public QueryLockStringCommand(String queryName, Map<String, Object> params, boolean singleResult) {
        QueryLockStringCommand.this.resultType = ((Class<T>) (Object.class.getClass()));
        QueryLockStringCommand.this.queryString = queryName;
        QueryLockStringCommand.this.params = params;
    }
