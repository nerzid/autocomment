...
public class ThrowExceptionCommand implements Command {
    ...
    public ExecutionResults execute(CommandContext ctx) {
        // debug String{"Hi This is the Exception command!"} to Logger{ThrowExceptionCommand.logger}
        ThrowExceptionCommand.logger.debug("Hi This is the Exception command!");
