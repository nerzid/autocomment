...
public class BasicExecutorIntegrationTest {
    ...
    public void callbackTest() throws InterruptedException {
        ...
        BasicExecutorIntegrationTest.cachedEntities.put(((String) (commandContext.getData("businessKey"))), new AtomicLong(1));
        ...
        List<RequestInfo> executedRequests = executorService.getCompletedRequests(new org.kie.api.runtime.query.QueryContext());
        Assert.assertEquals(1, executedRequests.size());
        Assert.assertEquals(2, ((AtomicLong) (BasicExecutorIntegrationTest.cachedEntities.get(((String) (commandContext.getData("businessKey")))))).longValue());
    }
    ...
    public void addAnotherCallbackTest() throws InterruptedException {
        ...
        try {
            ...
            BasicExecutorIntegrationTest.logger.warn("Exception while serializing context data", e);
            return ;
        } finally {
            if (in != null) {
                try {
    ...
    public void executorExceptionTest() throws InterruptedException {
        ...
        BasicExecutorIntegrationTest.logger.info("{} Sleeping for 10 secs", System.currentTimeMillis());
        Thread.sleep(10000);
        List<RequestInfo> inErrorRequests = executorService.getInErrorRequests(new org.kie.api.runtime.query.QueryContext());
        Assert.assertEquals(1, inErrorRequests.size());
        BasicExecutorIntegrationTest.logger.info("Error: {}", inErrorRequests.get(0));
        List<ErrorInfo> errors = executorService.getAllErrors(new org.kie.api.runtime.query.QueryContext());
        BasicExecutorIntegrationTest.logger.info("Errors: {}", errors);
    ...
    public void cancelRequestTest() throws InterruptedException {
        ...
        List<RequestInfo> requests = executorService.getRequestsByBusinessKey(businessKey, new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(requests);
        Assert.assertEquals(1, requests.size());
        Assert.assertEquals(requestId, requests.get(0).getId());
        // cancel the task immediately
        executorService.cancelRequest(requestId);
        List<RequestInfo> cancelledRequests = executorService.getCancelledRequests(new org.kie.api.runtime.query.QueryContext());
    ...
    public void reoccurringExcecutionTest() throws InterruptedException {
        ...
        List<RequestInfo> executedRequests = executorService.getCompletedRequests(new org.kie.api.runtime.query.QueryContext());
        Assert.assertEquals(4, executedRequests.size());
    }
    ...
    public void cleanupLogExcecutionTest() throws InterruptedException {
        ...
        List<RequestInfo> canceled = executorService.getCancelledRequests(new org.kie.api.runtime.query.QueryContext());
        ...
        Thread.sleep(5000);
        inErrorRequests = executorService.getInErrorRequests(new org.kie.api.runtime.query.QueryContext());
        Assert.assertEquals(0, inErrorRequests.size());
        queuedRequests = executorService.getQueuedRequests(new org.kie.api.runtime.query.QueryContext());
        Assert.assertEquals(0, queuedRequests.size());
        executedRequests = executorService.getCompletedRequests(new org.kie.api.runtime.query.QueryContext());
        Assert.assertEquals(1, executedRequests.size());
    }
    ...
    public void cancelRequestWithSearchByCommandTest() throws InterruptedException {
        ...
        List<RequestInfo> requests = executorService.getRequestsByCommand("org.jbpm.executor.test.CustomCommand", new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(requests);
        Assert.assertEquals(1, requests.size());
        Assert.assertEquals(requestId, requests.get(0).getId());
        // cancel the task immediately
