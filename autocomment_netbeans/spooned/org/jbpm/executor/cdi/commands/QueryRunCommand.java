...
public class QueryRunCommand implements Command {
    ...
    public ExecutionResults execute(CommandContext ctx) {
        ...
        try {
            ...
            QueryRunCommand.logger.info("CDI bean created {}", cdiBean);
            ...
            Object queryR = cdiBean.query(((String) (ctx.getData("query"))), mapper, new org.kie.api.runtime.query.QueryContext());
            QueryRunCommand.logger.info(("Result of the query is " + queryR));
        } catch (Exception e) {
            QueryRunCommand.logger.error("Error while creating CDI bean from jbpm executor", e);
        }
        QueryRunCommand.logger.info("Command executed on executor with data {}", ctx.getData());
