...
public class CDIUtils {
    ...
    private static final String[] BEAN_MANAGER_NAMES = new String[]{ "java:comp/BeanManager" , "java:comp/env/BeanManager" , System.getProperty("org.jbpm.cdi.bm") };
    ...
    public static BeanManager lookUpBeanManager(CommandContext ctx) {
        ...
        for (String jndiName : CDIUtils.BEAN_MANAGER_NAMES) {
            ...
            try {
                ...
                CDIUtils.logger.debug("No bean manager under {} jndi name", jndiName);
            }
        }
        if (beanManager == null) {
