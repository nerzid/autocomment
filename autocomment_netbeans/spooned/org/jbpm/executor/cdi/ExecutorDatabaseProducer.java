...
public class ExecutorDatabaseProducer {
    ...
    public EntityManagerFactory getEntityManagerFactory() {
        if ((ExecutorDatabaseProducer.this.emf) == null) {
            // this needs to be here for non EE containers
            ExecutorDatabaseProducer.this.emf = Persistence.createEntityManagerFactory("org.jbpm.executor");
        } 
        return ExecutorDatabaseProducer.this.emf;
    }
