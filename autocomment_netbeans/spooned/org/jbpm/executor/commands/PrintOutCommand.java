...
public class PrintOutCommand implements Command {
    ...
    public ExecutionResults execute(CommandContext ctx) {
        // info String{"Command executed on executor with data {}"} to Logger{PrintOutCommand.logger}
        PrintOutCommand.logger.info("Command executed on executor with data {}", ctx.getData());
