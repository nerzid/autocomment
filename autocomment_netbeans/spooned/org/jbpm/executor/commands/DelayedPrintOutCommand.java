...
public class DelayedPrintOutCommand extends PrintOutCommand {
    ...
    public ExecutionResults execute(CommandContext ctx) {
        ...
        // info String{"Delaying execution of command for {}"} to Logger{DelayedPrintOutCommand.logger}
        DelayedPrintOutCommand.logger.info("Delaying execution of command for {}", delay);
        try {
            Thread.sleep(delay);
