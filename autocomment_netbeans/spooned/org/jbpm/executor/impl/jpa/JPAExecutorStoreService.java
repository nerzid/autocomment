...
public class JPAExecutorStoreService implements ExecutorStoreService {
    ...
    public void setEventSupport(ExecutorEventSupport eventSupport) {
        JPAExecutorStoreService.this.eventSupport = eventSupport;
    }

    public void setCommandService(CommandService commandService) {
        JPAExecutorStoreService.this.commandService = commandService;
    }

    public void setEmf(EntityManagerFactory emf) {
        JPAExecutorStoreService.this.emf = emf;
    }
    ...
    public ErrorInfo findError(Long id) {
        return commandService.execute(new FindObjectCommand<ErrorInfo>(id, .class));
    }
    ...
    private class LockAndCancelRequestInfoCommand implements GenericCommand<RequestInfo> {
        ...
        LockAndCancelRequestInfoCommand(Long requestId) {
            JPAExecutorStoreService.LockAndCancelRequestInfoCommand.this.requestId = requestId;
        }
