...
public class ExecutorRequestAdminServiceImpl implements RequeueAware , ExecutorAdminService {
    ...
    public void setCommandService(CommandService commandService) {
        ExecutorRequestAdminServiceImpl.this.commandService = commandService;
    }
    ...
    public int clearAllRequests() {
        List<RequestInfo> requests = commandService.execute(new QueryStringCommand<List<RequestInfo>>("select r from RequestInfo r"));
    ...
    public int clearAllErrors() {
        List<ErrorInfo> errors = commandService.execute(new QueryStringCommand<List<ErrorInfo>>("select e from ErrorInfo e"));
    ...
    private class RequeueRunningJobsCommand implements GenericCommand<Void> {
        ...
        public RequeueRunningJobsCommand(Long maxRunningTime) {
            ExecutorRequestAdminServiceImpl.RequeueRunningJobsCommand.this.upperLimitTime = (System.currentTimeMillis()) - maxRunningTime;
        }
    ...
    private class RequeueRunningJobCommand implements GenericCommand<Void> {
        ...
        public RequeueRunningJobCommand(Long id) {
            ExecutorRequestAdminServiceImpl.RequeueRunningJobCommand.this.requestId = id;
        }
