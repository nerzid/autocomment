...
public class ExecutorRunnable implements Runnable {
    ...
    public void setAvailableJobsExecutor(AvailableJobsExecutor availableJobsExecutor) {
        ExecutorRunnable.this.availableJobsExecutor = availableJobsExecutor;
    }

    public void run() {
        try {
            ExecutorRunnable.logger.debug("About to execute jobs...");
            ExecutorRunnable.this.availableJobsExecutor.executeJob();
        } catch (Exception e) {
            ExecutorRunnable.logger.warn("Error while executing jobs due to {}", e.getMessage());
        }
    }
}
