...
public class InMemorySimpleExecutorTest extends BasicExecutorBaseTest {
    ...
    @Override
    @Test
    @Ignore(value = "It's only for JPA based as it removes data from db")
    ...
    @Override
    @Test
    @Ignore(value = "It's only for JPA based as it in memory does not care about delays")
    ...
    @Test
    @Ignore(value = "It's only for JPA based as it in memory does not care about priorities")
