...
public class CaseDynamicSubprocessEvent extends CaseEvent {
    ...
    public CaseDynamicSubprocessEvent(String caseId, String processId, Map<String, Object> data, long processInstanceId) {
        super(caseId);
        CaseDynamicSubprocessEvent.this.data = data;
        CaseDynamicSubprocessEvent.this.processId = processId;
        CaseDynamicSubprocessEvent.this.processInstanceId = processInstanceId;
    }
    ...
    public CaseDynamicSubprocessEvent(String caseId, String processId, Map<String, Object> data, long processInstanceId, long subProcessInstanceId) {
        ...
        CaseDynamicSubprocessEvent.this.processId = processId;
        CaseDynamicSubprocessEvent.this.processInstanceId = processInstanceId;
        CaseDynamicSubprocessEvent.this.subProcessInstanceId = subProcessInstanceId;
    }
