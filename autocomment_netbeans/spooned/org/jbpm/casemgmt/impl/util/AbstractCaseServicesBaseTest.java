...
public abstract class AbstractCaseServicesBaseTest {
    ...
    protected void configureServices() {
        ...
        caseIdGenerator = new org.jbpm.casemgmt.impl.generator.TableCaseIdGenerator(new org.jbpm.shared.services.impl.TransactionalCommandService(emf));
        ...
        ((CaseRuntimeDataServiceImpl) (caseRuntimeDataService)).setCommandService(new org.jbpm.shared.services.impl.TransactionalCommandService(emf));
    ...
    protected InternalKieModule createKieJar(KieServices ks, ReleaseId releaseId, List<String> resources, Map<String, String> extraResources) {
        ...
        if (!(kieBuilder.buildAll().getResults().getMessages().isEmpty())) {
            for (Message message : kieBuilder.buildAll().getResults().getMessages()) {
                AbstractCaseServicesBaseTest.logger.error("Error Message: ({}) {}", message.getPath(), message.getText());
            }
    ...
    public static void cleanupSingletonSessionId() {
        ...
        if (tempDir.exists()) {
            ...
            for (String file : jbpmSerFiles) {
                AbstractCaseServicesBaseTest.logger.debug("Temp dir to be removed {} file {}", tempDir, file);
    ...
    public void setDeploymentService(DeploymentService deploymentService) {
        AbstractCaseServicesBaseTest.this.deploymentService = deploymentService;
    }

    public void setBpmn2Service(DefinitionService bpmn2Service) {
        AbstractCaseServicesBaseTest.this.bpmn2Service = bpmn2Service;
    }

    public void setRuntimeDataService(RuntimeDataService runtimeDataService) {
        AbstractCaseServicesBaseTest.this.runtimeDataService = runtimeDataService;
    }

    public void setProcessService(ProcessService processService) {
        AbstractCaseServicesBaseTest.this.processService = processService;
    }

    public void setUserTaskService(UserTaskService userTaskService) {
        AbstractCaseServicesBaseTest.this.userTaskService = userTaskService;
    }

    public void setQueryService(QueryService queryService) {
        AbstractCaseServicesBaseTest.this.queryService = queryService;
    }

    public void setIdentityProvider(TestIdentityProvider identityProvider) {
        AbstractCaseServicesBaseTest.this.identityProvider = identityProvider;
    }

    public void setCaseRuntimeDataService(CaseRuntimeDataService caseRuntimeDataService) {
        AbstractCaseServicesBaseTest.this.caseRuntimeDataService = caseRuntimeDataService;
    }
