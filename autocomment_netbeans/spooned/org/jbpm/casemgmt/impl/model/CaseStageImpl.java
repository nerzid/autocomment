...
public class CaseStageImpl implements Serializable , CaseStage {
    ...
    public CaseStageImpl(String id, String name, Collection<AdHocFragment> adHocFragments) {
        CaseStageImpl.this.id = id;
        CaseStageImpl.this.name = name;
        CaseStageImpl.this.adHocFragments = (adHocFragments == null) ? Collections.emptyList() : adHocFragments;
    }
