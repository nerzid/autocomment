...
public class CaseMilestoneImpl implements Serializable , CaseMilestone {
    ...
    public CaseMilestoneImpl(String id, String name) {
        CaseMilestoneImpl.this.id = id;
        CaseMilestoneImpl.this.name = name;
    }

    public CaseMilestoneImpl(String id, String name, String achievementCondition, boolean mandatory) {
        CaseMilestoneImpl.this.id = id;
        CaseMilestoneImpl.this.name = name;
        CaseMilestoneImpl.this.achievementCondition = achievementCondition;
        CaseMilestoneImpl.this.mandatory = mandatory;
    }
    ...
    public String toString() {
        return ((((((("CaseMilestoneImpl [id=" + (id)) + ", name=") + (name)) + ", achievementCondition=") + (achievementCondition)) + ", mandatory=") + (mandatory)) + "]";
    }
}
