...
public class CaseServiceImpl implements CaseService {
    ...
    public void setProcessService(ProcessService processService) {
        CaseServiceImpl.this.processService = processService;
    }

    public void setRuntimeDataService(RuntimeDataService runtimeDataService) {
        CaseServiceImpl.this.runtimeDataService = runtimeDataService;
    }

    public void setDeploymentService(DeploymentService deploymentService) {
        CaseServiceImpl.this.deploymentService = deploymentService;
    }

    public void setCaseRuntimeDataService(CaseRuntimeDataService caseRuntimeDataService) {
        CaseServiceImpl.this.caseRuntimeDataService = caseRuntimeDataService;
    }

    public void setCaseIdGenerator(CaseIdGenerator caseIdGenerator) {
        CaseServiceImpl.this.caseIdGenerator = caseIdGenerator;
    }
    ...
    public String startCase(String deploymentId, String caseDefinitionId, CaseFileInstance caseFile) {
        ...
        CaseServiceImpl.logger.debug("Generated case id {} for case definition id {}", caseId, caseDefinitionId);
        if (caseFile == null) {
            caseFile = new CaseFileInstanceImpl(caseId);
            ((CaseFileInstanceImpl) (caseFile)).setupRoles(caseDef.getCaseRoles());
            CaseServiceImpl.logger.debug("CaseFile was not given, creating new empty one.");
        } else {
            ((CaseFileInstanceImpl) (caseFile)).setCaseId(caseId);
            CaseServiceImpl.logger.debug("CaseFile {} was given, associating it with case {}", caseFile, caseId);
        }
        processService.execute(deploymentId, CaseContext.get(caseId), new org.jbpm.casemgmt.impl.command.StartCaseCommand(caseId, deploymentId, caseDefinitionId, caseFile, processService));
        return caseId;
    }
    ...
    public CaseInstance getCaseInstance(String caseId, boolean withData, boolean withRoles, boolean withMilestones, boolean withStages) throws CaseNotFoundException {
        ...
        if (pi.getState().equals(ProcessInstance.STATE_ACTIVE)) {
            ...
            if (withMilestones) {
                Collection<CaseMilestoneInstance> milestones = caseRuntimeDataService.getCaseInstanceMilestones(caseId, false, new QueryContext(0, 100));
            ...
            if (withStages) {
                Collection<CaseStageInstance> stages = caseRuntimeDataService.getCaseInstanceStages(caseId, true, new QueryContext(0, 100));
    ...
    public void cancelCase(String caseId) throws CaseNotFoundException {
        CaseServiceImpl.logger.debug("About to abort case {}", caseId);
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.CancelCaseCommand(caseId, processService, runtimeDataService, false));
    }

    @Override
    public void destroyCase(String caseId) throws CaseNotFoundException {
        CaseServiceImpl.logger.debug("About to destroy permanently case {}", caseId);
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.CancelCaseCommand(caseId, processService, runtimeDataService, true));
    }
    ...
    public void addDynamicTask(String caseId, TaskSpecification taskSpecification) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.AddDynamicTaskCommand(caseId, taskSpecification.getNodeType(), pi.getId(), taskSpecification.getParameters()));
    }
    ...
    public void addDynamicTask(Long processInstanceId, TaskSpecification taskSpecification) throws ProcessInstanceNotFoundException {
        ...
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(processInstanceId), new org.jbpm.casemgmt.impl.command.AddDynamicTaskCommand(caseId, taskSpecification.getNodeType(), pi.getId(), taskSpecification.getParameters()));
    }
    ...
    public void addDynamicTaskToStage(String caseId, String stageId, TaskSpecification taskSpecification) throws CaseNotFoundException, StageNotFoundException {
        ...
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.AddDynamicTaskToStageCommand(caseId, taskSpecification.getNodeType(), pi.getId(), stageId, taskSpecification.getParameters()));
    }
    ...
    public void addDynamicTaskToStage(Long processInstanceId, String stageId, TaskSpecification taskSpecification) throws CaseNotFoundException, StageNotFoundException {
        ...
        String caseId = pi.getCorrelationKey();
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(processInstanceId), new org.jbpm.casemgmt.impl.command.AddDynamicTaskToStageCommand(caseId, taskSpecification.getNodeType(), pi.getId(), stageId, taskSpecification.getParameters()));
    }
    ...
    public void addDynamicSubprocess(String caseId, String processId, Map<String, Object> parameters) throws CaseNotFoundException {
        ...
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.AddDynamicProcessCommand(caseId, pi.getId(), processId, parameters));
    }
    ...
    public void addDynamicSubprocess(Long processInstanceId, String processId, Map<String, Object> parameters) throws CaseNotFoundException {
        ...
        String caseId = pi.getCorrelationKey();
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(processInstanceId), new org.jbpm.casemgmt.impl.command.AddDynamicProcessCommand(caseId, pi.getId(), processId, parameters));
    }
    ...
    public void addDynamicSubprocessToStage(String caseId, String stageId, String processId, Map<String, Object> parameters) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.AddDynamicProcessToStageCommand(caseId, pi.getId(), stageId, processId, parameters));
    }
    ...
    public void addDynamicSubprocessToStage(Long processInstanceId, String stageId, String processId, Map<String, Object> parameters) throws CaseNotFoundException {
        ...
        String caseId = pi.getCorrelationKey();
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(processInstanceId), new org.jbpm.casemgmt.impl.command.AddDynamicProcessToStageCommand(caseId, pi.getId(), stageId, processId, parameters));
    }
    ...
    public void addDataToCaseFile(String caseId, String name, Object value) throws CaseNotFoundException {
        ...
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.AddDataCaseFileInstanceCommand(parameters));
    }

    @Override
    public void addDataToCaseFile(String caseId, Map<String, Object> data) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.AddDataCaseFileInstanceCommand(data));
    }

    @Override
    public void removeDataFromCaseFile(String caseId, String name) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.RemoveDataCaseFileInstanceCommand(Arrays.asList(name)));
    }

    @Override
    public void removeDataFromCaseFile(String caseId, List<String> variableNames) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.RemoveDataCaseFileInstanceCommand(variableNames));
    }
    ...
    public void assignToCaseRole(String caseId, String role, OrganizationalEntity entity) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.ModifyRoleAssignmentCommand(role, entity, true));
    }

    @Override
    public void removeFromCaseRole(String caseId, String role, OrganizationalEntity entity) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.ModifyRoleAssignmentCommand(role, entity, false));
    }
    ...
    public void addCaseComment(String caseId, String author, String comment) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.CaseCommentCommand(author, comment));
    }

    @Override
    public void updateCaseComment(String caseId, String commentId, String author, String text) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.CaseCommentCommand(commentId, author, text));
    }

    @Override
    public void removeCaseComment(String caseId, String commentId) throws CaseNotFoundException {
        ProcessInstanceDesc pi = verifyCaseIdExists(caseId);
        processService.execute(pi.getDeploymentId(), ProcessInstanceIdContext.get(pi.getId()), new org.jbpm.casemgmt.impl.command.CaseCommentCommand(commentId));
    }
    ...
    public TaskSpecification newHumanTaskSpec(String taskName, String description, String actorIds, String groupIds, Map<String, Object> parameters) {
        return new org.jbpm.casemgmt.impl.dynamic.HumanTaskSpecification(taskName, actorIds, groupIds, description, parameters);
    }

    @Override
    public TaskSpecification newTaskSpec(String nodeType, String nodeName, Map<String, Object> parameters) {
        return new org.jbpm.casemgmt.impl.dynamic.WorkItemTaskSpecification(nodeType, nodeName, parameters);
    }

    /* internal methods */
    @SuppressWarnings(value = "unchecked")
    protected CaseFileInstance internalGetCaseFileInstance(String caseId, ProcessInstanceDesc pi) {
        CaseServiceImpl.logger.debug(("Retrieving case file from working memory for case " + caseId));
        Collection<CaseFileInstance> caseFiles = ((Collection<CaseFileInstance>) (processService.execute(pi.getDeploymentId(), CaseContext.get(caseId), commandsFactory.newGetObjects(new org.drools.core.ClassObjectFilter(CaseFileInstance.class)))));
        if ((caseFiles.size()) == 1) {
            CaseFileInstance caseFile = caseFiles.iterator().next();
            CaseServiceImpl.logger.debug("Single case file {} found in working memory", caseFile);
            return caseFile;
        } 
        CaseServiceImpl.logger.warn("Multiple case files found in working memory (most likely not using PER_CASE strategy), trying to filter out...");
        CaseFileInstance caseFile = caseFiles.stream().filter(( cf) -> cf.getCaseId().equals(caseId)).findFirst().orElse(null);
        CaseServiceImpl.logger.warn("Case file {} after filtering {}", caseFile, (caseFile == null ? "not found" : "found"));
        return caseFile;
    }
