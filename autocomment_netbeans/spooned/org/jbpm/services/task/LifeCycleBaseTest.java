...
public abstract class LifeCycleBaseTest extends HumanTaskServicesBaseTest {
    ...
    public void testWithNoTaskAndEmptyLists() {
        ...
        Assert.assertTrue(tasks2.isEmpty());
        ...
        Assert.assertTrue(tasks3.isEmpty());
        ...
        Assert.assertTrue(tasks4.isEmpty());
    }
    ...
    public void testNewTaskWithNoPotentialOwners() {
        ...
        Assert.assertEquals(task1.getTaskData().getStatus(), Status.Created);
        Assert.assertNull(task1.getTaskData().getActualOwner());
    }
    ...
    public void testNewTaskWithSinglePotentialOwner() {
        ...
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Reserved, task1.getTaskData().getStatus());
        String potOwner = "Bobba Fet";
        Assert.assertEquals(potOwner, task1.getTaskData().getActualOwner().getId());
    ...
    public void testNewTaskWithContent() {
        ...
        // Task should be assigned to the single potential owner and state set to Reserved
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(AccessType.Inline, ((InternalTaskData) (task1.getTaskData())).getDocumentAccessType());
        Assert.assertEquals("java.lang.String", task1.getTaskData().getDocumentType());
        ...
        Assert.assertEquals("content", unmarshalledObject.toString());
    ...
    public void testNewTaskWithMapContent() {
        ...
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(AccessType.Inline, ((InternalTaskData) (task1.getTaskData())).getDocumentAccessType());
        Assert.assertEquals("java.util.HashMap", task1.getTaskData().getDocumentType());
        long contentId = task1.getTaskData().getDocumentContentId();
        Assert.assertTrue((contentId != (-1)));
        // content
        Content content = taskService.getContentById(contentId);
        ...
        Assert.assertNotNull("Jaxb Content map not filled", jaxbContent.getContentMap());
        Assert.assertEquals("value1", unmarshalledvars.get("key1"));
        Assert.assertNull(unmarshalledvars.get("key2"));
        Assert.assertEquals("value3", unmarshalledvars.get("key3"));
    }
    ...
    public void testNewTaskWithMapContentAndOutput() {
        ...
        task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Completed, task1.getTaskData().getStatus());
        ...
        Assert.assertTrue(((Map<String, Object>) (unmarshalledObject)).containsKey("key2"));
        Assert.assertTrue(((Map<String, Object>) (unmarshalledObject)).containsKey("key4"));
        Assert.assertTrue(((Map<String, Object>) (unmarshalledObject)).containsKey("key5"));
        Assert.assertTrue(((Map<String, Object>) (unmarshalledObject)).containsKey("key6"));
    ...
    public void testNewTaskWithLargeContent() {
        ...
        Content content = taskService.getContentById(contentId);
        Object unmarshalledObject = ContentMarshallerHelper.unmarshall(content.getContent(), null);
        Assert.assertEquals(largeContent, unmarshalledObject.toString());
        xmlRoundTripContent(content);
    }
    ...
    public void testClaimWithMultiplePotentialOwners() throws Exception {
        ...
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Ready, task1.getTaskData().getStatus());
    ...
    public void testStartFromReadyStateWithIncorrectPotentialOwner() {
        ...
        Task task2 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Ready, task2.getTaskData().getStatus());
        Assert.assertNull(task2.getTaskData().getActualOwner());
    }
    ...
    public void testStartFromReserved() throws Exception {
        ...
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Reserved, task1.getTaskData().getStatus());
        Assert.assertEquals("Bobba Fet", task1.getTaskData().getActualOwner().getId());
    ...
    public void testSuspendFromReady() {
        ...
        Task task2 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Suspended, task2.getTaskData().getStatus());
        Assert.assertEquals(Status.Ready, task2.getTaskData().getPreviousStatus());
        Assert.assertNull(task1.getTaskData().getActualOwner());
    }
    ...
    public void testSuspendFromReserved() {
        ...
        taskService.suspend(taskId, "Darth Vader");
        Task task2 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Reserved, task2.getTaskData().getPreviousStatus());
        Assert.assertEquals(Status.Suspended, task2.getTaskData().getStatus());
        Assert.assertEquals("Darth Vader", task2.getTaskData().getActualOwner().getId());
    }
    ...
    public void testResumeFromReady() {
        ...
        Assert.assertEquals(Status.Ready, task3.getTaskData().getStatus());
        Assert.assertEquals(Status.Suspended, task3.getTaskData().getPreviousStatus());
        Assert.assertNull(task3.getTaskData().getActualOwner());
    }
    ...
    public void testResumeFromReserved() {
        ...
        taskService.resume(taskId, "Darth Vader");
        Task task3 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Reserved, task3.getTaskData().getStatus());
        Assert.assertEquals(Status.Suspended, task3.getTaskData().getPreviousStatus());
        Assert.assertEquals("Darth Vader", task3.getTaskData().getActualOwner().getId());
    }
    ...
    public void testSkipFromReady() {
        ...
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Obsolete, task1.getTaskData().getStatus());
        Assert.assertNull(task1.getTaskData().getActualOwner());
    }
    ...
    public void testDelegateFromReady() throws Exception {
        ...
        Assert.assertTrue(task2.getPeopleAssignments().getPotentialOwners().contains(user));
        user = createUser("Tony Stark");
        Assert.assertTrue(task2.getPeopleAssignments().getPotentialOwners().contains(user));
        Assert.assertEquals("Tony Stark", task2.getTaskData().getActualOwner().getId());
    ...
    public void testDelegateFromReservedWithIncorrectUser() throws Exception {
        ...
        Assert.assertTrue(task2.getPeopleAssignments().getPotentialOwners().contains(user));
        user = createUser("Tony Stark");
        Assert.assertFalse(task2.getPeopleAssignments().getPotentialOwners().contains(user));
        Assert.assertEquals("Darth Vader", task2.getTaskData().getActualOwner().getId());
        Assert.assertEquals(Status.Reserved, task2.getTaskData().getStatus());
    }
    ...
    public void testForwardFromReady() throws Exception {
        ...
        Task task2 = taskService.getTaskById(taskId);
        Assert.assertFalse(task2.getPeopleAssignments().getPotentialOwners().contains(createUser("Darth Vader")));
        Assert.assertTrue(task2.getPeopleAssignments().getPotentialOwners().contains(createUser("Tony Stark")));
        Assert.assertNull(task2.getTaskData().getActualOwner());
        Assert.assertEquals(Status.Ready, task2.getTaskData().getStatus());
    }
    ...
    public void testCompleteWithContent() {
        ...
        Assert.assertEquals(3, allContent.size());
        // only input(0) and output(1) is present
        Assert.assertNotNull(allContent.get(0));
        Assert.assertNotNull(allContent.get(1));
        Assert.assertNull(allContent.get(2));
        Task task2 = taskService.getTaskById(taskId);
        Assert.assertEquals(AccessType.Inline, ((InternalTaskData) (task2.getTaskData())).getOutputAccessType());
        Assert.assertEquals("java.util.HashMap", task2.getTaskData().getOutputType());
        ...
        Assert.assertEquals("content", unmarshalledObject.get("content"));
        // update content
        ...
        Assert.assertEquals("updated content", unmarshalledObject.get("content"));
    ...
    public void testFail() {
        ...
        Task task2 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Failed, task2.getTaskData().getStatus());
        Assert.assertEquals("Darth Vader", task2.getTaskData().getActualOwner().getId());
    }
    ...
    public void testFailWithContent() {
        ...
        Assert.assertNotNull(allContent.get(0));
        Assert.assertNull(allContent.get(1));
        Assert.assertNotNull(allContent.get(2));
        Task task2 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Failed, task2.getTaskData().getStatus());
        Assert.assertEquals(AccessType.Inline, ((InternalTaskData) (task2.getTaskData())).getFaultAccessType());
        Assert.assertEquals("type", task2.getTaskData().getFaultType());
        Assert.assertEquals("faultName", task2.getTaskData().getFaultName());
        ...
        Assert.assertEquals("content", unmarshalledContent.get("content"));
        xmlRoundTripContent(content);
        // update fault
        ...
        content = taskService.getContentById(contentId);
        String updated = new String(content.getContent());
        Assert.assertEquals("updated content", updated);
        // delete fault
    ...
    public void testRemoveNotInRecipientList() {
        ...
        Assert.assertNotNull(myRecipientTasks);
        Assert.assertEquals(0, myRecipientTasks.size());
        List<TaskSummary> myPotentialTasks = taskService.getTasksAssignedAsPotentialOwner("Jabba Hutt", "en-UK");
        Assert.assertNotNull(myPotentialTasks);
        Assert.assertEquals(0, myPotentialTasks.size());
        try {
        ...
        Assert.assertTrue(((InternalPeopleAssignments) (task1.getPeopleAssignments())).getRecipients().contains(user));
    }
    ...
    public void testNominateOnOtherThanCreated() {
        ...
        Task task1 = taskService.getTaskById(taskId);
        User user = createUser("Darth Vader");
        Assert.assertTrue(task1.getPeopleAssignments().getPotentialOwners().contains(user));
    ...
    public void testNominateWithIncorrectUser() {
        ...
        Task task1 = taskService.getTaskById(taskId);
        User user = createUser("Bobba Fet");
        Assert.assertTrue(task1.getPeopleAssignments().getBusinessAdministrators().contains(user));
        Assert.assertEquals(task1.getTaskData().getStatus(), Status.Created);
    }
    ...
    public void testNominateToUser() {
        ...
        // shouldn't affect the assignments
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(task1.getTaskData().getActualOwner().getId(), "Jabba Hutt");
        Assert.assertEquals(task1.getTaskData().getStatus(), Status.Reserved);
    }
    ...
    public void testNominateToGroup() {
        ...
        // shouldn't affect the assignments
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertTrue(task1.getPeopleAssignments().getPotentialOwners().contains(group));
        Assert.assertEquals(task1.getTaskData().getStatus(), Status.Ready);
    }
    ...
    public void testExitFromReady() {
        ...
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Exited, task1.getTaskData().getStatus());
    }
    ...
    public void testExitFromSuspended() {
        ...
        taskService.suspend(taskId, "Bobba Fet");
        task = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Suspended, task.getTaskData().getStatus());
        taskService.exit(taskId, "Administrator");
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.Exited, task1.getTaskData().getStatus());
    }
    ...
    public void testExitNotAvailableToUsers() {
        ...
        Assert.assertEquals(0, exitedTasks.size());
    }
    ...
    public void testClaimConflictAndRetry() {
        ...
        Assert.assertEquals(Status.Ready, salaboyTask.getTaskData().getStatus());
        // Because the Task contains a direct assignment we can query it for its Potential Owner
        // Notice that we obtain a list of TaskSummary (a lightweight representation of a task)
        ...
        Assert.assertEquals(bobbaTaskId, salaboyTaskId);
        // In order to check the task status we need to get the real task
        // The task is in a Reserved status because it already have a well-defined Potential Owner
        Task bobbaTask = taskService.getTaskById(bobbaTaskId);
        Assert.assertEquals(Status.Ready, bobbaTask.getTaskData().getStatus());
    ...
    public void testClaimNextAvailable() {
        ...
        Assert.assertEquals(0, salaboyTasks.size());
    }
    ...
    public void testCompleteWithRestrictedGroups() {
        ...
        Assert.assertNotNull(potOwners);
        Assert.assertEquals(1, potOwners.size());
        Assert.assertEquals("Crusaders", potOwners.get(0).getId());
        // Go straight from Ready to Inprogress
        taskService.start(taskId, "Darth Vader");
        Task task1 = taskService.getTaskById(taskId);
        Assert.assertEquals(Status.InProgress, task1.getTaskData().getStatus());
    ...
    public void testLongDescription() {
        ...
        Assert.assertEquals(1000, resultDescription.getText().length());// This is text
    ...
    public void testCompleteByActiveTasks() {
        ...
        taskService.addTask(task, new HashMap<String, Object>());
        long taskId = task.getId();
        Assert.assertNotNull(task.getTaskData().getActivationTime());
        ...
        Assert.assertEquals(1, activeTasks.size());
        ...
        Assert.assertNotNull(archiveddTasks);
        Assert.assertEquals(1, archiveddTasks.size());
    }
    ...
    public void testCompleteWithContentAndVarInputListener() {
        testCompleteWithContentAndVarListener(new DefaultTaskEventListener() {
            ...
            public void beforeTaskStartedEvent(TaskEvent event) {
                Assert.assertNull(event.getTask().getTaskData().getTaskInputVariables());
                Assert.assertNull(event.getTask().getTaskData().getTaskOutputVariables());
                event.getTaskContext().loadTaskVariables(event.getTask());
                Assert.assertNotNull(event.getTask().getTaskData().getTaskInputVariables());
                Assert.assertEquals(1, event.getTask().getTaskData().getTaskInputVariables().size());
                Assert.assertTrue(event.getTask().getTaskData().getTaskInputVariables().containsKey("input"));
                Assert.assertNull(event.getTask().getTaskData().getTaskOutputVariables());
            }
            ...
            public void beforeTaskCompletedEvent(TaskEvent event) {
                Assert.assertNull(event.getTask().getTaskData().getTaskInputVariables());
                Assert.assertNotNull(event.getTask().getTaskData().getTaskOutputVariables());
                Assert.assertEquals(1, event.getTask().getTaskData().getTaskOutputVariables().size());
                Assert.assertTrue(event.getTask().getTaskData().getTaskOutputVariables().containsKey("content"));
                event.getTaskContext().loadTaskVariables(event.getTask());
                Assert.assertNotNull(event.getTask().getTaskData().getTaskInputVariables());
                Assert.assertEquals(1, event.getTask().getTaskData().getTaskInputVariables().size());
                Assert.assertTrue(event.getTask().getTaskData().getTaskInputVariables().containsKey("input"));
