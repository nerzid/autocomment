...
public abstract class TaskAttachmentBaseTest extends HumanTaskServicesBaseTest {
    ...
    public void testAttachmentWithStringInlineContent() {
        ...
        Assert.assertEquals(2, allAttachmentsByTaskId.size());
        ...
        Assert.assertEquals("This is my first inline document", firstDocString);
        ...
        Assert.assertEquals("This is my second inline document", secondDocString);
    }
}
