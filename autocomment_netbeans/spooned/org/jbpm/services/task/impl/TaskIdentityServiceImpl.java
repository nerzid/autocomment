...
public class TaskIdentityServiceImpl implements TaskIdentityService {
    ...
    public List<User> getUsers() {
        return persistenceContext.queryStringInTransaction("from User", ClassUtil.<List<User>>castClass(List.class));
    }

    public List<Group> getGroups() {
        return persistenceContext.queryStringInTransaction("from Group", ClassUtil.<List<Group>>castClass(List.class));
    }
