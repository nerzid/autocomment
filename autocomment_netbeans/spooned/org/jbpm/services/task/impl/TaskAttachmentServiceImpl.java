...
public class TaskAttachmentServiceImpl implements TaskAttachmentService {
    ...
    public TaskAttachmentServiceImpl(TaskPersistenceContext persistenceContext) {
        TaskAttachmentServiceImpl.this.persistenceContext = persistenceContext;
    }
    ...
    public List<Attachment> getAllAttachmentsByTaskId(long taskId) {
        return ((List<Attachment>) (persistenceContext.queryWithParametersInTransaction("AttachmentsByTaskId", persistenceContext.addParametersToMap("taskId", taskId), ClassUtil.<List<Attachment>>castClass(List.class))));
    }
