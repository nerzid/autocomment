...
@SequenceGenerator(allocationSize = 1, name = "attachmentIdSeq", sequenceName = "ATTACHMENT_ID_SEQ")
public class AttachmentImpl implements InternalAttachment {
    @Id
    @GeneratedValue(generator = "attachmentIdSeq", strategy = GenerationType.AUTO)
    @Column(name = "id")
    private Long id = 0L;
    ...
    public void setAccessType(AccessType accessType) {
        AttachmentImpl.this.accessType = accessType;
    }
    ...
    public void setContentType(String contentType) {
        AttachmentImpl.this.contentType = contentType;
    }
    ...
    public void setAttachedAt(Date attachedAt) {
        AttachmentImpl.this.attachedAt = attachedAt;
    }
    ...
    public void setAttachedBy(User attachedBy) {
        AttachmentImpl.this.attachedBy = convertToUserImpl(attachedBy);
    }
    ...
    public void setAttachmentContentId(long contentId) {
        AttachmentImpl.this.attachmentContentId = contentId;
    }
