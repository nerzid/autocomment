...
public class NonManagedTaskEventListener implements TaskLifeCycleEventListener {
    ...
    public NonManagedTaskEventListener(KieSession ksession, TaskService taskService) {
        NonManagedTaskEventListener.this.ksession = ksession;
        NonManagedTaskEventListener.this.taskService = taskService;
    }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = (prime * result) + ((ksession) == null ? 0 : ksession.hashCode());
    ...
    public boolean equals(Object obj) {
        if ((NonManagedTaskEventListener.this) == obj)
            return true;
