...
public class GetTaskAssignedAsStakeholderCommand extends UserGroupCallbackTaskCommand<List<TaskSummary>> {
    ...
    public List<TaskSummary> execute(Context cntxt) {
        ...
        // do callback GetTaskAssignedAsStakeholderCommand{userId} to GetTaskAssignedAsStakeholderCommand{}
        doCallbackUserOperation(userId, context);
        // do user GetTaskAssignedAsStakeholderCommand{userId} to GetTaskAssignedAsStakeholderCommand{}
