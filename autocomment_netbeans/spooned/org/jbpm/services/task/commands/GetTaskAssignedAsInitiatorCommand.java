...
public class GetTaskAssignedAsInitiatorCommand extends UserGroupCallbackTaskCommand<List<TaskSummary>> {
    ...
    public List<TaskSummary> execute(Context cntxt) {
        ...
        // do callback GetTaskAssignedAsInitiatorCommand{userId} to GetTaskAssignedAsInitiatorCommand{}
        doCallbackUserOperation(userId, context);
        // do user GetTaskAssignedAsInitiatorCommand{userId} to GetTaskAssignedAsInitiatorCommand{}
