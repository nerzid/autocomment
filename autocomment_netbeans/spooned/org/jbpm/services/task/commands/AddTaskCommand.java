...
public class AddTaskCommand extends UserGroupCallbackTaskCommand<Long> {
    ...
    // remove and add @XmlElement when done
    @XmlTransient
    ...
    public AddTaskCommand(Task task, Map<String, Object> params) {
        setTask(task);
        AddTaskCommand.this.params = params;
    }

    public AddTaskCommand(Task task, ContentData data) {
        setTask(task);
        AddTaskCommand.this.data = data;
    }
    ...
    public void setJaxbTask(JaxbTask jaxbTask) {
        AddTaskCommand.this.jaxbTask = jaxbTask;
    }
    ...
    public void setTask(Task task) {
        AddTaskCommand.this.task = task;
        if (task instanceof JaxbTask) {
            AddTaskCommand.this.jaxbTask = ((JaxbTask) (task));
        } else {
            AddTaskCommand.this.jaxbTask = new JaxbTask(task);
        }
    }
    ...
    private void scheduleDeadlines(final List<? extends Deadline> deadlines, final long now, final long taskId, DeadlineType type, TaskDeadlinesService deadlineService) {
