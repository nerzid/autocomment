...
public class AddCommentCommand extends UserGroupCallbackTaskCommand<Long> {
    ...
    public void setComment(Comment comment) {
        AddCommentCommand.this.comment = comment;
        if (comment instanceof JaxbComment) {
            AddCommentCommand.this.jaxbComment = ((JaxbComment) (comment));
        } else {
            AddCommentCommand.this.jaxbComment = new JaxbComment(comment);
        }
    }
    ...
    public void setJaxbComment(JaxbComment jaxbComment) {
        AddCommentCommand.this.jaxbComment = jaxbComment;
    }
