...
public class GetTaskAssignedAsRecipientCommand extends UserGroupCallbackTaskCommand<List<TaskSummary>> {
    ...
    public List<TaskSummary> execute(Context cntxt) {
        ...
        // do callback GetTaskAssignedAsRecipientCommand{userId} to GetTaskAssignedAsRecipientCommand{}
        doCallbackUserOperation(userId, context);
        // do user GetTaskAssignedAsRecipientCommand{userId} to GetTaskAssignedAsRecipientCommand{}
