...
public class TaskFluent {
    ...
    public TaskFluent setCreatedBy(String userId) {
        ((TaskDataImpl) (task.getTaskData())).setCreatedBy(new org.jbpm.services.task.impl.model.UserImpl(userId));
        return TaskFluent.this;
    }
    ...
    public TaskFluent addI18NName(String language, String name) {
        task.getNames().add(new org.jbpm.services.task.impl.model.I18NTextImpl(language, name));
        return TaskFluent.this;
    }

    public TaskFluent addI18NDescription(String language, String description) {
        task.getDescriptions().add(new org.jbpm.services.task.impl.model.I18NTextImpl(language, description));
        return TaskFluent.this;
    }

    public TaskFluent addI18NSubject(String language, String subject) {
        task.getSubjects().add(new org.jbpm.services.task.impl.model.I18NTextImpl(language, subject));
        return TaskFluent.this;
    }
    ...
    public TaskFluent addPotentialUser(String userId) {
        ...
        assignments.getPotentialOwners().add(new org.jbpm.services.task.impl.model.UserImpl(userId));
        return TaskFluent.this;
    }
    ...
    public TaskFluent addPotentialGroup(String groupId) {
        ...
        assignments.getPotentialOwners().add(new org.jbpm.services.task.impl.model.GroupImpl(groupId));
        return TaskFluent.this;
    }
    ...
    public TaskFluent setAdminUser(String userId) {
        ...
        assignments.getBusinessAdministrators().add(new org.jbpm.services.task.impl.model.UserImpl(userId));
        return TaskFluent.this;
    }
    ...
    public TaskFluent setAdminGroup(String groupId) {
        ...
        assignments.getBusinessAdministrators().add(new org.jbpm.services.task.impl.model.GroupImpl(groupId));
        return TaskFluent.this;
    }
