...
public class AbstractTaskQueryCriteriaUtil extends QueryCriteriaUtil {
    ...
    protected EntityManager getEntityManager() {
        return AbstractTaskQueryCriteriaUtil.this.persistenceContext.getEntityManager();
    }

    protected Object joinTransaction(EntityManager em) {
        AbstractTaskQueryCriteriaUtil.this.persistenceContext.joinTransaction();
        return true;
    }
    ...
    protected boolean initializeCriteriaAttributes() {
        return AbstractTaskQueryCriteriaUtil.shouldBeImplementedInChildClass(boolean.class);
    }
    ...
    protected <R, T> Predicate implSpecificCreatePredicateFromSingleCriteria(CriteriaQuery<R> query, CriteriaBuilder builder, Class queryType, QueryCriteria criteria, QueryWhere queryWhere) {
        return AbstractTaskQueryCriteriaUtil.shouldBeImplementedInChildClass(Predicate.class);
    }
