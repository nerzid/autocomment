...
public class TaskQueryManager {
    ...
    public static TaskQueryManager get() {
        return TaskQueryManager.instance;
    }
    ...
    public synchronized void addNamedQueries(String ormFile) {
        try {
            ...
            TaskQueryManager.logger.debug(("TaskQueryManager unable to read Taskorm file due to " + (e.getMessage())), e);
            TaskQueryManager.logger.warn(("TaskQueryManager unable to read Taskorm file due to " + (e.getMessage())));
        }
    }
