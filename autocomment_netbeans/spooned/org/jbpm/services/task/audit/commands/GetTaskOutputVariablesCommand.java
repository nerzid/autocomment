...
public class GetTaskOutputVariablesCommand extends TaskCommand<List<TaskVariable>> {
    ...
    public List<TaskVariable> execute(Context context) {
        ...
        return persistenceContext.queryWithParametersInTransaction("getTaskOutputVariables", persistenceContext.addParametersToMap("taskId", taskId, "firstResult", filter.getOffset(), "maxResults", filter.getCount()), ClassUtil.<List<TaskVariable>>castClass(List.class));
    }
}
