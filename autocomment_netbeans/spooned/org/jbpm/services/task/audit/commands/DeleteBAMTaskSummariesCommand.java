...
public class DeleteBAMTaskSummariesCommand extends TaskCommand<Void> {
    ...
    public Void execute(Context context) {
        ...
        if ((DeleteBAMTaskSummariesCommand.this.taskId) != null) {
            persistenceContext.executeUpdateString(("delete from BAMTaskSummaryImpl b where b.taskId = " + (DeleteBAMTaskSummariesCommand.this.taskId)));
        } else {
