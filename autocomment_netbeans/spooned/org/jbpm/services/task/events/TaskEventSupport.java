    ...
    public void fireBeforeTaskUpdated(final Task task, TaskContext context) {
        ...
        if (iter.hasNext()) {
            do {
                ...
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).beforeTaskUpdatedEvent(new TaskEventImpl(task, context));
                }
            } while (iter.hasNext() );
        }
    }
    ...
    public void fireBeforeTaskReassigned(final Task task, TaskContext context) {
        ...
        if (iter.hasNext()) {
            do {
                TaskLifeCycleEventListener listener = iter.next();
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).beforeTaskReassignedEvent(new TaskEventImpl(task, context));
                }
            } while (iter.hasNext() );
        }
    }
    ...
    public void fireBeforeTaskNotified(final Task task, TaskContext context) {
        ...
        if (iter.hasNext()) {
            do {
                TaskLifeCycleEventListener listener = iter.next();
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).beforeTaskNominatedEvent(new TaskEventImpl(task, context));
                }
            } while (iter.hasNext() );
        }
    }
    ...
    public void fireAfterTaskUpdated(final Task task, TaskContext context) {
        ...
        if (iter.hasNext()) {
            do {
                TaskLifeCycleEventListener listener = iter.next();
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).afterTaskUpdatedEvent(new TaskEventImpl(task, context));
                }
            } while (iter.hasNext() );
        }
    }
    ...
    public void fireAfterTaskReassigned(final Task task, TaskContext context) {
        ...
        if (iter.hasNext()) {
            do {
                TaskLifeCycleEventListener listener = iter.next();
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).afterTaskReassignedEvent(new TaskEventImpl(task, context));
                }
            } while (iter.hasNext() );
        }
    }
    ...
    public void fireAfterTaskNotified(final Task task, TaskContext context) {
        ...
        if (iter.hasNext()) {
            do {
                TaskLifeCycleEventListener listener = iter.next();
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).afterTaskNotificationEvent(new TaskEventImpl(task, context));
                }
            } while (iter.hasNext() );
        }
    }
    ...
    public void fireAfterTaskInputVariablesChanged(final Task task, TaskContext context, Map<String, Object> variables) {
        ...
        if (iter.hasNext()) {
            do {
                TaskLifeCycleEventListener listener = iter.next();
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).afterTaskInputVariableChangedEvent(new TaskEventImpl(task, context), variables);
                }
            } while (iter.hasNext() );
        }
    }
    ...
    public void fireAfterTaskOutputVariablesChanged(final Task task, TaskContext context, Map<String, Object> variables) {
        ...
        if (iter.hasNext()) {
            do {
                TaskLifeCycleEventListener listener = iter.next();
                if (listener instanceof org.jbpm.services.task.lifecycle) {
                    ((TaskLifeCycleEventListener) (listener)).afterTaskOutputVariableChangedEvent(new TaskEventImpl(task, context), variables);
                }
            } while (iter.hasNext() );
        }
    }
