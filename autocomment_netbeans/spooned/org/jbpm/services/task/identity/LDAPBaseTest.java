...
public abstract class LDAPBaseTest {
    ...
    protected static final String SERVER_URL = "ldap://localhost:" + (LDAPBaseTest.PORT);
...
CUSTOM, DEFAULT, SYSTEM;    }
    ...
    public void startDirectoryServer() throws LDAPException {
        InMemoryListenerConfig listenerConfig = InMemoryListenerConfig.createLDAPConfig("default", LDAPBaseTest.PORT);
        InMemoryDirectoryServerConfig serverConfig = new InMemoryDirectoryServerConfig(new com.unboundid.ldap.sdk.DN(LDAPBaseTest.BASE_DN));
        serverConfig.setListenerConfigs(listenerConfig);
        serverConfig.addAdditionalBindCredentials(LDAPBaseTest.USER_DN, LDAPBaseTest.PASSWORD);
