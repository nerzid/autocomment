...
public class LDAPUserInfoImplTest extends LDAPBaseTest {
    ...
    public void testGetDisplayNameForUserByDefaultAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.JOHN, "John Doe", false);
    }

    @Test
    public void testGetDisplayNameForUserDnByDefaultAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.JOHN_DN, "John Doe", false);
    }

    @Test
    public void testGetDisplayNameForUserByCustomAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.MARY, "Mary Snow", true);
    }

    @Test
    public void testGetDisplayNameForUserDnByCustomAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.MARY_DN, "Mary Snow", true);
    }

    @Test
    public void testGetDisplayNameForGroupByDefaultAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.MANAGER, "jBPM manager", false);
    }

    @Test
    public void testGetDisplayNameForGroupDnByDefaultAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.MANAGER_DN, "jBPM manager", false);
    }

    @Test
    public void testGetDisplayNameForGroupByCustomAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.USER, "jBPM user", true);
    }

    @Test
    public void testGetDisplayNameForGroupDnByCustomAttribute() {
        testGetDisplayName(LDAPUserInfoImplTest.USER_DN, "jBPM user", true);
    }
    ...
    private void testGetMembersForGroup(boolean emptyGroup, boolean customAttribute, boolean distinguishedName) {
        ...
        Group group;
        if (distinguishedName) {
            group = (emptyGroup) ? LDAPUserInfoImplTest.USER_DN : LDAPUserInfoImplTest.MANAGER_DN;
        } else {
            group = (emptyGroup) ? LDAPUserInfoImplTest.USER : LDAPUserInfoImplTest.MANAGER;
        }
        ...
        if (customAttribute) {
            Assertions.assertThat(user.getId()).isEqualTo(LDAPUserInfoImplTest.MARY_DN.getId());
        } else {
            Assertions.assertThat(user.getId()).isEqualTo(LDAPUserInfoImplTest.JOHN_DN.getId());
        }
        Assertions.assertThat(iterator.hasNext()).isFalse();
    }
    ...
    public void testHasExistingEmailByDefaultAttribute() {
        testHasEmail(LDAPUserInfoImplTest.MANAGER, true, false);
    }

    @Test
    public void testHasExistingEmailDnByDefaultAttribute() {
        testHasEmail(LDAPUserInfoImplTest.MANAGER_DN, true, false);
    }

    @Test
    public void testHasExistingEmailByCustomAttribute() {
        testHasEmail(LDAPUserInfoImplTest.USER, true, true);
    }

    @Test
    public void testHasExistingEmailDnByCustomAttribute() {
        testHasEmail(LDAPUserInfoImplTest.USER_DN, true, true);
    }

    @Test
    public void testHasNonExistingEmailByDefaultAttribute() {
        testHasEmail(LDAPUserInfoImplTest.USER, false, false);
    }

    @Test
    public void testHasNonExistingEmailByCustomAttribute() {
        testHasEmail(LDAPUserInfoImplTest.MANAGER, false, true);
    }
    ...
    public void testGetExistingEmailForUserByDefaultAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.JOHN, "johndoe@jbpm.org", false);
    }

    @Test
    public void testGetExistingEmailForUserDnByDefaultAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.JOHN_DN, "johndoe@jbpm.org", false);
    }

    @Test
    public void testGetExistingEmailForUserByCustomAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.MARY, "marysnow@jbpm.org", true);
    }

    @Test
    public void testGetExistingEmailForUserDnByCustomAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.MARY_DN, "marysnow@jbpm.org", true);
    }

    @Test
    public void testGetNonExistingEmailForUserByDefaultAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.MARY, null, false);
    }

    @Test
    public void testGetNonExistingEmailForUserByCustomAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.JOHN, null, true);
    }

    @Test
    public void testGetExistingEmailForGroupByDefaultAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.MANAGER, "manager@jbpm.org", false);
    }

    @Test
    public void testGetExistingEmailForGroupDnByDefaultAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.MANAGER_DN, "manager@jbpm.org", false);
    }

    @Test
    public void testGetExistingEmailForGroupByCustomAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.USER, "user@jbpm.org", true);
    }

    @Test
    public void testGetExistingEmailForGroupDnByCustomAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.USER_DN, "user@jbpm.org", true);
    }

    @Test
    public void testGetNonExistingEmailForGroupByDefaultAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.USER, null, false);
    }

    @Test
    public void testGetNonExistingEmailForGroupByCustomAttribute() {
        testGetEmailForEntity(LDAPUserInfoImplTest.MANAGER, null, true);
    }
    ...
    public void testGetLanguageForUserByDefaultAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.JOHN, "en-US", false);
    }

    @Test
    public void testGetLanguageForUserDnByDefaultAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.JOHN_DN, "en-US", false);
    }

    @Test
    public void testGetLanguageForUserByCustomAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.MARY, "fr-FR", true);
    }

    @Test
    public void testGetLanguageForUserDnByCustomAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.MARY_DN, "fr-FR", true);
    }

    @Test
    public void testGetDefaultLanguageForUserByDefaultAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.MARY, "en-UK", false);
    }

    @Test
    public void testGetDefaultLanguageForUserByCustomAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.JOHN, "en-UK", true);
    }

    @Test
    public void testGetLanguageForGroupByDefaultAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.MANAGER, "en-US", false);
    }

    @Test
    public void testGetLanguageForGroupDnByDefaultAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.MANAGER_DN, "en-US", false);
    }

    @Test
    public void testGetLanguageForGroupByCustomAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.USER, "fr-FR", true);
    }

    @Test
    public void testGetLanguageForGroupDnByCustomAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.USER_DN, "fr-FR", true);
    }

    @Test
    public void testGetDefaultLanguageForGroupByDefaultAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.USER, "en-UK", false);
    }

    @Test
    public void testGetDefaultLanguageForGroupByCustomAttribute() {
        testGetLanguageForEntity(LDAPUserInfoImplTest.MANAGER, "en-UK", true);
    }
    ...
    private void assertUsers(UserInfo userInfo, boolean john, boolean mary, boolean peter, boolean mike) {
        ...
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.JOHN)).as(LDAPUserInfoImplTest.JOHN.getId()).isEqualTo((john ? LDAPUserInfoImplTest.JOHN.getId() : null));
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.MARY)).as(LDAPUserInfoImplTest.MARY.getId()).isEqualTo((mary ? LDAPUserInfoImplTest.MARY.getId() : null));
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.PETER)).as(LDAPUserInfoImplTest.PETER.getId()).isEqualTo((peter ? LDAPUserInfoImplTest.PETER.getId() : null));
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.MIKE)).as(LDAPUserInfoImplTest.MIKE.getId()).isEqualTo((mike ? LDAPUserInfoImplTest.MIKE.getId() : null));
    ...
    private void assertGroups(UserInfo userInfo, boolean manager, boolean user, boolean analyst, boolean developer) {
        Assertions.assertThat(userInfo).isNotNull();
        SoftAssertions assertions = new SoftAssertions();
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.MANAGER)).as(LDAPUserInfoImplTest.MANAGER.getId()).isEqualTo((manager ? LDAPUserInfoImplTest.MANAGER.getId() : null));
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.USER)).as(LDAPUserInfoImplTest.USER.getId()).isEqualTo((user ? LDAPUserInfoImplTest.USER.getId() : null));
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.ANALYST)).as(LDAPUserInfoImplTest.ANALYST.getId()).isEqualTo((analyst ? LDAPUserInfoImplTest.ANALYST.getId() : null));
        assertions.assertThat(userInfo.getDisplayName(LDAPUserInfoImplTest.DEVELOPER)).as(LDAPUserInfoImplTest.DEVELOPER.getId()).isEqualTo((developer ? LDAPUserInfoImplTest.DEVELOPER.getId() : null));
        assertions.assertAll();
    }
