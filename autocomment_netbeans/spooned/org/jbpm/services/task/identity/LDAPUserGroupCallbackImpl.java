...
public class LDAPUserGroupCallbackImpl extends AbstractLDAPUserGroupInfo implements UserGroupCallback {
    ...
    private static final String[] REQUIRED_PROPERTIES = new String[]{ LDAPUserGroupCallbackImpl.USER_CTX , LDAPUserGroupCallbackImpl.ROLE_CTX , LDAPUserGroupCallbackImpl.USER_FILTER , LDAPUserGroupCallbackImpl.ROLE_FILTER , LDAPUserGroupCallbackImpl.USER_ROLES_FILTER };
    ...
    public LDAPUserGroupCallbackImpl(boolean activate) {
        super(LDAPUserGroupCallbackImpl.REQUIRED_PROPERTIES, LDAPUserGroupCallbackImpl.DEFAULT_PROPERTIES_NAME);
    }
    ...
    public LDAPUserGroupCallbackImpl(Properties config) {
        super(LDAPUserGroupCallbackImpl.REQUIRED_PROPERTIES, config);
    }

    @Override
    public boolean existsUser(String userId) {
        String context = getConfigProperty(LDAPUserGroupCallbackImpl.USER_CTX);
        String filter = getConfigProperty(LDAPUserGroupCallbackImpl.USER_FILTER);
        String attributeId = getConfigProperty(LDAPUserGroupCallbackImpl.USER_ATTR_ID, DEFAULT_USER_ATTR_ID);
        return existsEntity(userId, context, filter, attributeId);
    }

    @Override
    public boolean existsGroup(String groupId) {
        String context = getConfigProperty(LDAPUserGroupCallbackImpl.ROLE_CTX);
        String filter = getConfigProperty(LDAPUserGroupCallbackImpl.ROLE_FILTER);
        String attributeId = getConfigProperty(LDAPUserGroupCallbackImpl.ROLE_ATTR_ID, DEFAULT_ROLE_ATTR_ID);
    ...
    public List<String> getGroupsForUser(String userId, List<String> groupIds, List<String> allExistingGroupIds) {
        String roleContext = getConfigProperty(LDAPUserGroupCallbackImpl.USER_ROLES_CTX, getConfigProperty(LDAPUserGroupCallbackImpl.ROLE_CTX));
        String roleFilter = getConfigProperty(LDAPUserGroupCallbackImpl.USER_ROLES_FILTER);
        String roleAttributeId = getConfigProperty(LDAPUserGroupCallbackImpl.ROLE_ATTR_ID, DEFAULT_ROLE_ATTR_ID);
        String userDn = userId;
        if (!(isUserIdDn())) {
            String userContext = getConfigProperty(LDAPUserGroupCallbackImpl.USER_CTX);
            String userFilter = getConfigProperty(LDAPUserGroupCallbackImpl.USER_FILTER);
    ...
    private boolean isUserIdDn() {
        return Boolean.parseBoolean(getConfigProperty(LDAPUserGroupCallbackImpl.IS_USER_ID_DN, LDAPUserGroupCallbackImpl.DEFAULT_USER_ID_DN));
    }
}
