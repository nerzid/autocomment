...
public class LDAPUserGroupCallbackImplTest extends LDAPBaseTest {
    ...
    private void assertUsers(UserGroupCallback userGroupCallback, boolean john, boolean mary, boolean peter, boolean mike) {
    ...
    private void assertGroups(UserGroupCallback userGroupCallback, boolean manager, boolean user, boolean analyst, boolean developer) {
        Assertions.assertThat(userGroupCallback).isNotNull();
        SoftAssertions assertions = new SoftAssertions();
