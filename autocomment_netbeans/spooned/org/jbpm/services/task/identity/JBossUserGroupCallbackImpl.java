...
public class JBossUserGroupCallbackImpl extends AbstractUserGroupInfo implements UserGroupCallback {
    ...
    public JBossUserGroupCallbackImpl(String location) {
        Properties userGroups = readProperties(location, JBossUserGroupCallbackImpl.DEFAULT_PROPERTIES_LOCATION);
        JBossUserGroupCallbackImpl.logger.debug("Loaded properties {}", userGroups);
        init(userGroups);
    }
    ...
    protected void init(Properties userGroups) {
        ...
        JBossUserGroupCallbackImpl.this.separator = System.getProperty("org.jbpm.ht.user.separator", ",");
