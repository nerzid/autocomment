...
public class MockNotificationListener implements NotificationListener {
    ...
    public MockNotificationListener() {
        MockNotificationListener.eventsRecieved = new ArrayList<NotificationEvent>();
    }

    public void onNotification(NotificationEvent event, UserInfo userInfo) {
        // add NotificationEvent{event} to List{MockNotificationListener.eventsRecieved}
        MockNotificationListener.eventsRecieved.add(event);
    }

    public List<NotificationEvent> getEventsRecieved() {
        return MockNotificationListener.eventsRecieved;
    }
