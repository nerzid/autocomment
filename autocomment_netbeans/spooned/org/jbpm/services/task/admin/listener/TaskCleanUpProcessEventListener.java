...
public class TaskCleanUpProcessEventListener extends DefaultProcessEventListener {
    ...
    public TaskCleanUpProcessEventListener(TaskService taskService) {
        TaskCleanUpProcessEventListener.this.taskService = ((InternalTaskService) (taskService));
    }
    ...
    public void afterProcessCompleted(ProcessCompletedEvent event) {
        ...
        List<TaskSummary> completedTasksByProcessId = ((InternalTaskService) (taskService)).execute(new org.jbpm.services.task.commands.GetTasksForProcessCommand(event.getProcessInstance().getId(), statuses, "en-UK"));
        // archive and remove
    ...
    public void setTaskService(InternalTaskService taskService) {
        TaskCleanUpProcessEventListener.this.taskService = taskService;
    }
}
