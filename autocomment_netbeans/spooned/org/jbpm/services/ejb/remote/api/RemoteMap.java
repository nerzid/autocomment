 ...
 */
public class RemoteMap extends AbstractRemoteObject implements Serializable , Map<String, Object> {
    ...
    public void putAll(Map<? extends String, ? extends Object> input) {
        ...
        for (Map.Entry<? extends String, ? extends Object> entry : input.entrySet()) {
