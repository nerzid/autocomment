...
public class ClientUserTaskServiceEJBTest extends UserTaskServiceImplTest {
    ...
    protected void configureServices() {
        try {
            ...
            DeploymentServiceEJBRemote deploymentService = factory.getService(ClientUserTaskServiceEJBTest.application, DeploymentServiceEJBRemote.class);
            ProcessServiceEJBRemote processService = factory.getService(ClientUserTaskServiceEJBTest.application, ProcessServiceEJBRemote.class);
            RuntimeDataServiceEJBRemote runtimeDataService = factory.getService(ClientUserTaskServiceEJBTest.application, RuntimeDataServiceEJBRemote.class);
            DefinitionServiceEJBRemote definitionService = factory.getService(ClientUserTaskServiceEJBTest.application, DefinitionServiceEJBRemote.class);
            UserTaskServiceEJBRemote userTaskService = factory.getService(ClientUserTaskServiceEJBTest.application, UserTaskServiceEJBRemote.class);
