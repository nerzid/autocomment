...
public class ClientDefinitionServiceEJBTest extends BPMN2DataServicesTest {
    ...
    protected void configureServices() {
        try {
            ...
            DeploymentServiceEJBRemote deploymentService = factory.getService(ClientDefinitionServiceEJBTest.application, DeploymentServiceEJBRemote.class);
            ProcessServiceEJBRemote processService = factory.getService(ClientDefinitionServiceEJBTest.application, ProcessServiceEJBRemote.class);
            RuntimeDataServiceEJBRemote runtimeDataService = factory.getService(ClientDefinitionServiceEJBTest.application, RuntimeDataServiceEJBRemote.class);
            DefinitionServiceEJBRemote definitionService = factory.getService(ClientDefinitionServiceEJBTest.application, DefinitionServiceEJBRemote.class);
            UserTaskServiceEJBRemote userTaskService = factory.getService(ClientDefinitionServiceEJBTest.application, UserTaskServiceEJBRemote.class);
