...
public class ClientProcessServiceEJBTest extends ProcessServiceImplTest {
    ...
    protected void configureServices() {
        try {
            ...
            DeploymentServiceEJBRemote deploymentService = factory.getService(ClientProcessServiceEJBTest.application, DeploymentServiceEJBRemote.class);
            ProcessServiceEJBRemote processService = factory.getService(ClientProcessServiceEJBTest.application, ProcessServiceEJBRemote.class);
            RuntimeDataServiceEJBRemote runtimeDataService = factory.getService(ClientProcessServiceEJBTest.application, RuntimeDataServiceEJBRemote.class);
            DefinitionServiceEJBRemote definitionService = factory.getService(ClientProcessServiceEJBTest.application, DefinitionServiceEJBRemote.class);
            UserTaskServiceEJBRemote userTaskService = factory.getService(ClientProcessServiceEJBTest.application, UserTaskServiceEJBRemote.class);
