...
public class DeploymentServiceWrapper implements DeploymentService {
    ...
    public DeploymentServiceWrapper(DeploymentServiceEJBRemote remote) {
        DeploymentServiceWrapper.this.remote = remote;
    }

    @Override
    public void deploy(DeploymentUnit unit) {
        KModuleDeploymentUnit kmoduleUnit = ((KModuleDeploymentUnit) (unit));
        remote.deploy(kmoduleUnit.getGroupId(), kmoduleUnit.getArtifactId(), kmoduleUnit.getVersion(), kmoduleUnit.getKbaseName(), kmoduleUnit.getKsessionName(), kmoduleUnit.getStrategy().toString());
    }
