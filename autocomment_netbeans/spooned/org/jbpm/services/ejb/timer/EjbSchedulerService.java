...
public class EjbSchedulerService implements GlobalSchedulerService {
    ...
    private SchedulerServiceInterceptor interceptor = new org.jbpm.process.core.timer.impl.DelegateSchedulerServiceInterceptor(EjbSchedulerService.this);
    ...
    public void initScheduler(TimerService timerService) {
        EjbSchedulerService.this.globalTimerService = timerService;
        try {
            EjbSchedulerService.this.scheduler = InitialContext.doLookup("java:module/EJBTimerScheduler");
    ...
    public void setInterceptor(SchedulerServiceInterceptor interceptor) {
        EjbSchedulerService.this.interceptor = interceptor;
    }
