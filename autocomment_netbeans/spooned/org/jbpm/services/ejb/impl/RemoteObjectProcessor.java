...
public class RemoteObjectProcessor {
    ...
    public static <T> T processRemoteObjects(T variables, ClassLoader cl) {
        if (variables instanceof RemoteMap) {
            ...
            if (variables instanceof org.jbpm.services.ejb.remote.api.RemoteObject) {
                ((org.jbpm.services.ejb.remote.api.RemoteObject) (variables)).setClassLoader(cl);
                return ((T) (((org.jbpm.services.ejb.remote.api.RemoteObject) (variables)).get()));
            }
