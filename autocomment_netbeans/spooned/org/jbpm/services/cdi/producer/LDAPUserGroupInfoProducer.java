...
public class LDAPUserGroupInfoProducer implements UserGroupInfoProducer {
    private UserGroupCallback callback = new org.jbpm.services.task.identity.LDAPUserGroupCallbackImpl(true);

    private UserInfo userInfo = new org.jbpm.services.task.identity.LDAPUserInfoImpl(true);
