...
public class JAASUserGroupInfoProducer implements UserGroupInfoProducer {
    private UserGroupCallback callback = new org.jbpm.services.task.identity.JAASUserGroupCallbackImpl(true);

    private UserInfo userInfo = new org.jbpm.services.task.identity.DefaultUserInfo(true);
