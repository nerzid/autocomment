...
public class RuntimeDataServiceCDIImplTest extends RuntimeDataServiceImplTest {
    ...
    public void removeAllData() {
        ...
        deleted += commandService.execute(new org.jbpm.shared.services.impl.commands.UpdateStringCommand("delete from  AuditTaskImpl at"));
        deleted += commandService.execute(new org.jbpm.shared.services.impl.commands.UpdateStringCommand("delete from  TaskEventImpl te"));
        deleted += commandService.execute(new org.jbpm.shared.services.impl.commands.UpdateStringCommand("delete from  TaskVariableImpl te"));
        RuntimeDataServiceCDIImplTest.logger.debug(("Deleted " + deleted));
    }
}
