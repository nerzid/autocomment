...
public class HumanResourcesHiringTest extends AbstractKieServicesBaseTest {
    ...
    public void simpleExecutionTest() {
        ...
        auditEventBuilder.setIdentityProvider(new org.jbpm.services.cdi.test.TestIdentifyProviderCDI());
    ...
    private void testHiringProcess(RuntimeManager manager, Context<?> context) {
        ...
        Collection<NodeInstanceDesc> activeNodes = runtimeDataService.getProcessInstanceHistoryActive(processInstance.getId(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(activeNodes);
        Assert.assertEquals(1, activeNodes.size());
        Collection<NodeInstanceDesc> completedNodes = runtimeDataService.getProcessInstanceHistoryCompleted(processInstance.getId(), new org.kie.api.runtime.query.QueryContext());
        ...
        activeNodes = runtimeDataService.getProcessInstanceHistoryActive(processInstance.getId(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(activeNodes);
        Assert.assertEquals(1, activeNodes.size());
        completedNodes = runtimeDataService.getProcessInstanceHistoryCompleted(processInstance.getId(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(completedNodes);
        Assert.assertEquals(2, completedNodes.size());
        ...
        Assert.assertEquals(7, taskContent.size());
        Assert.assertEquals("salaboy@gmail.com", taskContent.get("in_mail"));
        Assert.assertEquals(29, taskContent.get("in_age"));
        Assert.assertEquals("salaboy", taskContent.get("in_name"));
        ...
        completedNodes = runtimeDataService.getProcessInstanceHistoryCompleted(processInstance.getId(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(completedNodes);
        Assert.assertEquals(3, completedNodes.size());
        ...
        Assert.assertEquals(6, taskContent.size());
        Assert.assertEquals(8, taskContent.get("in_tech_score"));
        Assert.assertEquals(8, taskContent.get("in_hr_score"));
        ...
        completedNodes = runtimeDataService.getProcessInstanceHistoryCompleted(processInstance.getId(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(completedNodes);
        Assert.assertEquals(5, completedNodes.size());
        ...
        taskContent = ((Map<String, Object>) (ContentMarshallerHelper.unmarshall(contentById.getContent(), null)));
        Assert.assertEquals(6, taskContent.size());
        Assert.assertEquals(10000, taskContent.get("in_offering"));
        Assert.assertEquals("salaboy", taskContent.get("in_name"));
        ...
        completedNodes = runtimeDataService.getProcessInstanceHistoryCompleted(processInstance.getId(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(completedNodes);
        Assert.assertEquals(8, completedNodes.size());
        int removeAllTasks = ((InternalTaskService) (taskService)).removeAllTasks();
        HumanResourcesHiringTest.logger.debug(">>> Removed Tasks > {}", removeAllTasks);
    }
}
