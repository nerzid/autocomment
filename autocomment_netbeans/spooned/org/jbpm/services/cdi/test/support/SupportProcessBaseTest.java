...
public abstract class SupportProcessBaseTest extends AbstractKieServicesBaseTest {
    ...
    public void prepare() {
        ...
        customDescriptor.getBuilder().addTaskEventListener(new org.kie.internal.runtime.conf.ObjectModel("org.jbpm.services.cdi.test.ext.DebugTaskLifeCycleEventListener"));
    ...
    public void testSupportProcess() {
        DeploymentUnit deploymentUnitSupport = new org.jbpm.kie.services.impl.KModuleDeploymentUnit(GROUP_ID, ARTIFACT_ID, VERSION);
        ...
        Assert.assertEquals(0, currentNumberOfEvents);
        ...
        Assert.assertEquals(1, taskOutputMappings.size());
