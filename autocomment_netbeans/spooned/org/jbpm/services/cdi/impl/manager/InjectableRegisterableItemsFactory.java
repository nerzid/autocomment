...
public class InjectableRegisterableItemsFactory extends DefaultRegisterableItemsFactory {
    ...
    public Map<String, WorkItemHandler> getWorkItemHandlers(RuntimeEngine runtime) {
        ...
        try {
            ...
            InjectableRegisterableItemsFactory.logger.debug("Executor service not available due to {}", e.getMessage());
        }
        if ((kieContainer) != null) {
            ...
            if (StringUtils.isEmpty(ksessionName)) {
                ...
                if (ksessionModel == null) {
                    ksessionModel = ((KieContainerImpl) (kieContainer)).getKieSessionModel(InjectableRegisterableItemsFactory.DEFAULT_KIE_SESSION);
                } 
            } else {
        ...
        try {
            ...
            InjectableRegisterableItemsFactory.logger.warn("Exception while evalutating work item handler prodcuers {}", e.getMessage());
        }
    ...
    public List<ProcessEventListener> getProcessEventListeners(RuntimeEngine runtime) {
        ...
        try {
            ...
            InjectableRegisterableItemsFactory.logger.warn("Exception while evaluating ProcessEventListener producers {}", e.getMessage());
        }
    ...
    public List<RuleRuntimeEventListener> getRuleRuntimeEventListeners(RuntimeEngine runtime) {
        ...
        try {
            ...
            InjectableRegisterableItemsFactory.logger.warn("Exception while evaluating WorkingMemoryEventListener producers {}", e.getMessage());
        }
        // add listeners from descriptor
    ...
    public List<AgendaEventListener> getAgendaEventListeners(RuntimeEngine runtime) {
        ...
        defaultListeners.add(new org.jbpm.process.instance.event.listeners.TriggerRulesEventListener(runtime.getKieSession()));
        try {
    ...
    public List<TaskLifeCycleEventListener> getTaskListeners() {
        ...
        try {
            ...
            InjectableRegisterableItemsFactory.logger.warn("Cannot add listeners to task service due to {}", e.getMessage());
        }
        // add listeners from descriptor
    ...
    public Map<String, Object> getGlobals(RuntimeEngine runtime) {
        ...
        try {
            ...
            // do nothing as work item handler is considered optional
            InjectableRegisterableItemsFactory.logger.warn("Exception while evalutating globals prodcuers {}", e.getMessage());
        }
    ...
    public static RegisterableItemsFactory getFactory(BeanManager beanManager, AbstractAuditLogger auditlogger) {
        InjectableRegisterableItemsFactory instance = InjectableRegisterableItemsFactory.getInstanceByType(beanManager, InjectableRegisterableItemsFactory.class, new Annotation[]{  });
    ...
    public void setAuditlogger(AbstractAuditLogger auditlogger) {
        InjectableRegisterableItemsFactory.this.auditlogger = auditlogger;
    }
    ...
    public void setKieContainer(KieContainer kieContainer) {
        InjectableRegisterableItemsFactory.this.kieContainer = kieContainer;
    }
    ...
    public void setKsessionName(String ksessionName) {
        InjectableRegisterableItemsFactory.this.ksessionName = ksessionName;
    }
    ...
    protected AbstractAuditLogger getAuditLoggerInstance(RuntimeEngine engine) {
        ...
        if (("true".equals(System.getProperty("jbpm.audit.jms.enabled"))) || ((descriptor.getAuditMode()) == (AuditMode.JMS))) {
            try {
                ...
                InjectableRegisterableItemsFactory.logger.error("Unable to load jms audit properties from {}", "/jbpm.audit.jms.properties", e);
            }
            ...
            if (descriptor.getPersistenceUnit().equals(descriptor.getAuditPersistenceUnit())) {
                ...
                auditLogger = new org.jbpm.process.audit.JPAWorkingMemoryDbLogger(EntityManagerFactoryManager.get().getOrCreate(descriptor.getAuditPersistenceUnit()));
            }
            auditLogger.setBuilder(getAuditBuilder(engine));
        } 
        return auditLogger;
