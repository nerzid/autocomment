...
public class PersistDataSetCDIListener extends PersistDataSetListener {
    ...
    public void onDataSetDefStale(@Observes
    DataSetStaleEvent event) {
        super.onDataSetDefStale(event.getDataSetDef());
    }

    public void onDataSetDefModified(@Observes
    DataSetDefModifiedEvent event) {
        super.onDataSetDefModified(event.getOldDataSetDef(), event.getNewDataSetDef());
    }

    public void onDataSetDefRegistered(@Observes
    DataSetDefRegisteredEvent event) {
        super.onDataSetDefRegistered(event.getDataSetDef());
    }

    public void onDataSetDefRemoved(@Observes
    DataSetDefRemovedEvent event) {
