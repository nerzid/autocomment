...
public class IdentityProviderCDIWrapper implements IdentityProvider {
    ...
    public String getName() {
        ...
        try {
            ...
            IdentityProviderCDIWrapper.logger.debug("Used original identity provider with user: {}", name);
    ...
    public List<String> getRoles() {
        ...
        try {
            ...
            IdentityProviderCDIWrapper.logger.debug("Used original identity provider with roles: {}", roles);
        } catch (ContextNotActiveException e) {
