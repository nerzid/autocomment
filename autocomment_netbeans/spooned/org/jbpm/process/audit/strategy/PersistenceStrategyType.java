...
KIE_SESSION, STANDALONE_JTA, STANDALONE_JTA_SPRING_SHARED_EM, STANDALONE_LOCAL_SPRING_SHARED_EM, STANDALONE_LOCAL;
    ...
    public static PersistenceStrategy getPersistenceStrategy(PersistenceStrategyType type, Environment env, EntityManagerFactory emf, String persistenceUnitName) {
        ...
        if (env != null) {
            emf = ((EntityManagerFactory) (env.get(ENTITY_MANAGER_FACTORY)));
            // in case there is entity manager already available and the type is shared entity manager then use this
            em = ((EntityManager) (env.get(CMD_SCOPED_ENTITY_MANAGER)));
        }
            ...
            case STANDALONE_JTA :
                if (emf != null) {
                    ...
                    if (persistenceUnitName != null) {
                        persistenceStrategy = new StandaloneJtaStrategy(javax.persistence.Persistence.createEntityManagerFactory(persistenceUnitName));
                    }else {
