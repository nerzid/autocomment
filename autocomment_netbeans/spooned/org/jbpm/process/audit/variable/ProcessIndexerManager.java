...
import org.kie.api.runtime.manager.audit.org.jbpm.process.audit.VariableInstanceLog;
...
public class ProcessIndexerManager {
    ...
    private ProcessIndexerManager() {
        for (ProcessVariableIndexer indexer : ProcessIndexerManager.taskVariableIndexers) {
    ...
    public static ProcessIndexerManager get() {
        if ((ProcessIndexerManager.INSTANCE) == null) {
            ProcessIndexerManager.INSTANCE = new ProcessIndexerManager();
        }
        return ProcessIndexerManager.INSTANCE;
    }
}
