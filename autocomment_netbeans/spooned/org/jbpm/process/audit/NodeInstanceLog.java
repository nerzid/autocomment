...
public class NodeInstanceLog implements NodeInstanceLog , Serializable , AuditEvent {
    ...
    @Id
    @GeneratedValue(generator = "nodeInstanceLogIdSeq", strategy = GenerationType.AUTO)
    private long id;
    ...
    public String toString() {
        return ((((((((((((type) == 0 ? "Triggered " : "Left ") + "Node Instance '") + (processId)) + "#") + (nodeId)) + "' (") + (nodeName)) + ") [") + (processInstanceId)) + "#") + (nodeInstanceId)) + "]";
    }
