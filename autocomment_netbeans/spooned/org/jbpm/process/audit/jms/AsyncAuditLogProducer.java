...
public class AsyncAuditLogProducer extends AbstractAuditLogger {
    ...
    public AsyncAuditLogProducer(KieSession session, boolean transacted) {
        super(session);
        AsyncAuditLogProducer.this.transacted = transacted;
        session.addEventListener(AsyncAuditLogProducer.this);
    }
    ...
    public void setConnectionFactory(ConnectionFactory connectionFactory) {
        AsyncAuditLogProducer.this.connectionFactory = connectionFactory;
    }
    ...
    public void setQueue(Queue queue) {
        AsyncAuditLogProducer.this.queue = queue;
    }
        ...
        try {
            ...
            if (producer != null) {
                try {
                    ...
                    AsyncAuditLogProducer.logger.warn("Error when closing producer", e);
                }
            } 
            if (queueSession != null) {
                try {
                    ...
                    AsyncAuditLogProducer.logger.warn("Error when closing queue session", e);
                }
            } 
            if (queueConnection != null) {
                try {
                    ...
                    AsyncAuditLogProducer.logger.warn("Error when closing queue connection", e);
                }
            } 
        }
    }
