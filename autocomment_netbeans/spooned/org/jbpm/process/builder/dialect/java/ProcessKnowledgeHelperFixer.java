...
public class ProcessKnowledgeHelperFixer {
    ...
    static {
        ...
        ProcessKnowledgeHelperFixer.macros.put("insert", new Macro() {
    ...
    public static String fix(final String raw) {
        ...
        // set macros Map{ProcessKnowledgeHelperFixer.macros} to MacroProcessor{macroProcessor}
        macroProcessor.setMacros(ProcessKnowledgeHelperFixer.macros);
