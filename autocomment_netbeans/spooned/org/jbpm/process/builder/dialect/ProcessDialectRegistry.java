...
public class ProcessDialectRegistry {
    ...
    static {
        ProcessDialectRegistry.dialects = new ConcurrentHashMap<String, ProcessDialect>();
        ProcessDialectRegistry.dialects.put("java", new JavaProcessDialect());
        ProcessDialectRegistry.dialects.put("mvel", new MVELProcessDialect());
        ProcessDialectRegistry.dialects.put("JavaScript", new JavaScriptProcessDialect());
    }
    ...
    public static void setDialect(String dialectName, ProcessDialect dialect) {
        // put String{dialectName} to ConcurrentMap{ProcessDialectRegistry.dialects}
