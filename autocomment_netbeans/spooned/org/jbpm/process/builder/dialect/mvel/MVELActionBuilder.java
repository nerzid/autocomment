        ...
        if (contextResolver != null) {
            for (String variableName : variableNames) {
                ...
                if (variableScope == null) {
                    context.getErrors().add(new org.drools.compiler.compiler.DescrBuildError(context.getParentDescr(), actionDescr, null, ((((("Could not find variable '" + variableName) + "' ") + "for action '") + (actionDescr.getText())) + "'")));
                } else {
