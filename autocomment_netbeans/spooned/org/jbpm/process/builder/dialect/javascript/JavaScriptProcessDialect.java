...
public class JavaScriptProcessDialect implements ProcessDialect {
    ...
    public ActionBuilder getActionBuilder() {
        return JavaScriptProcessDialect.actionBuilder;
    }

    public ProcessClassBuilder getProcessClassBuilder() {
        throw new UnsupportedOperationException("JavaScriptProcessDialect.getProcessClassBuilder is not supported");
    }

    public ReturnValueEvaluatorBuilder getReturnValueEvaluatorBuilder() {
        return JavaScriptProcessDialect.returnValueEvaluatorBuilder;
    }

    public AssignmentBuilder getAssignmentBuilder() {
        throw new UnsupportedOperationException("JavaScript assignments not supported");
    }
}
