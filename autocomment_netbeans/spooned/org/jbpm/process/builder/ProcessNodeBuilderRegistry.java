...
public class ProcessNodeBuilderRegistry {
    ...
    public ProcessNodeBuilderRegistry() {
        ...
        register(RuleSetNode.class, new RuleSetNodeBuilder());
        register(SubProcessNode.class, new SubProcessNodeBuilder());
        register(HumanTaskNode.class, new WorkItemNodeBuilder());
        register(WorkItemNode.class, new WorkItemNodeBuilder());
        ...
        register(CompositeContextNode.class, new EventBasedNodeBuilder());
        register(EventSubProcessNode.class, new EventBasedNodeBuilder());
        register(StateNode.class, new EventBasedNodeBuilder());
        register(NodeImpl.class, new MultiConditionalSequenceFlowNodeBuilder());
        register(ForEachNode.class, new EventBasedNodeBuilder());
        register(EventNode.class, new EventNodeBuilder());
        register(BoundaryEventNode.class, new EventNodeBuilder());
        register(DynamicNode.class, new ExtendedNodeBuilder());
    }
