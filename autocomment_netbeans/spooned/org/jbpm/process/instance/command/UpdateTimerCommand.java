...
public class UpdateTimerCommand implements GenericCommand<Void> , ProcessInstanceIdCommand {
    ...
    public UpdateTimerCommand(long processInstanceId, String timerName, long delay, long period, int repeatLimit) {
        UpdateTimerCommand.this.processInstanceId = processInstanceId;
        UpdateTimerCommand.this.timerName = timerName;
        UpdateTimerCommand.this.delay = delay;
        UpdateTimerCommand.this.period = period;
        UpdateTimerCommand.this.repeatLimit = repeatLimit;
    }
    ...
    public void setProcessInstanceId(Long procInstId) {
        UpdateTimerCommand.this.processInstanceId = procInstId;
    }
