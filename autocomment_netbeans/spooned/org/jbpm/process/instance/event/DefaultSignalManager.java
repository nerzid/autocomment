...
public class DefaultSignalManager implements SignalManager {
    ...
    public DefaultSignalManager(InternalKnowledgeRuntime kruntime) {
        DefaultSignalManager.this.kruntime = kruntime;
    }
    ...
    public void signalEvent(String type, Object event) {
        kruntime.queueWorkingMemoryAction(new DefaultSignalManager.SignalAction(type, event));
    ...
    public void signalEvent(long processInstanceId, String type, Object event) {
        ...
        if (processInstance != null) {
            kruntime.queueWorkingMemoryAction(new DefaultSignalManager.SignalProcessInstanceAction(processInstanceId, type, event));
            kruntime.executeQueuedActions();
        } 
    }
    ...
    public static class SignalProcessInstanceAction extends PropagationEntry.AbstractPropagationEntry implements WorkingMemoryAction {
        ...
        public SignalProcessInstanceAction(long processInstanceId, String type, Object event) {
            DefaultSignalManager.SignalProcessInstanceAction.this.processInstanceId = processInstanceId;
            DefaultSignalManager.SignalProcessInstanceAction.this.type = type;
            DefaultSignalManager.SignalProcessInstanceAction.this.event = event;
        }
    ...
    public static class SignalAction extends PropagationEntry.AbstractPropagationEntry implements WorkingMemoryAction {
        ...
        public SignalAction(String type, Object event) {
            DefaultSignalManager.SignalAction.this.type = type;
            DefaultSignalManager.SignalAction.this.event = event;
        }
