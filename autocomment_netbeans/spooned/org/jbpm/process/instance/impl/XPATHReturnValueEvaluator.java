...
public class XPATHReturnValueEvaluator implements ReturnValueEvaluator , Externalizable {
    ...
    public XPATHReturnValueEvaluator(final String expression, final String id) {
        XPATHReturnValueEvaluator.this.expression = expression;
        XPATHReturnValueEvaluator.this.id = id;
    }
    ...
    public String getDialect() {
        return XPATHReturnValueEvaluator.this.id;
    }
    ...
    public Object evaluate(final ProcessContext context) throws Exception {
        ...
        return xpathEvaluator.evaluate(XPATHReturnValueEvaluator.this.expression, builder.newDocument(), XPathConstants.BOOLEAN);
    }

    public String toString() {
        return XPATHReturnValueEvaluator.this.expression;
    }
}
