...
public class ProcessInstanceFactoryRegistry {
    ...
    private ProcessInstanceFactoryRegistry() {
        ProcessInstanceFactoryRegistry.this.registry = new HashMap<Class<? extends Process>, ProcessInstanceFactory>();
        // hard wired nodes:
        register(RuleFlowProcess.class, new org.jbpm.ruleflow.instance.RuleFlowProcessInstanceFactory());
    }

    public void register(Class<? extends Process> cls, ProcessInstanceFactory factory) {
        ProcessInstanceFactoryRegistry.this.registry.put(cls, factory);
    }

    public ProcessInstanceFactory getProcessInstanceFactory(Process process) {
        return ProcessInstanceFactoryRegistry.this.registry.get(process.getClass());
    }
}
