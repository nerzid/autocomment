...
public class VariableScopeInstance extends AbstractContextInstance {
    ...
    public Object getVariable(String name) {
        ...
        if (((getProcessInstance()) != null) && ((getProcessInstance().getKnowledgeRuntime()) != null)) {
            ...
            Collection<CaseData> caseFiles = ((Collection<CaseData>) (getProcessInstance().getKnowledgeRuntime().getObjects(new org.drools.core.ClassObjectFilter(CaseData.class))));
            if ((caseFiles.size()) == 1) {
    ...
    public void setContextInstanceContainer(ContextInstanceContainer contextInstanceContainer) {
        ...
        if (contextInstanceContainer instanceof CompositeContextNodeInstance) {
            VariableScopeInstance.this.variableIdPrefix = ((Node) (((CompositeContextNodeInstance) (contextInstanceContainer)).getNode())).getUniqueId();
            VariableScopeInstance.this.variableInstanceIdPrefix = ((CompositeContextNodeInstance) (contextInstanceContainer)).getUniqueId();
        } 
    }
}
