...
public abstract class AbstractContextInstance implements Serializable , ContextInstance {
    ...
    public void setContextId(long contextId) {
        AbstractContextInstance.this.contextId = contextId;
    }
    ...
    public void setContextInstanceContainer(ContextInstanceContainer contextInstanceContainer) {
        AbstractContextInstance.this.contextInstanceContainer = contextInstanceContainer;
    }
    ...
    public void setProcessInstance(ProcessInstance processInstance) {
        AbstractContextInstance.this.processInstance = processInstance;
    }
}
