...
public final class StartProcessHelper {
    ...
    private static String comparatorClass = System.getProperty(StartProcessHelper.PROCESS_COMPARATOR_CLASS_KEY);
    ...
    public static Comparator<Process> getComparator(String name) {
        if ((StartProcessHelper.comparatorClass) != null) {
            try {
                Class<Comparator<Process>> comparatorClazz = ((Class<Comparator<Process>>) (Class.forName(StartProcessHelper.comparatorClass)));
