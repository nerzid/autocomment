...
public class BroadcastEventTypeFilter extends EventTypeFilter {
    ...
    public boolean acceptsEvent(String type, Object event) {
        ...
        if ((BroadcastEventTypeFilter.this.type) != null) {
            if (BroadcastEventTypeFilter.this.type.equals(type)) {
                accepts = true;
            } else if ((type != null) && (type.startsWith(BroadcastEventTypeFilter.this.type))) {
                accepts = true;
            } 
        } 
        return accepts;
    ...
    public String toString() {
        return ("Broadcast Event filter: [" + (BroadcastEventTypeFilter.this.type)) + "]";
    }
}
