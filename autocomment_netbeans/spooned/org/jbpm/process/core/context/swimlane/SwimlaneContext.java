...
public class SwimlaneContext extends AbstractContext {
    ...
    public void addSwimlane(Swimlane swimlane) {
        SwimlaneContext.this.swimlanes.put(swimlane.getName(), swimlane);
    }

    public Swimlane getSwimlane(String name) {
        return SwimlaneContext.this.swimlanes.get(name);
    }

    public void removeSwimlane(String name) {
        SwimlaneContext.this.swimlanes.remove(name);
    }
    ...
    public void setSwimlanes(Collection<Swimlane> swimlanes) {
        SwimlaneContext.this.swimlanes.clear();
    ...
    public Context resolveContext(Object param) {
        if (param instanceof String) {
            return (getSwimlane(((String) (param)))) == null ? null : SwimlaneContext.this;
        } 
