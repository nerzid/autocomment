...
import BusinessCalendarImpl.DAYS_PER_WEEK;
import java.util.Date;
import BusinessCalendarImpl.HOLIDAYS;
import org.junit.Test;
import BusinessCalendarImpl.HOURS_PER_DAY;
import org.slf4j.LoggerFactory;
import BusinessCalendarImpl.WEEKEND_DAYS;
...
public class BusinessCalendarImplTest extends AbstractBaseTest {
    ...
    public void testCalculateHours() {
        ...
        // assert equals String{expectedDate} to void{Assert}
    ...
    public void testCalculateHoursCustomWorkingHours() {
        Properties config = new Properties();
        // set property void{HOURS_PER_DAY} to Properties{config}
        config.setProperty(HOURS_PER_DAY, "6");
    ...
    public void testCalculateHoursPassingOverCustomDefinedWeekend() {
        Properties config = new Properties();
        // set property void{WEEKEND_DAYS} to Properties{config}
    ...
    public void testCalculateMinutesPassingOverHoliday() {
        Properties config = new Properties();
        // set property void{HOLIDAYS} to Properties{config}
        config.setProperty(HOLIDAYS, "2012-05-12:2012-05-19");
    ...
    public void testCalculateDaysCustomWorkingDays() {
        Properties config = new Properties();
        // set property void{DAYS_PER_WEEK} to Properties{config}
        config.setProperty(DAYS_PER_WEEK, "4");
        // set property void{WEEKEND_DAYS} to Properties{config}
    ...
    public void testCalculateTimeDaysHoursMinutesHolidays() {
        Properties config = new Properties();
        // set property void{HOLIDAYS} to Properties{config}
        config.setProperty(HOLIDAYS, "2012-05-10:2012-05-19");
    ...
    public void testCalculateTimeDaysHoursMinutesSingleDayHolidays() {
        Properties config = new Properties();
        // set property void{HOLIDAYS} to Properties{config}
        config.setProperty(HOLIDAYS, "2012-05-07");
    ...
    public void testCalculateTimeDaysHoursMinutesSingleDayHolidaysInMiddleOfWeek() {
        Properties config = new Properties();
        // set property void{HOLIDAYS} to Properties{config}
        config.setProperty(HOLIDAYS, "2012-05-09");
    ...
    public void testCalculateDaysPassingOverHolidayAtYearEnd() {
        Properties config = new Properties();
        // set property void{HOLIDAYS} to Properties{config}
        config.setProperty(HOLIDAYS, "2012-12-31:2013-01-01");
    ...
    public void testCalculateDaysPassingOverHolidayAtYearEndWithWildcards() {
        Properties config = new Properties();
        // set property void{HOLIDAYS} to Properties{config}
        config.setProperty(HOLIDAYS, "*-12-31:*-01-01");
    ...
    public void testSingleHolidayWithinGivenTime() {
        ...
        // put void{HOLIDAYS} to Properties{props}
        props.put(HOLIDAYS, "2015-01-13");
