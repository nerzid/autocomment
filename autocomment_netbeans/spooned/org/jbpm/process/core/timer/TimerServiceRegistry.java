...
public class TimerServiceRegistry {
    ...
    public static TimerServiceRegistry getInstance() {
        return TimerServiceRegistry.instance;
    }
    ...
    public void registerTimerService(String id, TimerService timerService) {
        ...
        TimerServiceRegistry.this.registeredServices.put(id, timerService);
    }
    ...
    public TimerService get(String id) {
        ...
        return TimerServiceRegistry.this.registeredServices.get(id);
    }
    ...
    public TimerService remove(String id) {
        return TimerServiceRegistry.this.registeredServices.remove(id);
    }
}
