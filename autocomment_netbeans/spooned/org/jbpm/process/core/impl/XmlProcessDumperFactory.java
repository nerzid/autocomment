...
public class XmlProcessDumperFactory {
    ...
    public static XmlProcessDumper newXmlProcessDumperFactory() {
        return XmlProcessDumperFactory.getXmlProcessDumperFactoryService().newXmlProcessDumper();
    }
    ...
    public static synchronized XmlProcessDumperFactoryService getXmlProcessDumperFactoryService() {
        if ((XmlProcessDumperFactory.service) == null) {
            XmlProcessDumperFactory.loadProvider();
        } 
        return XmlProcessDumperFactory.service;
    }
    ...
    private static void loadProvider() {
        ...
        XmlProcessDumperFactory.setXmlProcessDumperFactoryService(ServiceRegistryImpl.getInstance().get(XmlProcessDumperFactoryService.class));
    }
}
