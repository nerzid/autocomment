...
public class ParserWorkItemHandlerTest {
    ...
    final String PERSON_XML = ((("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><person><age>" + (AGE)) + "</age><name>") + (NAME)) + "</name></person>";
    ...
    public void testXmlToObject() {
        ...
        handler.executeWorkItem(workItem, new ParserWorkItemHandlerTest.TestWorkItemManager(workItem));
    ...
    public void testObjectToXml() {
        ...
        Assert.assertEquals(PERSON_XML, result);
    }
    ...
    public void testObjectToJson() {
        ...
        handler.executeWorkItem(workItem, new ParserWorkItemHandlerTest.TestWorkItemManager(workItem));
        String result = ((String) (workItem.getResult(ParserWorkItemHandler.RESULT)));
        Assert.assertEquals(PERSON_JSON, result);
    }
    ...
    private class TestWorkItemManager implements WorkItemManager {
        ...
        TestWorkItemManager(WorkItem workItem) {
            ParserWorkItemHandlerTest.TestWorkItemManager.this.workItem = workItem;
        }
