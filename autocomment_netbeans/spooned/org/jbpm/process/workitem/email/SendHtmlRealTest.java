...
public class SendHtmlRealTest extends AbstractBaseTest {
    ...
    public void sendEmailViaAnotherDomain() throws Exception {
        ...
        // info String{"{} : {}"} to Logger{SendHtmlRealTest.logger}
        SendHtmlRealTest.logger.info("{} : {}", testMethodName, uniqueTestNum);
        WorkItemImpl workItem = new WorkItemImpl();
        // set parameter String{"To"} to WorkItemImpl{workItem}
        workItem.setParameter("To", toAddress);
        // set parameter String{"From"} to WorkItemImpl{workItem}
        workItem.setParameter("From", fromAddress);
        // set parameter String{"Reply-To"} to WorkItemImpl{workItem}
        workItem.setParameter("Reply-To", fromAddress);
        // set parameter String{"Subject"} to WorkItemImpl{workItem}
        workItem.setParameter("Subject", ((((this.getClass().getSimpleName()) + " test message [") + (uniqueTestNum)) + "]"));
        // set parameter String{"Body"} to WorkItemImpl{workItem}
        ...
        // set start boolean{true} to Connection{connection}
