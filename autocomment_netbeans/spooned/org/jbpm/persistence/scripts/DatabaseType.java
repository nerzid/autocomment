...
DB2("db2"), DERBY("derby"), H2("h2"), HSQLDB("hsqldb"), MYSQL5("mysql5"), MYSQLINNODB("mysqlinnodb"), ORACLE("oracle"), POSTGRESQL("postgresql"), SQLSERVER("sqlserver"), SQLSERVER2008("sqlserver2008");
    ...
    DatabaseType(String scriptsFolderName) {
        DatabaseType.this.scriptsFolderName = scriptsFolderName;
    }
    /**
