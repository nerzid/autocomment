...
public final class SQLScriptUtil {
     ...
     * @throws IOException
     */
    public static List<String> getCommandsFromScript(final File script, final DatabaseType databaseType) throws IOException {
     ...
     */
    private static void extractCommandsFromLine(final String line, final String delimiter, final StringBuilder bufferedCommand, final List<String> extractedCommands) {
