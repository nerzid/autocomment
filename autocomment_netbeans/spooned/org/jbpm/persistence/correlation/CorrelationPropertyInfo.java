...
public class CorrelationPropertyInfo implements Serializable , CorrelationProperty<String> {
    ...
    @Id
    @GeneratedValue(generator = "correlationPropertyInfoIdSeq", strategy = GenerationType.AUTO)
