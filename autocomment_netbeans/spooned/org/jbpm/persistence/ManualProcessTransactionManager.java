...
public class ManualProcessTransactionManager extends ManualTransactionManager {
    ...
    public ManualProcessTransactionManager(NonTransactionalProcessPersistentSession session, ProcessStorage storage) {
        super(session, storage);
        ManualProcessTransactionManager.this.storage = storage;
        ManualProcessTransactionManager.this.session = session;
    }
