...
public class GlobalJPATimerJobFactoryManager implements CommandServiceTimerJobFactoryManager {
    ...
    public void setCommandService(CommandService commandService) {
        GlobalJPATimerJobFactoryManager.this.commandService = commandService;
    }
    ...
    public TimerJobInstance createTimerJobInstance(Job job, JobContext ctx, Trigger trigger, JobHandle handle, InternalSchedulerService scheduler) {
        ...
        GlobalJpaTimerJobInstance jobInstance = new GlobalJpaTimerJobInstance(new org.drools.core.time.SelfRemovalJob(job), new SelfRemovalJobContext(ctx, emptyStore), trigger, handle, scheduler);
        return jobInstance;
    }
    ...
    public CommandService getCommandService() {
        return GlobalJPATimerJobFactoryManager.this.commandService;
    }
}
