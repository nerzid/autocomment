...
public class ContainerManagedTransactionManager implements TransactionManager {
    ...
    protected Object findTransactionSynchronizationRegistry() {
        ...
        try {
            ...
            ContainerManagedTransactionManager.logger.warn("Error when getting TransactionSynchronizationRegistry from JNDI ", ex);
            ...
            try {
                ...
                ContainerManagedTransactionManager.logger.debug("JTA TransactionSynchronizationRegistry found at default JNDI location [{}]", customJndiLocation);
                return tsrObject;
            } catch (Exception e1) {
                ContainerManagedTransactionManager.logger.debug("No JTA TransactionSynchronizationRegistry found at default JNDI location [{}]", customJndiLocation, ex);
            }
        }
        return null;
    }
