...
public abstract class MapPersistenceTest extends AbstractBaseTest {
    ...
    public void createProcessStartItDisposeAndLoadItAgain() {
        ...
        MapPersistenceTest.DummyWorkItemHandler handler = new MapPersistenceTest.DummyWorkItemHandler();
    ...
    public void executeMultipleProcessTest() {
        ...
        MapPersistenceTest.DummyWorkItemHandler handler1 = new MapPersistenceTest.DummyWorkItemHandler();
        ksession1.getWorkItemManager().registerWorkItemHandler(workName, handler1);
        MapPersistenceTest.DummyWorkItemHandler handler2 = new MapPersistenceTest.DummyWorkItemHandler();
        ...
        ksession1 = disposeAndReloadSession(ksession1, ksession1Id, kbase);
    ...
    public void crashProcessBeforePersisting() {
        ...
        KieBase kbase = createKieBase(ProcessCreatorForHelp.newProcessWithOneWork(processId, workName));
        StatefulKnowledgeSession crmPersistentSession = createSession(kbase);
        MapPersistenceTest.ChrashingWorkItemHandler handler = new MapPersistenceTest.ChrashingWorkItemHandler();
    ...
    public void processWithSubProcessThatCrashTest() {
        ...
        int knowledgeSessionsCountBeforeTest = getKnowledgeSessionsCount();
        int processInstancesBeforeTest = getProcessInstancesCount();
        KieBase kbase = createKieBase(ProcessCreatorForHelp.newProcessWithOneWork(subProcessId, workName), ProcessCreatorForHelp.newProcessWithOneSubProcess(processId, subProcessId));
        StatefulKnowledgeSession ksession = createSession(kbase);
        MapPersistenceTest.ChrashingWorkItemHandler handler = new MapPersistenceTest.ChrashingWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler(workName, handler);
        try {
    ...
    protected abstract StatefulKnowledgeSession disposeAndReloadSession(StatefulKnowledgeSession crmPersistentSession, long ksessionId, KieBase kbase);
    ...
    private static class DummyWorkItemHandler implements WorkItemHandler {
        ...
        public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
            MapPersistenceTest.DummyWorkItemHandler.this.setLatestWorkItem(workItem);
        }
        ...
        public void setLatestWorkItem(WorkItem latestWorkItem) {
            MapPersistenceTest.DummyWorkItemHandler.this.latestWorkItem = latestWorkItem;
        }
