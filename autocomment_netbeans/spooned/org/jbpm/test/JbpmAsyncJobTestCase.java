...
public class JbpmAsyncJobTestCase extends JbpmTestCase {
    ...
    public JbpmAsyncJobTestCase() {
        this(JbpmAsyncJobTestCase.EXECUTOR_THREADS, JbpmAsyncJobTestCase.EXECUTOR_INTERVAL);
    }

    public JbpmAsyncJobTestCase(int executorRetries) {
        this(JbpmAsyncJobTestCase.EXECUTOR_THREADS, executorRetries, JbpmAsyncJobTestCase.EXECUTOR_INTERVAL);
    }

    public JbpmAsyncJobTestCase(int executorThreads, int executorInterval) {
        this(executorThreads, JbpmAsyncJobTestCase.EXECUTOR_RETRIES, executorInterval);
    }

    public JbpmAsyncJobTestCase(int executorThreads, int executorRetries, int executorInterval) {
        super(true, true);
        JbpmAsyncJobTestCase.this.executorThreads = executorThreads;
        JbpmAsyncJobTestCase.this.executorRetries = executorRetries;
        JbpmAsyncJobTestCase.this.executorInterval = executorInterval;
    }
