...
public abstract class JbpmTestCase extends JbpmJUnitBaseTestCase {
    ...
    @Rule
    public IKeeperJUnitConnector issueKeeper = new IKeeperJUnitConnector(new qa.tools.ikeeper.client.BugzillaClient("https://bugzilla.redhat.com"), new qa.tools.ikeeper.client.JiraClient("https://issues.jboss.org"));
