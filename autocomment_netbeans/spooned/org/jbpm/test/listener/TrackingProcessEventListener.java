...
public class TrackingProcessEventListener extends DefaultProcessEventListener {
    ...
    public TrackingProcessEventListener(int involvedThreads) {
        ...
        TrackingProcessEventListener.this.processesAbortedLatch = new CountDownLatch(involvedThreads);
        TrackingProcessEventListener.this.processesStartedLatch = new CountDownLatch(involvedThreads);
        TrackingProcessEventListener.this.processesCompletedLatch = new CountDownLatch(involvedThreads);
    }
    ...
    public TrackingProcessEventListener(boolean transactional) {
        this(1);
        TrackingProcessEventListener.this.transactional = transactional;
    }
    ...
    protected void countDown(final CountDownLatch latch) {
        try {
            ...
            if (((((transactional) && (tm != null)) && ((tm.getStatus()) != (TransactionManager.STATUS_NO_TRANSACTION))) && ((tm.getStatus()) != (TransactionManager.STATUS_ROLLEDBACK))) && ((tm.getStatus()) != (TransactionManager.STATUS_COMMITTED))) {
