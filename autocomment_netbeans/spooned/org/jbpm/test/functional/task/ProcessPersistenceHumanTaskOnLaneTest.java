...
public class ProcessPersistenceHumanTaskOnLaneTest extends JbpmTestCase {
    ...
    public void testProcess() throws Exception {
        ...
        ProcessPersistenceHumanTaskOnLaneTest.logger.debug("Reloading the environemnt to simulate system restart");
        ...
        // simulating a system restart
        ProcessPersistenceHumanTaskOnLaneTest.logger.debug("Reloading the environemnt to simulate system restart once again");
    ...
    public void testProcessWithBAMListener() throws Exception {
        ...
        KieSession ksession = runtimeEngine.getKieSession();
        TaskService taskService = runtimeEngine.getTaskService();
        ((EventService<TaskLifeCycleEventListener>) (taskService)).registerTaskEventListener(new org.jbpm.services.task.lifecycle.listeners.BAMTaskEventListener(true));
        ProcessInstance processInstance = ksession.startProcess("UserTask");
        assertProcessInstanceActive(processInstance.getId());
        long task1 = -1;
        long task2 = -1;
