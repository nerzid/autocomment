...
public class ScriptTaskTest extends JbpmTestCase {
    ...
    public void testScriptTask() {
        KieSession kieSession = createKSession(ScriptTaskTest.SCRIPT_TASK);
        ...
        kieSession.execute(((Command<?>) (getCommands().newStartProcess(ScriptTaskTest.SCRIPT_TASK_ID, params))));
        assertMultipleVariablesChanged(ipel, "person", "personList");
        assertProcessStarted(ipel, ScriptTaskTest.SCRIPT_TASK_ID);
        ...
        assertProcessCompleted(ipel, ScriptTaskTest.SCRIPT_TASK_ID);
    }
}
