...
public abstract class TimerBaseTest extends AbstractBaseTest {
    ...
    private static Properties getDatasourceProperties() {
        ...
        // set property String{"h2.lobInDatabase"} to void{System}
        ...
        // set default Properties{props} to void{TimerBaseTest}
    ...
    private static void setDefaultProperties(Properties props) {
        ...
        // assert true String{"Unequal number of keys for default properties"} to void{Assert}
