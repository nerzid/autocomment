...
public class TransactionsTest extends JbpmTestCase {
    ...
    public void init() throws Exception {
        ...
        resources.put(TransactionsTest.TRANSACTIONS, ResourceType.BPMN2);
        resources.put(TransactionsTest.HELLO_WORLD, ResourceType.BPMN2);
        resources.put(TransactionsTest.TRANSACTIONS_DRL, ResourceType.DRL);
    ...
    public void testForLoop() throws Exception {
        ...
        long processId = ksession.startProcess(TransactionsTest.TRANSACTIONS_ID, params).getId();
    ...
    private long startProcess(KieSession ksession, String nodeType) {
        ProcessInstance pi = ksession.startProcess(TransactionsTest.TRANSACTIONS_ID);
        if (nodeType != null) {
