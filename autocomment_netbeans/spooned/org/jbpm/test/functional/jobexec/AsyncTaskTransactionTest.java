...
public class AsyncTaskTransactionTest extends JbpmAsyncJobTestCase {
    ...
    public void testJobCommitInAsyncExec() throws Exception {
        ...
        KieSession ksession = registerAsyncHandler(createKSession(AsyncTaskTransactionTest.ASYNC_EXECUTOR_2, AsyncTaskTransactionTest.ASYNC_DATA_EXECUTOR));
        ProcessInstance pi;
        UserTransaction ut = getUserTransaction();
        try {
            ut.begin();
            Map<String, Object> pm = new HashMap<String, Object>();
            pm.put("_command", AsyncTaskTransactionTest.USER_COMMAND);
            pi = ksession.startProcess(AsyncTaskTransactionTest.ASYNC_EXECUTOR_2_ID, pm);
            ut.commit();
        } catch (Exception ex) {
            ut.rollback();
            throw ex;
    ...
    public void testJobRollbackInAsyncExec() throws Exception {
        ...
        try {
            ...
            Map<String, Object> pm = new HashMap<String, Object>();
            pm.put("_command", AsyncTaskTransactionTest.USER_COMMAND);
            ProcessInstance pi = ksession.startProcess(AsyncTaskTransactionTest.ASYNC_EXECUTOR_2_ID, pm);
            processId = pi.getId();
    ...
    public void testJobCommit() throws Exception {
        CountDownAsyncJobListener countDownListener = new CountDownAsyncJobListener(1);
        ((ExecutorServiceImpl) (getExecutorService())).addAsyncJobListener(countDownListener);
        KieSession ksession = registerAsyncHandler(createKSession(AsyncTaskTransactionTest.ASYNC_DATA_EXECUTOR));
        ProcessInstance pi;
        UserTransaction ut = getUserTransaction();
        try {
            ut.begin();
            Map<String, Object> pm = new HashMap<String, Object>();
            pm.put("command", AsyncTaskTransactionTest.USER_COMMAND);
            pi = ksession.startProcess(AsyncTaskTransactionTest.ASYNC_DATA_EXECUTOR_ID, pm);
    ...
    public void testJobRollback() throws Exception {
        ...
        try {
            ut.begin();
            Map<String, Object> pm = new HashMap<String, Object>();
            pm.put("_command", AsyncTaskTransactionTest.USER_FAILING_COMMAND);
            ProcessInstance pi = ksession.startProcess(AsyncTaskTransactionTest.ASYNC_DATA_EXECUTOR_ID, pm);
            processId = pi.getId();
        } finally {
            ut.rollback();
        }
