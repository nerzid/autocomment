...
public class AsyncTaskCallbackTest extends JbpmAsyncJobTestCase {
    ...
    public void testTaskCallback() throws Exception {
        ...
        KieSession ksession = createKSession(AsyncTaskCallbackTest.ASYNC_EXECUTOR_CALLBACK, AsyncTaskCallbackTest.ASYNC_DATA_EXECUTOR);
        ...
        pm.put("_command", AsyncTaskCallbackTest.CALLBACK_COMMAND);
        ProcessInstance pi = ksession.startProcess(AsyncTaskCallbackTest.ASYNC_EXECUTOR_CALLBACK_ID, pm);
