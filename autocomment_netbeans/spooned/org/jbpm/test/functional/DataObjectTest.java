...
public class DataObjectTest extends JbpmTestCase {
    ...
    public void testDataObject() {
        KieSession ksession = createKSession(DataObjectTest.PROCESS);
        ...
        spc.setProcessId(DataObjectTest.PROCESS_ID);
        spc.setParameters(params);
        ksession.execute(spc);
        assertChangedVariable(listener, "person", null, mojmir);
        assertProcessStarted(listener, DataObjectTest.PROCESS_ID);
        ...
        assertProcessCompleted(listener, DataObjectTest.PROCESS_ID);
    }
}
