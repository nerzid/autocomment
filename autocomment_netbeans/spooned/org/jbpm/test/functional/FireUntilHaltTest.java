...
public class FireUntilHaltTest extends JbpmTestCase {
    ...
    public void testFireUntilHaltWithProcess() throws Exception {
        ...
        res.put(FireUntilHaltTest.PROCESS, ResourceType.BPMN2);
        res.put(FireUntilHaltTest.PROCESS_DRL, ResourceType.DRL);
        ...
        ksession.startProcess(FireUntilHaltTest.PROCESS_ID);
        Thread.sleep(100);
        ...
        // 5 + 2 changed + 1 added
        Assertions.assertThat(listener.ruleFiredCount("person detector")).isEqualTo(((wantedPersonsNum + (2 * unwantedPersonsNum)) + 1));
