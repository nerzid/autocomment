...
public class RetrySyncWorkItemByJPATest extends JbpmTestCase {
    ...
    public void workItemRecoveryTestByJPA() {
        ...
        ProcessInstance pi = kieSession.startProcess(RetrySyncWorkItemByJPATest.RETRY_WORKITEM_JPA_PROCESS_ID);
        ...
        ProcessInstance processInstance = ((WorkflowProcessInstance) (kieSession.getProcessInstance(pi.getId())));
        Collection<NodeInstance> nis = ((WorkflowProcessInstance) (processInstance)).getNodeInstances();
