...
public class RetrySyncWorkItemByMemoryTest extends JbpmTestCase {
    ...
    public void workItemRecoveryTestByMemory() {
        ...
        ProcessInstance pi = kieSession.startProcess(RetrySyncWorkItemByMemoryTest.RETRY_WORKITEM_MEMORY_PROCESS_ID);
        ...
        Collection<NodeInstance> nis = ((WorkflowProcessInstance) (p)).getNodeInstances();
