...
public class VariableInstanceLogCleanTest extends JbpmTestCase {
    ...
    public void deleteDataObjectLogsByDateRange() throws InterruptedException {
        kieSession = createKSession(VariableInstanceLogCleanTest.DATA_OBJECT);
        Person person = new Person("Marge");
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("person", person);
        Date start = new Date();
        processInstanceList.addAll(startProcess(kieSession, VariableInstanceLogCleanTest.DATA_OBJECT_ID, paramMap, 1));
        Date mid = new Date();
        processInstanceList.addAll(startProcess(kieSession, VariableInstanceLogCleanTest.DATA_OBJECT_ID, paramMap, 2));
        Date end = new Date();
        processInstanceList.addAll(startProcess(kieSession, VariableInstanceLogCleanTest.DATA_OBJECT_ID, paramMap, 1));
    ...
    public void deleteDataObjectLogsByDate() {
        ...
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("person", person);
        processInstanceList = startProcess(kieSession, VariableInstanceLogCleanTest.DATA_OBJECT_ID, paramMap, 3);
