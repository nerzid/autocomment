...
public class AsyncThreadContinuationTest extends JbpmTestCase {
    ...
    public void setUp() throws Exception {
        ...
        addProcessEventListener(new DefaultProcessEventListener() {
            ...
            public void afterProcessCompleted(ProcessCompletedEvent event) {
                ...
                } else if (event.getProcessInstance().getProcessId().equals(AsyncThreadContinuationTest.PROCESS_IT)) {
    ...
    public void testCorrectProcessStateAfterException() {
        KieSession ksession = createKSession(AsyncThreadContinuationTest.BPMN_ATC);
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("message", "Ivo");
        ProcessInstance pi = ksession.startProcess(AsyncThreadContinuationTest.PROCESS_ATC, params);
    ...
    public void testRepeatFailingSyncTask() {
        ...
        synchronized(AsyncThreadContinuationTest.LOCK_ATC) {
            try {
                AsyncThreadContinuationTest.LOCK_ATC.wait();
    ...
    public void testRepeatIntermediateTimerAfterException() {
        ...
        KieSession ksession = createKSession(AsyncThreadContinuationTest.BPMN_IT);
        ksession.addEventListener(countDownListener);
        ProcessInstance pi = ksession.startProcess(AsyncThreadContinuationTest.PROCESS_IT);
        long pid = pi.getId();
