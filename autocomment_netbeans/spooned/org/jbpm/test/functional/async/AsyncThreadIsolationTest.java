...
public class AsyncThreadIsolationTest extends JbpmTestCase {
    ...
    public void setUp() throws Exception {
        ...
        addWorkItemHandler("Service Task", new org.jbpm.process.workitem.bpmn2.ServiceTaskHandler());
    ...
    public void testCorrectProcessStateAfterException() {
        KieSession ksession = createKSession(AsyncThreadIsolationTest.BPMN_ATI);
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("message", "Ivo");
        ProcessInstance pi = ksession.startProcess(AsyncThreadIsolationTest.PROCESS_ATI, params);
        synchronized(AsyncThreadIsolationTest.LOCK) {
            try {
                AsyncThreadIsolationTest.LOCK.wait();
