...
public class AsyncThrowSignalTest extends JbpmTestCase {
    ...
    public void setUp() throws Exception {
        ...
        addProcessEventListener(new DefaultProcessEventListener() {
            ...
            public void afterProcessCompleted(ProcessCompletedEvent event) {
                synchronized(AsyncThrowSignalTest.LOCK) {
                    AsyncThrowSignalTest.LOCK.notifyAll();
                }
            }
        });
    }
    ...
    public void testCorrectProcessStateAfterExceptionThrowSignal() {
        KieSession ksession = createKSession(AsyncThrowSignalTest.BPMN_AICS, AsyncThrowSignalTest.BPMN_ATS);
        ProcessInstance pi1 = ksession.startProcess(AsyncThrowSignalTest.PROCESS_AICS, null);
        long pid1 = pi1.getId();
        ProcessInstance pi2 = ksession.startProcess(AsyncThrowSignalTest.PROCESS_ATS, null);
        long pid2 = pi2.getId();
        synchronized(AsyncThrowSignalTest.LOCK) {
            try {
                AsyncThrowSignalTest.LOCK.wait();
