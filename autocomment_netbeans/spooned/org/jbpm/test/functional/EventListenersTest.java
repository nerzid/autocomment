...
public class EventListenersTest extends JbpmTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        ksession = createKSession(EventListenersTest.PROCESS);
    }
    ...
    public void testClearExecution() {
        ...
        commands.add(getCommands().newStartProcess(EventListenersTest.PROCESS_ID));
        ...
        assertTrue(listener.wasProcessStarted(EventListenersTest.PROCESS_ID));
        assertTrue(listener.wasProcessCompleted(EventListenersTest.PROCESS_ID));
    }
    ...
    public void testUnfinishedProcess() {
        ...
        assertTrue(listener.wasProcessStarted(EventListenersTest.PROCESS_ID));
        assertFalse(listener.wasProcessCompleted(EventListenersTest.PROCESS_ID));
    }
