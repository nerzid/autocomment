...
public abstract class AbstractStartProcessWithCorrelationKeyTest extends JbpmTestCase {
    ...
    public void testCreateAndStartProcessWithBusinessKey() {
        ...
        AbstractStartProcessWithCorrelationKeyTest.logger.info("John is executing task {}", task.getName());
        ...
        task = list.get(0);
        AbstractStartProcessWithCorrelationKeyTest.logger.info("Mary is executing task {}", task.getName());
