...
public class FlexibleProcessTest extends JbpmTestCase {
    ...
    public void testFlexibleProcess() throws Exception {
        KieSession ksession = createKSession(FlexibleProcessTest.PROCESS);
        TrackingProcessEventListener tpel = new TrackingProcessEventListener();
        ksession.addEventListener(tpel);
        TestWorkItemHandler handler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", handler);
        ProcessInstance pi = ksession.startProcess(FlexibleProcessTest.PROCESS_ID);
        assertProcessStarted(tpel, FlexibleProcessTest.PROCESS_ID);
        ...
        ksession = restoreKSession(FlexibleProcessTest.PROCESS);
        ...
        assertProcessCompleted(tpel, FlexibleProcessTest.PROCESS_ID);
