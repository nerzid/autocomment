...
public class ExclusiveGatewayTest extends JbpmTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        ksession = createKSession(ExclusiveGatewayTest.EXCLUSIVE_GATEWAY);
    ...
    public void testExclusive1() {
        Assume.assumeFalse(ExclusiveGatewayTest.EXCLUSIVE_GATEWAY_ID.contains("ExclusiveGateway-eclipse"));
        ...
        spc.setProcessId(ExclusiveGatewayTest.EXCLUSIVE_GATEWAY_ID);
        spc.setParameters(params);
        ksession.execute(spc);
        assertMultipleVariablesChanged(iterableListener, "element", "x");
        assertProcessStarted(iterableListener, ExclusiveGatewayTest.EXCLUSIVE_GATEWAY_ID);
        ...
        assertProcessCompleted(iterableListener, ExclusiveGatewayTest.EXCLUSIVE_GATEWAY_ID);
    }
