...
public class ParallelGatewayTest extends JbpmTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        kieSession = createKSession(ParallelGatewayTest.PARALLEL_GATEWAY);
    ...
    public void testParallel() {
        ...
        kieSession.execute(((Command<?>) (getCommands().newStartProcess(ParallelGatewayTest.PARALLEL_GATEWAY_ID))));
        TrackingListenerAssert.assertProcessStarted(trackingListener, ParallelGatewayTest.PARALLEL_GATEWAY_ID);
        ...
        TrackingListenerAssert.assertProcessCompleted(trackingListener, ParallelGatewayTest.PARALLEL_GATEWAY_ID);
    }
}
