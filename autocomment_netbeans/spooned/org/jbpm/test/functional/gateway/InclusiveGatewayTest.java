...
public class InclusiveGatewayTest extends JbpmTestCase {
    ...
    public void setUp() throws Exception {
        super.setUp();
        kieSession = createKSession(InclusiveGatewayTest.INCLUSIVE_GATEWAY);
    ...
    public void testInclusive() {
        ...
        spc.setProcessId(InclusiveGatewayTest.INCLUSIVE_GATEWAY_ID);
        spc.setParameters(params);
        kieSession.execute(spc);
        assertChangedVariable(iterableListener, "x", null, 15);
        assertProcessStarted(iterableListener, InclusiveGatewayTest.INCLUSIVE_GATEWAY_ID);
        ...
        assertNextNode(iterableListener, "finalScript");
        assertNextNode(iterableListener, "end");
        assertProcessCompleted(iterableListener, InclusiveGatewayTest.INCLUSIVE_GATEWAY_ID);
    }
}
