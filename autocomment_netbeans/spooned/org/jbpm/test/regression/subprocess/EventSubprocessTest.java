...
public class EventSubprocessTest extends JbpmTestCase {
    ...
    public void testErrorCodeException() {
        KieSession ksession = createKSession(EventSubprocessTest.ERROR_CODE_EXCEPTION);
        ksession.getWorkItemManager().registerWorkItemHandler("Request Handler", new org.jbpm.bpmn2.handler.SignallingTaskHandlerDecorator(EventSubprocessTest.ExceptionOnPurposeHandler.class, "Error-90277"));
        ...
        try {
            ProcessInstance processInstance = ksession.startProcess(EventSubprocessTest.ERROR_CODE_EXCEPTION_ID);
