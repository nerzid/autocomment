...
public class EDefinitionTest extends AbstractEJBServicesTest {
    ...
    public void testBuildProcessDefinition() {
        ...
        ProcessDefinition pd = definitionService.buildProcessDefinition(deploymentId, bpmn2Content, KieServices.Factory.get().getKieClasspathContainer(EDefinitionTest.this.getClass().getClassLoader()), false);
