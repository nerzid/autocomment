...
@Category(value = { EAP.class , WLS.class , WAS.class })
public class ETransactionTest extends AbstractRuntimeEJBServicesTest {
    ...
    public void testStartProcessCommit() throws Exception {
        UserTransaction ut = InitialContext.doLookup(ETransactionTest.USER_TRANSACTION_NAME);
        ut.begin();
        Long processInstanceId = null;
        ProcessInstanceDesc processDesc = null;
        List<NodeInstanceDesc> processInstanceHistory = null;
        try {
            processInstanceId = startProcessInstance(ETransactionTest.PROCESS_ID);
    ...
    public void testStartProcessRollback() throws Exception {
        ...
        try {
            ...
            ETransactionTest.LOGGER.error("Non-XA database thrown NPE on process started before rollback", npe);
        }
    }

    @Test
    public void testAbortProcessCommit() throws Exception {
        Long processInstanceId = startProcessInstance(ETransactionTest.PROCESS_ID);
        checkProcessInstanceIsActive(processInstanceId);
        UserTransaction ut = InitialContext.doLookup(ETransactionTest.USER_TRANSACTION_NAME);
        ut.begin();
        try {
        ...
        Collection<ProcessInstanceDesc> processInstances = runtimeDataService.getProcessInstances(states, null, new org.kie.internal.query.QueryContext());
    ...
    public void testScript() throws Exception {
        ...
        ut.rollback();
        ut = InitialContext.doLookup(ETransactionTest.USER_TRANSACTION_NAME);
        ut.begin();
        try {
            processService.signalProcessInstance(processInstanceId, "start", "script");
    ...
    public void testRuleFlowGroup() throws Exception {
        ...
        ut.rollback();
        agenda.clear();
        processService.execute(kieJar, new org.drools.core.command.runtime.rule.FireAllRulesCommand());
    ...
    public void testForLoop() throws Exception {
        ...
        Long processInstanceId = startProcessInstance(ETransactionTest.PROCESS_ID, params);
        UserTransaction ut = InitialContext.doLookup(ETransactionTest.USER_TRANSACTION_NAME);
        ut.begin();
        try {
