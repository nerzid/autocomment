...
@Category(value = { EAP.class , EWS.class , WAS.class , WLS.class })
public class RestServiceInvokeTest extends JbpmContainerTest {
    ...
    public static Archive<?> deployRestService() {
        RestServiceInvokeTest.rrs = new RegisterRestService();
        org.jboss.shrinkwrap.api.Archive<?> war = RestServiceInvokeTest.rrs.buildArchive();// in case of WebSphere (WAS) it is an ear, see implementation of buildArchive()
    ...
    public void testGet() throws Exception {
        ...
        KieSession ksession = getSession(RestServiceInvokeTest.rrs.getResource(RegisterRestService.BPMN_CALL_REST_SERVICE_SIMPLE));
    ...
    public void testSecuredGet() throws Exception {
        System.out.println("### Running proccess ...");
        KieSession ksession = getSession(RestServiceInvokeTest.rrs.getResource(RegisterRestService.BPMN_CALL_REST_SERVICE_SIMPLE));
        ksession.getWorkItemManager().registerWorkItemHandler("REST", new org.jbpm.process.workitem.rest.RESTWorkItemHandler("ibek", "ibek1234;"));
        HashMap<String, Object> arguments = new HashMap<String, Object>();
    ...
    public void testSecuredFail() throws Exception {
        System.out.println("### Running proccess ...");
        KieSession ksession = getSession(RestServiceInvokeTest.rrs.getResource(RegisterRestService.BPMN_CALL_REST_SERVICE_SIMPLE));
        ksession.getWorkItemManager().registerWorkItemHandler("REST", new org.jbpm.process.workitem.rest.RESTWorkItemHandler("undefined", "user"));
        HashMap<String, Object> arguments = new HashMap<String, Object>();
        arguments.put("Url", ((RegisterRestService.SERVICE_URL) + "PersonList/securedPing"));
        WorkflowProcessInstance pi = ((WorkflowProcessInstance) (ksession.startProcess(RegisterRestService.PROCESS_CALL_REST_SERVICE_SIMPLE, arguments)));
    ...
    public void testPost() throws Exception {
        System.out.println("### Running proccess ...");
        KieSession ksession = getSession(RestServiceInvokeTest.rrs.getResource(RegisterRestService.BPMN_CALL_REST_SERVICE));
        ksession.getWorkItemManager().registerWorkItemHandler("REST", new org.jbpm.process.workitem.rest.RESTWorkItemHandler());
        HashMap<String, Object> arguments = new HashMap<String, Object>();
