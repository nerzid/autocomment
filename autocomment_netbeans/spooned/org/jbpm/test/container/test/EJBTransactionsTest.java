...
public class EJBTransactionsTest extends AbstractEJBTransactionsTest {
    ...
    private void startProcess(ProcessEJB ejb) {
        ...
        final EJBTransactionsTest.TestWorkItemHandler wih = new EJBTransactionsTest.TestWorkItemHandler();
    ...
    class TestWorkItemHandler implements WorkItemHandler {
        ...
        public void executeWorkItem(WorkItem wi, WorkItemManager wim) {
            EJBTransactionsTest.TestWorkItemHandler.this.wi = wi;
        }
        ...
        public WorkItem getWorkItem() {
            return EJBTransactionsTest.TestWorkItemHandler.this.wi;
        }
    }
}
