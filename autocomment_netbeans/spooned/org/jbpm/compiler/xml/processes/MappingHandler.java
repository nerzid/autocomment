...
public class MappingHandler extends BaseAbstractHandler implements Handler {
    public MappingHandler() {
        if (((MappingHandler.this.validParents) == null) && ((MappingHandler.this.validPeers) == null)) {
            this.validParents = new HashSet();
            MappingHandler.this.validParents.add(Mappable.class);
            this.validPeers = new HashSet();
            MappingHandler.this.validPeers.add(null);
