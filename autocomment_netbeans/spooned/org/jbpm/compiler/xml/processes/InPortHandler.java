...
public class InPortHandler extends BaseAbstractHandler implements Handler {
    public InPortHandler() {
        if (((InPortHandler.this.validParents) == null) && ((InPortHandler.this.validPeers) == null)) {
            this.validParents = new HashSet();
            InPortHandler.this.validParents.add(CompositeNode.class);
            this.validPeers = new HashSet();
            InPortHandler.this.validPeers.add(null);
