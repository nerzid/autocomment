...
public abstract class AbstractNodeHandler extends BaseAbstractHandler implements Handler {
    ...
    protected boolean containsMetaData(final Node node) {
        for (Map.Entry<String, Object> entry : ((NodeImpl) (node)).getMetaData().entrySet()) {
            ...
            if (((((((!("x".equals(name))) && (!("y".equals(name)))) && (!("width".equals(name)))) && (!("height".equals(name)))) && (!("color".equals(name)))) && (!("UniqueId".equals(name)))) && ((entry.getValue()) instanceof String)) {
                return true;
            } 
        }
        return false;
    ...
    protected void writeMetaData(final Node node, final StringBuilder xmlDump) {
        for (Map.Entry<String, Object> entry : ((NodeImpl) (node)).getMetaData().entrySet()) {
            String name = entry.getKey();
            if ((((((!("x".equals(name))) && (!("y".equals(name)))) && (!("width".equals(name)))) && (!("height".equals(name)))) && (!("color".equals(name)))) && ((entry.getValue()) instanceof String)) {
                xmlDump.append(((("      <metaData name=\"" + name) + "\">") + (AbstractNodeHandler.EOL)));
                xmlDump.append(((("        <value>" + (entry.getValue())) + "</value>") + (AbstractNodeHandler.EOL)));
                xmlDump.append(("      </metaData>" + (AbstractNodeHandler.EOL)));
            } 
        }
    }
    ...
    protected void writeActions(final String type, List<DroolsAction> actions, final StringBuilder xmlDump) {
        if ((actions != null) && ((actions.size()) > 0)) {
            xmlDump.append(((("      <" + type) + ">") + (AbstractNodeHandler.EOL)));
    ...
    public static void writeAction(final DroolsAction action, final StringBuilder xmlDump) {
        if (action instanceof DroolsConsequenceAction) {
            ...
            if (consequence == null) {
                ...
                xmlDump.append((((">" + (XmlDumper.replaceIllegalChars(consequence.trim()))) + "</action>") + (AbstractNodeHandler.EOL)));
            }
        } else {
    ...
    public void writeTimers(final Map<Timer, DroolsAction> timers, final StringBuilder xmlDump) {
        if ((timers != null) && (!(timers.isEmpty()))) {
            xmlDump.append(("      <timers>" + (AbstractNodeHandler.EOL)));
            ...
            for (Timer timer : timerList) {
                ...
                xmlDump.append(("        </timer>" + (AbstractNodeHandler.EOL)));
            }
            xmlDump.append(("      </timers>" + (AbstractNodeHandler.EOL)));
        } 
    }
