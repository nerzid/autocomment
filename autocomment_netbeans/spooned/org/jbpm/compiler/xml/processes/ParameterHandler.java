...
public class ParameterHandler extends BaseAbstractHandler implements Handler {
    public ParameterHandler() {
        if (((ParameterHandler.this.validParents) == null) && ((ParameterHandler.this.validPeers) == null)) {
            this.validParents = new HashSet<Class<?>>();
            ParameterHandler.this.validParents.add(Work.class);
            this.validPeers = new HashSet<Class<?>>();
            ParameterHandler.this.validPeers.add(null);
    ...
    public Object start(final String uri, final String localName, final Attributes attrs, final ExtensibleXmlParser parser) throws SAXException {
        ...
        ParameterDefinition parameterDefinition = new org.drools.core.process.core.impl.ParameterDefinitionImpl();
        parameterDefinition.setName(name);
        work.addParameterDefinition(parameterDefinition);
        return new ParameterHandler.ParameterWrapper(parameterDefinition, work);
    }
    ...
    public Class<?> generateNodeFor() {
        return ParameterHandler.ParameterWrapper.class;
    }
    ...
    public class ParameterWrapper implements TypeObject , ValueObject {
        ...
        public ParameterWrapper(ParameterDefinition parameterDefinition, Work work) {
            ParameterHandler.ParameterWrapper.this.work = work;
            ParameterHandler.ParameterWrapper.this.parameterDefinition = parameterDefinition;
        }
