...
public class TypeHandler extends BaseAbstractHandler implements Handler {
    public TypeHandler() {
        if (((TypeHandler.this.validParents) == null) && ((TypeHandler.this.validPeers) == null)) {
            this.validParents = new HashSet<Class<?>>();
            TypeHandler.this.validParents.add(TypeObject.class);
            this.validPeers = new HashSet<Class<?>>();
            TypeHandler.this.validPeers.add(null);
