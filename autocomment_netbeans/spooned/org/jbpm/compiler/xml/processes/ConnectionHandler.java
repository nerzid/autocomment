...
public class ConnectionHandler extends BaseAbstractHandler implements Handler {
    public ConnectionHandler() {
        if (((ConnectionHandler.this.validParents) == null) && ((ConnectionHandler.this.validPeers) == null)) {
            this.validParents = new HashSet();
            ConnectionHandler.this.validParents.add(NodeContainer.class);
            this.validPeers = new HashSet();
            ConnectionHandler.this.validPeers.add(null);
            ConnectionHandler.this.validPeers.add(Connection.class);
