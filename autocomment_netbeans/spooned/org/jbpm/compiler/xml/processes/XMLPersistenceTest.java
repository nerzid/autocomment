...
public class XMLPersistenceTest extends XMLTestCase {
    ...
    public void testPersistenceOfEmptyNodes() throws Exception {
        ...
        process.addNode(new org.jbpm.workflow.core.node.DynamicNode());
        ...
        modules.addSemanticModule(new org.jbpm.compiler.xml.ProcessSemanticModule());
    ...
    public void testPersistenceOfFullNodes() throws Exception {
        ...
        variable.setType(new org.drools.core.process.core.datatype.impl.type.ObjectDataType("org.jbpm.integrationtests.test.Person"));
        ...
        listDataType.setType(new org.drools.core.process.core.datatype.impl.type.ObjectDataType("java.lang.Integer"));
        ...
        Connection connection = new org.jbpm.workflow.core.impl.ConnectionImpl(split, Node.CONNECTION_DEFAULT_TYPE, actionNode, Node.CONNECTION_DEFAULT_TYPE);
        ...
        connection = new org.jbpm.workflow.core.impl.ConnectionImpl(split, Node.CONNECTION_DEFAULT_TYPE, ruleSetNode, Node.CONNECTION_DEFAULT_TYPE);
        constraint = new org.jbpm.workflow.core.impl.ConstraintImpl();
        ...
        new org.jbpm.workflow.core.impl.ConnectionImpl(startNode, Node.CONNECTION_DEFAULT_TYPE, split, Node.CONNECTION_DEFAULT_TYPE);
        ...
        new org.jbpm.workflow.core.impl.ConnectionImpl(actionNode, Node.CONNECTION_DEFAULT_TYPE, join, Node.CONNECTION_DEFAULT_TYPE);
        new org.jbpm.workflow.core.impl.ConnectionImpl(ruleSetNode, Node.CONNECTION_DEFAULT_TYPE, join, Node.CONNECTION_DEFAULT_TYPE);
        new org.jbpm.workflow.core.impl.ConnectionImpl(eventNode, Node.CONNECTION_DEFAULT_TYPE, join, Node.CONNECTION_DEFAULT_TYPE);
        ...
        connection = new org.jbpm.workflow.core.impl.ConnectionImpl(join, Node.CONNECTION_DEFAULT_TYPE, milestone, Node.CONNECTION_DEFAULT_TYPE);
        ...
        connection = new org.jbpm.workflow.core.impl.ConnectionImpl(milestone, Node.CONNECTION_DEFAULT_TYPE, subProcess, Node.CONNECTION_DEFAULT_TYPE);
        ...
        ParameterDefinition parameterDefinition = new org.drools.core.process.core.impl.ParameterDefinitionImpl("param1", new org.drools.core.process.core.datatype.impl.type.StringDataType());
        parameterDefinitions.add(parameterDefinition);
        parameterDefinition = new org.drools.core.process.core.impl.ParameterDefinitionImpl("param2", new org.drools.core.process.core.datatype.impl.type.IntegerDataType());
        parameterDefinitions.add(parameterDefinition);
        ...
        connection = new org.jbpm.workflow.core.impl.ConnectionImpl(subProcess, Node.CONNECTION_DEFAULT_TYPE, workItemNode, Node.CONNECTION_DEFAULT_TYPE);
        ...
        parameterDefinition = new org.drools.core.process.core.impl.ParameterDefinitionImpl("TaskName", new org.drools.core.process.core.datatype.impl.type.StringDataType());
        parameterDefinitions.add(parameterDefinition);
        parameterDefinition = new org.drools.core.process.core.impl.ParameterDefinitionImpl("ActorId", new org.drools.core.process.core.datatype.impl.type.StringDataType());
        parameterDefinitions.add(parameterDefinition);
        parameterDefinition = new org.drools.core.process.core.impl.ParameterDefinitionImpl("Priority", new org.drools.core.process.core.datatype.impl.type.StringDataType());
        parameterDefinitions.add(parameterDefinition);
        ...
        connection = new org.jbpm.workflow.core.impl.ConnectionImpl(workItemNode, Node.CONNECTION_DEFAULT_TYPE, humanTaskNode, Node.CONNECTION_DEFAULT_TYPE);
        ...
        new org.jbpm.workflow.core.impl.ConnectionImpl(humanTaskNode, Node.CONNECTION_DEFAULT_TYPE, timerNode, Node.CONNECTION_DEFAULT_TYPE);
        ForEachNode forEachNode = new ForEachNode();
        forEachNode.setName("ForEach");
        forEachNode.setCollectionExpression("collection");
        forEachNode.setVariable("variableName", new org.drools.core.process.core.datatype.impl.type.ObjectDataType());
        ...
        new org.jbpm.workflow.core.impl.ConnectionImpl(subActionNode1, Node.CONNECTION_DEFAULT_TYPE, subActionNode2, Node.CONNECTION_DEFAULT_TYPE);
        ...
        new org.jbpm.workflow.core.impl.ConnectionImpl(timerNode, Node.CONNECTION_DEFAULT_TYPE, forEachNode, Node.CONNECTION_DEFAULT_TYPE);
        ...
        new org.jbpm.workflow.core.impl.ConnectionImpl(forEachNode, Node.CONNECTION_DEFAULT_TYPE, compositeNode, Node.CONNECTION_DEFAULT_TYPE);
        ...
        new org.jbpm.workflow.core.impl.ConnectionImpl(compositeNode, Node.CONNECTION_DEFAULT_TYPE, stateNode, Node.CONNECTION_DEFAULT_TYPE);
        connection = new org.jbpm.workflow.core.impl.ConnectionImpl(stateNode, Node.CONNECTION_DEFAULT_TYPE, join, Node.CONNECTION_DEFAULT_TYPE);
        constraint = new org.jbpm.workflow.core.impl.ConstraintImpl();
        constraint.setName("constraint1 ><&&");
        constraint.setPriority(1);
        constraint.setDialect("dialect1");
        ...
        connection = new org.jbpm.workflow.core.impl.ConnectionImpl(stateNode, Node.CONNECTION_DEFAULT_TYPE, endNode, Node.CONNECTION_DEFAULT_TYPE);
        constraint = new org.jbpm.workflow.core.impl.ConstraintImpl();
        constraint.setName("constraint2");
        constraint.setPriority(2);
        constraint.setDialect("dialect2");
        ...
        Diff diff = new Diff(control, test, null, new org.custommonkey.xmlunit.ElementNameAndAttributeQualifier("name"));
