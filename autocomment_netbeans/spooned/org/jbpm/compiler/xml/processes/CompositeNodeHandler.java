...
public class CompositeNodeHandler extends AbstractNodeHandler {
    ...
    public void writeNode(org.jbpm.workflow.core.Node node, StringBuilder xmlDump, boolean includeMeta) {
        ...
        List<org.jbpm.workflow.core.Node> subNodes = getSubNodes(compositeNode);
        xmlDump.append(("      <nodes>" + (EOL)));
        for (org.jbpm.workflow.core.Node subNode : subNodes) {
    ...
    protected List<org.jbpm.workflow.core.Node> getSubNodes(CompositeNode compositeNode) {
        List<org.jbpm.workflow.core.Node> subNodes = new ArrayList<org.jbpm.workflow.core.Node>();
        for (Node subNode : compositeNode.getNodes()) {
            // filter out composite start and end nodes as they can be regenerated
            if ((!(subNode instanceof CompositeNode)) && (!(subNode instanceof CompositeNode))) {
                subNodes.add(((org.jbpm.workflow.core.Node) (subNode)));
            } 
        }
        return subNodes;
    }
