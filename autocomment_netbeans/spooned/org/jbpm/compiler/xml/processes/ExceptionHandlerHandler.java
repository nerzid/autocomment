...
public class ExceptionHandlerHandler extends BaseAbstractHandler implements Handler {
    public ExceptionHandlerHandler() {
        if (((ExceptionHandlerHandler.this.validParents) == null) && ((ExceptionHandlerHandler.this.validPeers) == null)) {
            this.validParents = new HashSet<Class<?>>();
            ExceptionHandlerHandler.this.validParents.add(Process.class);
            this.validPeers = new HashSet<Class<?>>();
            ExceptionHandlerHandler.this.validPeers.add(null);
