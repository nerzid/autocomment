...
public class PackageBuilderTest extends AbstractBaseTest {
    ...
    public void testRuleFlow() throws Exception {
        InputStream in = PackageBuilderTest.this.getClass().getResourceAsStream("/org/jbpm/integrationtests/ruleflow.rfm");
        assertNotNull(in);
        builder.addPackage(new org.drools.compiler.lang.descr.PackageDescr("com.sample"));
    ...
    public void testRuleFlowUpgrade() throws Exception {
        ...
        InputStream in = PackageBuilderTest.this.getClass().getResourceAsStream("/org/jbpm/integrationtests/ruleflow40.rfm");
        assertNotNull(in);
        builder.addPackage(new org.drools.compiler.lang.descr.PackageDescr("com.sample"));
        builder.addRuleFlow(new InputStreamReader(in));
        InternalKnowledgePackage pkg = builder.getPackage();
    ...
    public void testPackageRuleFlows() throws Exception {
        InternalKnowledgePackage pkg = new org.drools.core.definitions.impl.KnowledgePackageImpl("boo");
        Process rf = new PackageBuilderTest.MockRuleFlow("1");
        pkg.addProcess(rf);
        assertTrue(pkg.getRuleFlows().containsKey("1"));
        assertSame(rf, pkg.getRuleFlows().get("1"));
        Process rf2 = new PackageBuilderTest.MockRuleFlow("2");
        pkg.addProcess(rf2);
        assertTrue(pkg.getRuleFlows().containsKey("1"));
        assertSame(rf, pkg.getRuleFlows().get("1"));
    ...
    class MockRuleFlow implements Process {
        ...
        MockRuleFlow(String id) {
            PackageBuilderTest.MockRuleFlow.this.id = id;
        }
