...
public class RuleFlowProcessValidator implements ProcessValidator {
    ...
    public ProcessValidationError[] validateProcess(final RuleFlowProcess process) {
        ...
        if ((process.getName()) == null) {
            errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, "Process has no name."));
        } 
        if (((process.getId()) == null) || ("".equals(process.getId()))) {
            errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, "Process has no id."));
        } 
        if (((process.getPackageName()) == null) || ("".equals(process.getPackageName()))) {
            errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, "Process has no package name."));
        } 
        // check start node of process
        if ((process.getStartNodes().isEmpty()) && (!(process.isDynamic()))) {
            errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, "Process has no start node."));
        } 
        ...
        if (!(endNodeFound)) {
            errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, "Process has no end node."));
        } 
    ...
    private void validateNodes(Node[] nodes, List<ProcessValidationError> errors, RuleFlowProcess process) {
        ...
        for (int i = 0; i < nodes; i++) {
            ...
            if (node instanceof StartNode) {
                ...
                errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, (("Unknown node type '" + (node.getClass().getName())) + "'")));
            }
        }
    }
    ...
    private void validateVariables(List<ProcessValidationError> errors, RuleFlowProcess process) {
        ...
        if (variables != null) {
            for (Variable var : variables) {
                ...
                if (varDataType == null) {
                    errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, (("Variable '" + (var.getName())) + "' has no type.")));
                } 
            }
        } 
    }
    ...
    protected void addErrorMessage(RuleFlowProcess process, Node node, List<ProcessValidationError> errors, String message) {
        ...
        errors.add(new org.jbpm.process.core.validation.impl.ProcessValidationErrorImpl(process, error));
    }
}
