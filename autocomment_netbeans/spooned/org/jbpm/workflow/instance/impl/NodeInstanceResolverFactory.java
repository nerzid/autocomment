...
public class NodeInstanceResolverFactory extends ImmutableDefaultFactory {
    ...
    public boolean isResolveable(String name) {
        boolean found = (nodeInstance.resolveContextInstance(VARIABLE_SCOPE, name)) != null;
        if (!found) {
    ...
    public VariableResolver getVariableResolver(String name) {
        ...
        Object value = ((VariableScopeInstance) (nodeInstance.resolveContextInstance(VARIABLE_SCOPE, name))).getVariable(name);
