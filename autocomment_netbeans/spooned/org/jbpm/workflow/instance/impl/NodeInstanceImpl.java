...
import ExclusiveGroup.EXCLUSIVE_GROUP;
...
public abstract class NodeInstanceImpl implements Serializable , org.jbpm.workflow.instance.NodeInstance {
    ...
    public Node getNode() {
        try {
            ...
            throw new IllegalArgumentException(((((("Unknown node id: " + (this.nodeId)) + " for node instance ") + (getUniqueId())) + " for process instance ") + (this.processInstance)), e);
        }
    }
    ...
    public void cancel() {
        // remove node NodeInstanceImpl{this} to NodeInstanceContainer{nodeInstanceContainer}
    ...
    protected void executeAction(Action action) {
        ...
        // set node NodeInstanceImpl{this} to ProcessContext{context}
        context.setNodeInstance(this);
        try {
            action.execute(context);
        } catch (Exception e) {
            String exceptionName = e.getClass().getName();
            ExceptionScopeInstance exceptionScopeInstance = ((ExceptionScopeInstance) (resolveContextInstance(EXCEPTION_SCOPE, exceptionName)));
    ...
    protected NodeInstance followConnection(Connection connection) {
        ...
        if (parent instanceof ContextInstanceContainer) {
            List<ContextInstance> contextInstances = ((ContextInstanceContainer) (parent)).getContextInstances(EXCLUSIVE_GROUP);
            if (contextInstances != null) {
                for (ContextInstance contextInstance : new ArrayList<ContextInstance>(contextInstances)) {
                    ...
                    if (groupInstance.containsNodeInstance(this)) {
                        ...
                        ((ContextInstanceContainer) (parent)).removeContextInstance(EXCLUSIVE_GROUP, contextInstance);
                    }
                }
            }
        }
    ...
    protected void triggerNodeInstance(NodeInstance nodeInstance, String type) {
        ...
        // trigger next node
        // trigger NodeInstanceImpl{this} to NodeInstance{nodeInstance}
    ...
    protected void triggerConnection(Connection connection) {
        // trigger node NodeInstance{followConnection(connection)} to NodeInstanceImpl{}
    ...
    public void retrigger(boolean remove) {
        ...
        // trigger node long{getNodeId()} to NodeInstanceImpl{}
    ...
    public void triggerNode(long nodeId) {
        ...
        // trigger node NodeInstance{nodeInstance} to NodeInstanceImpl{}
    ...
    public Object getVariable(String variableName) {
        VariableScopeInstance variableScope = ((VariableScopeInstance) (resolveContextInstance(VARIABLE_SCOPE, variableName)));
        if (variableScope == null) {
            variableScope = ((VariableScopeInstance) (((ProcessInstance) (getProcessInstance())).getContextInstance(VARIABLE_SCOPE)));
        }
    ...
    public void setVariable(String variableName, Object value) {
        VariableScopeInstance variableScope = ((VariableScopeInstance) (resolveContextInstance(VARIABLE_SCOPE, variableName)));
        if (variableScope == null) {
            variableScope = ((VariableScopeInstance) (getProcessInstance().getContextInstance(VARIABLE_SCOPE)));
        ...
        // set variable String{variableName} to VariableScopeInstance{variableScope}
