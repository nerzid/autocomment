...
class CompensationEventListener implements EventListener {
    ...
    public CompensationEventListener(WorkflowProcessInstanceImpl instance) {
        CompensationEventListener.this.instance = instance;
    }
    ...
    public void signalEvent(String compensationType, Object activityRefStr) {
        if ((activityRefStr == null) || (!(activityRefStr instanceof String))) {
            throw new org.jbpm.workflow.instance.WorkflowRuntimeException(null, getProcessInstance(), (("Compensation can only be triggered with String events, not an event of type " + activityRefStr) == null ? "null" : activityRefStr.getClass().getSimpleName()));
        } 
        ...
        if ((toCompensateNode != null) || (compensationScopeContainer != null)) {
            CompensationScope.CompensationScope compensationScope = null;
            if (compensationScopeContainer != null) {
                compensationScope = ((CompensationScope.CompensationScope) (compensationScopeContainer.getDefaultContext(COMPENSATION_SCOPE)));
            } else {
                compensationScope = ((CompensationScope.CompensationScope) (((NodeImpl) (toCompensateNode)).resolveContext(COMPENSATION_SCOPE, toCompensateNodeId)));
            }
