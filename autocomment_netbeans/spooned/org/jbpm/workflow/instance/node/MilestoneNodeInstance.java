...
public class MilestoneNodeInstance extends StateBasedNodeInstance implements AgendaEventListener {
    ...
    public void internalTrigger(final NodeInstance from, String type) {
        ...
        String rule = (("RuleFlow-Milestone-" + (getProcessInstance().getProcessId())) + "-") + (getMilestoneNode().getUniqueId());
    ...
    private void addActivationListener() {
        getProcessInstance().getKnowledgeRuntime().addEventListener(MilestoneNodeInstance.this);
        getProcessInstance().addEventListener(getActivationEventType(), MilestoneNodeInstance.this, true);
    }

    public void removeEventListeners() {
        super.removeEventListeners();
        getProcessInstance().getKnowledgeRuntime().removeEventListener(MilestoneNodeInstance.this);
        getProcessInstance().removeEventListener(getActivationEventType(), MilestoneNodeInstance.this, true);
    }
