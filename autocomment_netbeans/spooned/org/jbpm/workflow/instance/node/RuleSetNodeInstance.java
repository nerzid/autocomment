...
public class RuleSetNodeInstance extends StateBasedNodeInstance implements EventListener {
    ...
    private void addRuleSetListener() {
        getProcessInstance().addEventListener(getRuleSetEventType(), RuleSetNodeInstance.this, true);
    }

    public void removeEventListeners() {
        super.removeEventListeners();
        getProcessInstance().removeEventListener(getRuleSetEventType(), RuleSetNodeInstance.this, true);
    }
                ...
                if ((association.getTransformation()) != null) {
                    ...
                    if (transformer != null) {
                        ...
                        if ((variableScopeInstance != null) && (parameterValue != null)) {
                            ...
                            RuleSetNodeInstance.logger.warn("Could not find variable scope for variable {}", association.getTarget());
                            RuleSetNodeInstance.logger.warn("Continuing without setting variable.");
                        }
                    ...
                    if (variableScopeInstance != null) {
                        ...
                        if (value == null) {
                            try {
                                value = MVELSafeHelper.getEvaluator().eval(association.getSources().get(0), new org.mvel2.integration.impl.MapVariableResolverFactory(objects));
                            } catch (Throwable t) {
                                // do nothing
                            }
                        } 
        ...
        for (Iterator<DataAssociation> iterator = ruleSetNode.getInAssociations().iterator(); iterator.hasNext();) {
            ...
            if ((association.getTransformation()) != null) {
                ...
                if (variableScopeInstance != null) {
                    ...
                    try {
                        parameterValue = MVELSafeHelper.getEvaluator().eval(association.getSources().get(0), new org.jbpm.workflow.instance.impl.NodeInstanceResolverFactory(RuleSetNodeInstance.this));
                    } catch (Throwable t) {
                        RuleSetNodeInstance.logger.error("Could not find variable scope for variable {}", association.getSources().get(0));
                        RuleSetNodeInstance.logger.error("when trying to execute RuleSetNode {}", ruleSetNode.getName());
                        RuleSetNodeInstance.logger.error("Continuing without setting parameter.");
                    }
                }
                if (parameterValue != null) {
                    replacements.put(association.getTarget(), parameterValue);
        ...
        if (s instanceof String) {
            ...
            while (matcher.find()) {
                ...
                if (variableScopeInstance != null) {
                    ...
                    try {
                        Object variableValue = MVELSafeHelper.getEvaluator().eval(paramName, new org.jbpm.workflow.instance.impl.NodeInstanceResolverFactory(RuleSetNodeInstance.this));
                        if (variableValue != null) {
                            return variableValue;
                        } 
                    } catch (Throwable t) {
                        RuleSetNodeInstance.logger.error("Could not find variable scope for variable {}", paramName);
                    }
                }
            }
        } 
    ...
    protected Map<String, Object> getSourceParameters(DataAssociation association) {
        ...
        for (String sourceParam : association.getSources()) {
            ...
            if (variableScopeInstance != null) {
                ...
                try {
                    parameterValue = MVELSafeHelper.getEvaluator().eval(sourceParam, new org.jbpm.workflow.instance.impl.NodeInstanceResolverFactory(RuleSetNodeInstance.this));
                } catch (Throwable t) {
                    RuleSetNodeInstance.logger.warn("Could not find variable scope for variable {}", sourceParam);
                }
            }
            if (parameterValue != null) {
    ...
    public void setFactHandles(Map<String, FactHandle> factHandles) {
        RuleSetNodeInstance.this.factHandles = factHandles;
    }
    ...
    public void setRuleFlowGroup(String ruleFlowGroup) {
        RuleSetNodeInstance.this.ruleFlowGroup = ruleFlowGroup;
    }
}
