...
public class ForEachNodeInstance extends CompositeContextNodeInstance {
    ...
    public NodeInstance getNodeInstance(final Node node) {
        ...
        if (node instanceof ForEachSplitNode) {
            ForEachNodeInstance.ForEachSplitNodeInstance nodeInstance = new ForEachNodeInstance.ForEachSplitNodeInstance();
            nodeInstance.setNodeId(node.getId());
            nodeInstance.setNodeInstanceContainer(ForEachNodeInstance.this);
            ...
            int level = ForEachNodeInstance.this.getLevelForNode(uniqueID);
            nodeInstance.setLevel(level);
            return nodeInstance;
        } else if (node instanceof ForEachJoinNode) {
            ForEachNodeInstance.ForEachJoinNodeInstance nodeInstance = ((ForEachNodeInstance.ForEachJoinNodeInstance) (getFirstNodeInstance(node.getId())));
            if (nodeInstance == null) {
                nodeInstance = new ForEachNodeInstance.ForEachJoinNodeInstance();
                nodeInstance.setNodeId(node.getId());
                nodeInstance.setNodeInstanceContainer(ForEachNodeInstance.this);
                nodeInstance.setProcessInstance(getProcessInstance());
                String uniqueID = ((String) (node.getMetaData().get("UniqueId")));
    ...
    private Collection<?> evaluateCollectionExpression(String collectionExpression) {
        ...
        if (variableScopeInstance != null) {
            ...
            try {
                collection = MVELSafeHelper.getEvaluator().eval(collectionExpression, new NodeInstanceResolverFactory(ForEachNodeInstance.this));
            } catch (Throwable t) {
    ...
    public class ForEachSplitNodeInstance extends NodeInstanceImpl {
        ...
        public void internalTrigger(NodeInstance fromm, String type) {
            ...
            ((NodeInstanceContainer) (getNodeInstanceContainer())).removeNodeInstance(ForEachNodeInstance.ForEachSplitNodeInstance.this);
            if (collection.isEmpty()) {
                ...
                for (Object o : collection) {
                    ...
                    NodeInstance nodeInstance = ((NodeInstance) (((NodeInstanceContainer) (getNodeInstanceContainer())).getNodeInstance(getForEachSplitNode().getTo().getTo())));
                ...
                for (NodeInstance nodeInstance : nodeInstances) {
                    ...
                    ((org.jbpm.workflow.instance.NodeInstance) (nodeInstance)).trigger(ForEachNodeInstance.ForEachSplitNodeInstance.this, getForEachSplitNode().getTo().getToType());
                }
    ...
    public class ForEachJoinNodeInstance extends NodeInstanceImpl {
        ...
        public void internalTrigger(NodeInstance from, String type) {
            ...
            if ((getForEachNode().getOutputVariableName()) != null) {
                ...
                Collection<Object> outputCollection = ((Collection<Object>) (subprocessVariableScopeInstance.getVariable(ForEachNodeInstance.TEMP_OUTPUT_VAR)));
                if (outputCollection == null) {
                    outputCollection = new ArrayList<Object>();
                } 
                VariableScopeInstance variableScopeInstance = ((VariableScopeInstance) (((NodeInstanceImpl) (from)).resolveContextInstance(VariableScope.VARIABLE_SCOPE, getForEachNode().getOutputVariableName())));
                ...
                subprocessVariableScopeInstance.setVariable(ForEachNodeInstance.TEMP_OUTPUT_VAR, outputCollection);
            ...
            if (((getNodeInstanceContainer().getNodeInstances().size()) == 1) || isCompletionConditionMet) {
                ...
                if (outputCollection != null) {
                    ...
                    if (outputVariable != null) {
                        ...
                        outputVariable = ((Collection<Object>) (subprocessVariableScopeInstance.getVariable(ForEachNodeInstance.TEMP_OUTPUT_VAR)));
                    }
                    variableScopeInstance.setVariable(outputCollection, outputVariable);
                } 
                ((NodeInstanceContainer) (getNodeInstanceContainer())).removeNodeInstance(ForEachNodeInstance.ForEachJoinNodeInstance.this);
                if (getForEachNode().isWaitForCompletion()) {
        ...
        private boolean evaluateCompletionCondition(String expression, Map<String, Object> tempVariables) {
            ...
            try {
                Object result = MVELSafeHelper.getEvaluator().eval(expression, new ForEachNodeInstance.ForEachNodeInstanceResolverFactory(ForEachNodeInstance.ForEachJoinNodeInstance.this, tempVariables));
    ...
    public ContextInstance getContextInstance(String contextId) {
        ...
        if (contextInstance == null) {
            contextInstance = resolveContextInstance(contextId, ForEachNodeInstance.TEMP_OUTPUT_VAR);
    ...
    private class ForEachNodeInstanceResolverFactory extends NodeInstanceResolverFactory {
        ...
        public ForEachNodeInstanceResolverFactory(NodeInstance nodeInstance, Map<String, Object> tempVariables) {
            super(nodeInstance);
            ForEachNodeInstance.ForEachNodeInstanceResolverFactory.this.tempVariables = tempVariables;
        }
        ...
        public VariableResolver getVariableResolver(String name) {
            if (tempVariables.containsKey(name)) {
                return new org.mvel2.integration.impl.SimpleValueResolver(tempVariables.get(name));
            } 
