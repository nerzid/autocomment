...
public class DynamicNodeInstance extends CompositeContextNodeInstance implements AgendaEventListener {
    ...
    public void removeEventListeners() {
        ...
        getProcessInstance().getKnowledgeRuntime().removeEventListener(DynamicNodeInstance.this);
        getProcessInstance().removeEventListener(getActivationEventType(), DynamicNodeInstance.this, true);
    }

    private void addActivationListener() {
        getProcessInstance().getKnowledgeRuntime().addEventListener(DynamicNodeInstance.this);
        getProcessInstance().addEventListener(getActivationEventType(), DynamicNodeInstance.this, true);
    }
    ...
    public void nodeInstanceCompleted(NodeInstance nodeInstance, String outType) {
        ...
        if (isTerminated(nodeInstance)) {
            ...
            Object value = MVELSafeHelper.getEvaluator().eval(completionCondition, new org.jbpm.workflow.instance.impl.NodeInstanceResolverFactory(DynamicNodeInstance.this));
