...
public class CompositeContextNodeInstance extends CompositeNodeInstance implements ContextInstanceContainer , ContextableInstance {
    ...
    public void setContextInstance(String contextId, ContextInstance contextInstance) {
        CompositeContextNodeInstance.this.contextInstances.put(contextId, contextInstance);
    }

    public ContextInstance getContextInstance(String contextId) {
        ContextInstance contextInstance = CompositeContextNodeInstance.this.contextInstances.get(contextId);
    ...
    public List<ContextInstance> getContextInstances(String contextId) {
        return CompositeContextNodeInstance.this.subContextInstances.get(contextId);
    }

    public void addContextInstance(String contextId, ContextInstance contextInstance) {
        List<ContextInstance> list = CompositeContextNodeInstance.this.subContextInstances.get(contextId);
        if (list == null) {
            list = new ArrayList<ContextInstance>();
            CompositeContextNodeInstance.this.subContextInstances.put(contextId, list);
        } 
    ...
    public ContextInstance getContextInstance(final Context context) {
        ...
        ContextInstance contextInstance = ((ContextInstance) (conf.getContextInstance(context, CompositeContextNodeInstance.this, ((ProcessInstance) (getProcessInstance())))));
        if (contextInstance == null) {
