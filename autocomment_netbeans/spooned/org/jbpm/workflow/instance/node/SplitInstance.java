...
public class SplitInstance extends NodeInstanceImpl {
    ...
    public void internalTrigger(final NodeInstance from, String type) {
        ...
        try {
            ...
            throw new WorkflowRuntimeException(SplitInstance.this, getProcessInstance(), ("Unable to execute Split: " + (e.getMessage())), e);
        }
    }
        ...
        switch (split.getType()) {
            ...
            case Split.TYPE_XOR :
                ...
                for (final Iterator<Connection> iterator = outgoing.iterator(); iterator.hasNext();) {
                    ...
                    if (((constraint != null) && ((constraint.getPriority()) < priority)) && (!(constraint.isDefault()))) {
                        try {
                            if (constraint.evaluate(SplitInstance.this, connection, constraint)) {
                                selected = connection;
                ...
                ((NodeInstanceContainer) (getNodeInstanceContainer())).removeNodeInstance(SplitInstance.this);
                if (selected == null) {
                    for (final Iterator<Connection> iterator = outgoing.iterator(); iterator.hasNext();) {
                        final Connection connection = ((Connection) (iterator.next()));
            ...
            case Split.TYPE_OR :
                ...
                while (!(outgoingCopy.isEmpty())) {
                    ...
                    if (selectedConstraint.evaluate(SplitInstance.this, selectedConnection, selectedConstraint)) {
            ...
            case Split.TYPE_XAND :
                ((org.jbpm.workflow.instance.NodeInstanceContainer) (getNodeInstanceContainer())).removeNodeInstance(SplitInstance.this);
                Node node = getNode();
                ...
                if ((connections == null) || (connections.isEmpty())) {
                    ((org.jbpm.workflow.instance.NodeInstanceContainer) (getNodeInstanceContainer())).nodeInstanceCompleted(SplitInstance.this, type);
                } else {
                    ...
                    for (Map.Entry<org.jbpm.workflow.instance.NodeInstance, String> entry : nodeInstancesMap.entrySet()) {
                        ...
                        if (!hidden) {
                            ((InternalProcessRuntime) (kruntime.getProcessRuntime())).getProcessEventSupport().fireBeforeNodeLeft(SplitInstance.this, kruntime);
                        } 
                        ((org.jbpm.workflow.instance.NodeInstance) (entry.getKey())).trigger(SplitInstance.this, entry.getValue());
                        if (!hidden) {
                            ((InternalProcessRuntime) (kruntime.getProcessRuntime())).getProcessEventSupport().fireAfterNodeLeft(SplitInstance.this, kruntime);
                        } 
                    }
                }
                // stop if this process instance has been aborted / completed
