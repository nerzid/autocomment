...
public class SplitInstance extends NodeInstanceImpl {
            ...
            case Split.TYPE_XAND :
                ...
                if ((connections == null) || (connections.isEmpty())) {
                    ...
                    if (parent instanceof ContextInstanceContainer) {
                        ((ContextInstanceContainer) (parent)).addContextInstance(EXCLUSIVE_GROUP, groupInstance);
                    }else {
    ...
    protected boolean checkNodes(Node currentNode, final Node lookFor, Set<Long> vistedNodes) {
        List<Connection> connections = currentNode.getOutgoingConnections(CONNECTION_DEFAULT_TYPE);
