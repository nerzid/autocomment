...
public class ActionNodeInstance extends NodeInstanceImpl {
    ...
    public void internalTrigger(final NodeInstance from, String type) {
        ...
        try {
            ...
            context.setNodeInstance(ActionNodeInstance.this);
            ...
            throw new WorkflowRuntimeException(ActionNodeInstance.this, getProcessInstance(), ("Unable to execute Action: " + (e.getMessage())), e);
        }
        triggerCompleted();
    }
