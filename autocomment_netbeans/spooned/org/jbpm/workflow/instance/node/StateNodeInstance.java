...
public class StateNodeInstance extends CompositeContextNodeInstance implements EventListener {
    ...
    public void internalTrigger(NodeInstance from, String type) {
        ...
        if (selected != null) {
            ((NodeInstanceContainer) (getNodeInstanceContainer())).removeNodeInstance(StateNodeInstance.this);
            ...
            if (event instanceof String) {
                for (Connection connection : getStateNode().getOutgoingConnections(NodeImpl.CONNECTION_DEFAULT_TYPE)) {
                    ...
                    if (selected) {
                        ...
                        ((org.jbpm.workflow.instance.NodeInstanceContainer) (getNodeInstanceContainer())).removeNodeInstance(StateNodeInstance.this);
    ...
    private void addTriggerListener() {
        getProcessInstance().addEventListener("signal", StateNodeInstance.this, false);
    }

    private void addActivationListener() {
        getProcessInstance().addEventListener(getActivationEventType(), StateNodeInstance.this, true);
    }
    ...
    public void removeEventListeners() {
        ...
        getProcessInstance().removeEventListener("signal", StateNodeInstance.this, false);
        getProcessInstance().removeEventListener(getActivationEventType(), StateNodeInstance.this, true);
    }
