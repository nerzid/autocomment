...
public class WorkflowRuntimeException extends RuntimeException {
    ...
    public String getMessage() {
        return MessageFormat.format("[{0}:{4} - {1}:{2}] -- {3}", getProcessId(), ((getNodeName()) == null ? "?" : getNodeName()), ((getNodeId()) == 0 ? "?" : getNodeId()), ((getCause()) == null ? getMessage() : getCause().getMessage()), getProcessInstanceId());
    }
}
