 ...
 */
public class WorkItemNode extends StateBasedNode implements ContextContainer , Mappable {
    ...
    public void setInMappings(Map<String, String> inMapping) {
        WorkItemNode.this.inMapping = new LinkedList<DataAssociation>();
    ...
    public void setOutMappings(Map<String, String> outMapping) {
        WorkItemNode.this.outMapping = new LinkedList<DataAssociation>();
    ...
    public void setWaitForCompletion(boolean waitForCompletion) {
        WorkItemNode.this.waitForCompletion = waitForCompletion;
    }
    ...
    public void addContext(Context context) {
        ((AbstractContext) (context)).setContextContainer(WorkItemNode.this);
