...
public class ForEachNode extends CompositeContextNode {
    ...
    public ForEachNode() {
        ...
        super.addNode(split);
        super.linkIncomingConnections(org.jbpm.workflow.core.Node.CONNECTION_DEFAULT_TYPE, new CompositeNode.NodeAndType(split, Node.CONNECTION_DEFAULT_TYPE));
        // Composite node
        ...
        // Join
        ForEachNode.ForEachJoinNode join = new ForEachNode.ForEachJoinNode();
        join.setName("ForEachJoin");
        join.setMetaData("hidden", true);
        join.setMetaData("UniqueId", ((getMetaData("Uniqueid")) + ":foreach:join"));
        super.addNode(join);
        super.linkOutgoingConnections(new CompositeNode.NodeAndType(join, Node.CONNECTION_DEFAULT_TYPE), org.jbpm.workflow.core.Node.CONNECTION_DEFAULT_TYPE);
        new org.jbpm.workflow.core.impl.ConnectionImpl(super.getNode(1), Node.CONNECTION_DEFAULT_TYPE, getCompositeNode(), Node.CONNECTION_DEFAULT_TYPE);
        new org.jbpm.workflow.core.impl.ConnectionImpl(getCompositeNode(), Node.CONNECTION_DEFAULT_TYPE, super.getNode(3), Node.CONNECTION_DEFAULT_TYPE);
    }
    ...
    public ForEachNode.ForEachSplitNode getForEachSplitNode() {
        return ((ForEachNode.ForEachSplitNode) (super.getNode(1)));
    }

    public ForEachNode.ForEachJoinNode getForEachJoinNode() {
        return ((ForEachNode.ForEachJoinNode) (super.getNode(3)));
    }
    ...
    public NodeAndType getLinkedOutgoingNode(String inType) {
        return getCompositeNode().getLinkedOutgoingNode(inType);
    }

    public NodeAndType internalGetLinkedOutgoingNode(String inType) {
        return super.getLinkedOutgoingNode(inType);
    }

    public void setVariable(String variableName, DataType type) {
        ForEachNode.this.variableName = variableName;
    ...
    public void setOutputVariable(String variableName, DataType type) {
        ForEachNode.this.outputVariableName = variableName;
        VariableScope variableScope = ((VariableScope) (getCompositeNode().getDefaultContext(VariableScope.VARIABLE_SCOPE)));
        List<Variable> variables = variableScope.getVariables();
        if (variables == null) {
            variables = new ArrayList<Variable>();
    ...
    public void setCollectionExpression(String collectionExpression) {
        ForEachNode.this.collectionExpression = collectionExpression;
    }
    ...
    public void setOutputCollectionExpression(String collectionExpression) {
        ForEachNode.this.outputCollectionExpression = collectionExpression;
    }
    ...
    public void setWaitForCompletion(boolean waitForCompletion) {
        ForEachNode.this.waitForCompletion = waitForCompletion;
    }
    ...
    public void setCompletionConditionExpression(String completionConditionExpression) {
        ForEachNode.this.completionConditionExpression = completionConditionExpression;
    }
}
