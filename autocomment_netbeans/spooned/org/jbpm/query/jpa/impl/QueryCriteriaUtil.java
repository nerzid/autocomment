...
public abstract class QueryCriteriaUtil {
    ...
    protected void initialize(Map<Class, Map<String, Attribute>> criteriaAttributes) {
        QueryCriteriaUtil.this.criteriaAttributes = criteriaAttributes;
    }
    ...
    public <T> List<T> doCriteriaQuery(QueryWhere queryWhere, Class<T> queryType) {
        ...
        javax.persistence.criteria.CriteriaQuery<T> criteriaQuery = builder.createQuery(queryType);
        // query base;
     ...
     */
    // @formatter:off
    protected abstract <R, T> Predicate implSpecificCreatePredicateFromSingleCriteria(CriteriaQuery<R> query, CriteriaBuilder builder, Class queryType, QueryCriteria criteria, QueryWhere queryWhere);
     ...
     */
    // @formatter:off
    protected abstract <T> List<T> createQueryAndCallApplyMetaCriteriaAndGetResult(QueryWhere queryWhere, CriteriaQuery<T> criteriaQuery, CriteriaBuilder builder);
