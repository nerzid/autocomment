...
public class ChecklistUI extends JFrame {
        ...
        itemTable.getColumnModel().getColumn(0).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                if (value != null) {
                    ...
                    switch (((Status) (value))) {
                        case Completed :
                            label.setIcon(ChecklistUI.ICONS[0]);
                            break;
                        case Aborted :
                            label.setIcon(ChecklistUI.ICONS[2]);
                            break;
                        case InProgress :
                            label.setIcon(ChecklistUI.ICONS[1]);
                            break;
                        case Created :
                            label.setIcon(ChecklistUI.ICONS[1]);
                            break;
                        ...
                        case Ready :
                            ...
                            break;
                        case Optional :
                            label.setIcon(ChecklistUI.ICONS[3]);
                            break;
                        case Pending :
                            break;
                        default :
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                if (value != null) {
                    ...
                    if ("HumanTaskNode".equals(s)) {
                        label.setIcon(ChecklistUI.TYPE_ICONS[0]);
                    } else if ("ActionNode".equals(s)) {
                        label.setIcon(ChecklistUI.TYPE_ICONS[1]);
                    } else if ("SubProcessNode".equals(s)) {
                        label.setIcon(ChecklistUI.TYPE_ICONS[2]);
                    } else if ("WorkItemNode".equals(s)) {
                        label.setIcon(ChecklistUI.TYPE_ICONS[3]);
                    } 
                } 
                return label;
            }
    ...
    private void create() {
        String s = ((String) (JOptionPane.showInputDialog(ChecklistUI.this, "Select Checklist Template:", "Select Template", JOptionPane.PLAIN_MESSAGE, null, new Object[]{ "None" , "Business Trip" , "Sample1" }, "None")));
        if (s == null) {
            return ;
        } 
    ...
    private void createNewItem() {
        if ((getSelectedProcessInstance()) != null) {
            CreateItemDialog dialog = new CreateItemDialog(ChecklistUI.this, getActorId());
