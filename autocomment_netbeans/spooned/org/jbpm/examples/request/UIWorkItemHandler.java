...
public class UIWorkItemHandler extends JFrame implements WorkItemHandler {
    ...
    public WorkItem getSelectedWorkItem() {
        ...
        if (index != (-1)) {
            ...
            if (selected instanceof UIWorkItemHandler.WorkItemWrapper) {
                return ((UIWorkItemHandler.WorkItemWrapper) (selected)).getWorkItem();
            } 
        } 
        return null;
    }
    ...
    private void reloadWorkItemsList() {
        List<UIWorkItemHandler.WorkItemWrapper> result = new ArrayList<UIWorkItemHandler.WorkItemWrapper>();
        for (Iterator<WorkItem> iterator = workItems.keySet().iterator(); iterator.hasNext();) {
            WorkItem workItem = iterator.next();
            result.add(new UIWorkItemHandler.WorkItemWrapper(workItem));
        }
    ...
    private class WorkItemWrapper {
        ...
        public WorkItemWrapper(WorkItem workItem) {
            UIWorkItemHandler.WorkItemWrapper.this.workItem = workItem;
        }
