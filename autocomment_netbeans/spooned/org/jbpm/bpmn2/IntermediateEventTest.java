...
public class IntermediateEventTest extends JbpmBpmn2TestCase {
    ...
    public static Collection<Object[]> persistence() {
        Object[][] data = new Object[][]{ new Object[]{ false , false } , new Object[]{ true , false } , new Object[]{ true , true } };
    ...
    public void testEventBasedSplit() throws Exception {
        ...
        ksession = createKnowledgeSession(kbase);
        ksession.getWorkItemManager().registerWorkItemHandler("Email1", new org.jbpm.process.instance.impl.demo.SystemOutWorkItemHandler());
        ksession.getWorkItemManager().registerWorkItemHandler("Email2", new org.jbpm.process.instance.impl.demo.SystemOutWorkItemHandler());
        // Yes
    ...
    public void testEventBasedSplitBefore() throws Exception {
        ...
        KieBase kbase = createKnowledgeBase("BPMN2-EventBasedSplit.bpmn2");
        ksession = createKnowledgeSession(kbase);
        ksession.getWorkItemManager().registerWorkItemHandler("Email1", new org.jbpm.process.instance.impl.demo.DoNothingWorkItemHandler());
        ksession.getWorkItemManager().registerWorkItemHandler("Email2", new org.jbpm.process.instance.impl.demo.DoNothingWorkItemHandler());
        // Yes
        ProcessInstance processInstance = ksession.startProcess("com.sample.test");
        assertProcessInstanceActive(processInstance);
        ksession = restoreSession(ksession, true);
    ...
    public void testMessageIntermediateThrowVerifyWorkItemData() throws Exception {
        ...
        assertNotNull(workItem);
        assertTrue((workItem instanceof org.drools));
    ...
    public void testIntermediateCatchEventSameSignalOnTwoKsessions() throws Exception {
        ...
        ksession2.getWorkItemManager().registerWorkItemHandler("Human Task", new org.jbpm.process.instance.impl.demo.SystemOutWorkItemHandler());
    ...
    public void testSignalBoundaryEventWithTransformation() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-BoundarySignalEventOnTaskWithTransformation.bpmn", "BPMN2-IntermediateThrowEventSignal.bpmn2");
        StatefulKnowledgeSession ksession = createKnowledgeSession(kbase);
        TestWorkItemHandler handler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", handler);
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public void testEventSubprocessSignalWithTransformation() throws Exception {
        ...
        assertProcessInstanceFinished(processInstance, ksession);
        assertNodeTriggered(processInstance.getId(), "start", "User Task 1", "Sub Process 1", "start-sub", "end-sub");
        String var = getProcessVarValue(processInstance, "x");
        assertNotNull(var);
        assertEquals("JOHN", var);
    }
    ...
    public void testIntermediateCatchEventTimerDurationWithError() throws Exception {
        ...
        ksession.execute(new org.jbpm.process.instance.command.UpdateTimerCommand(processInstance.getId(), "timer", (waitTime + 1)));
