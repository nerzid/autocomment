...
public class ExceptionService {
    ...
    public void handleException(WorkItem workItem) {
        Object[] resultHolder = ExceptionService.localCaughtEventObjectHolder.get();
    ...
    public static void setCaughtEventObjectHolder(Object[] testVarArrayHolder) {
        // set Object[]{testVarArrayHolder} to ThreadLocal{ExceptionService.localCaughtEventObjectHolder}
        ExceptionService.localCaughtEventObjectHolder.set(testVarArrayHolder);
    }
}
