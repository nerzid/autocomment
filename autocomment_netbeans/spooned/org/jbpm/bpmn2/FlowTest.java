...
public class FlowTest extends JbpmBpmn2TestCase {
    ...
    public void testExclusiveSplit() throws Exception {
        ...
        params.put("x", "First");
        params.put("y", "Second");
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("com.sample.test", params);
    ...
    public void testExclusiveXORGateway() throws Exception {
        ...
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("process", params);
        assertProcessInstanceCompleted(processInstance);
    }
    ...
    public void testInclusiveSplitDefaultConnection() throws Exception {
        ...
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("test", "c");
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("InclusiveGatewayWithDefault", params);
        assertProcessInstanceCompleted(processInstance);
    }
    ...
    public void testInclusiveParallelExclusiveSplitNoLoop() throws Exception {
        ...
        ksession.addEventListener(new DefaultProcessEventListener() {
            ...
            public void beforeNodeTriggered(ProcessNodeTriggeredEvent event) {
                FlowTest.logger.info(event.getNodeInstance().getNodeName());
        ...
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("x", 0);
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("Process_1", params);
        assertProcessInstanceCompleted(processInstance);
    ...
    public void testInclusiveSplitWithLoopInside() throws Exception {
        ...
        ksession.addEventListener(new DefaultProcessEventListener() {
            @Override
            public void beforeNodeTriggered(ProcessNodeTriggeredEvent event) {
                FlowTest.logger.info("{} {}", event.getNodeInstance().getNodeName(), ((NodeInstanceImpl) (event.getNodeInstance())).getLevel());
                Integer value = nodeInstanceExecutionCounter.get(event.getNodeInstance().getNodeName());
                if (value == null) {
                    value = new Integer(0);
                } 
    ...
    public void testMultiInstanceLoopCharacteristicsProcessWithORGateway() throws Exception {
        ...
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("MultiInstanceLoopCharacteristicsProcess", params);
    ...
    public void testInclusiveJoinWithLoopAndHumanTasks() throws Exception {
        ...
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("InclusiveWithAdvancedLoop", params);
    ...
    public void testMultiInstanceLoopNumberTest() throws Exception {
        ...
        TestWorkItemHandler handler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", handler);
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("Test.MultipleInstancesBug", params);
        List<WorkItem> workItems = handler.getWorkItems();
        FlowTest.logger.debug("COMPLETING TASKS.");
    ...
    public void testMultiInstanceLoopCharacteristicsProcess2() throws Exception {
        ...
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("miprocess", params);
        List<WorkItem> workItems = handler.getWorkItems();
        assertNotNull(workItems);
        assertEquals(2, workItems.size());
        myOutList = ((List<String>) (ksession.execute(new FlowTest.GetProcessVariableCommand(processInstance.getId(), "mioutput"))));
    ...
    public void testMultiInstanceLoopCharacteristicsProcessWithOutput() throws Exception {
        ...
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("MultiInstanceLoopCharacteristicsProcessWithOutput", params);
        assertProcessInstanceCompleted(processInstance);
    ...
    public void testMultiInstanceLoopCharacteristicsTaskWithOutput() throws Exception {
        ...
        params.put("listOut", myListOut);
        assertEquals(0, myListOut.size());
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("MultiInstanceLoopCharacteristicsTask", params);
        assertProcessInstanceCompleted(processInstance);
        assertEquals(2, myListOut.size());
    }
    ...
    public void testMultipleIncomingFlowToEndNode() throws Exception {
        ...
        ksession = createKnowledgeSession(kbase);
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("MultipleFlowEndNode");
        assertProcessInstanceCompleted(processInstance);
        System.clearProperty("jbpm.enable.multi.con");
    }
    ...
    public void testMultipleEnabledOnSingleConditionalSequenceFlow() throws Exception {
        ...
        assertEquals(0, list.size());
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("BPMN2-MultiConnEnabled");
        assertProcessInstanceActive(processInstance);
    ...
    public void testMultipleInOutgoingSequenceFlowsDisable() throws Exception {
        try {
            ...
            assertEquals("This type of node [ScriptTask_1, Script Task] cannot have more than one outgoing connection!", e.getMessage());
        }
    }
    ...
    public void testLane() throws Exception {
        ...
        TestWorkItemHandler workItemHandler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", workItemHandler);
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("UserTask");
        assertTrue(((processInstance.getState()) == (org.kie.api.runtime.process.ProcessInstance.STATE_ACTIVE)));
        ksession = restoreSession(ksession, true);
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", workItemHandler);
    ...
    public void testExclusiveSplitDefaultNoCondition() throws Exception {
        ...
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("com.sample.test");
        assertProcessInstanceFinished(processInstance, ksession);
    }
    ...
    public void testMultipleGatewaysProcess() throws Exception {
        ...
        ksession.addEventListener(new DefaultProcessEventListener() {
            ...
            @Override
            public void beforeNodeTriggered(ProcessNodeTriggeredEvent event) {
                FlowTest.logger.info("Before Node triggered event received for node: {}", event.getNodeInstance().getNodeName());
            }
        ...
        org.kie.api.runtime.process.ProcessInstance processInstance = ksession.startProcess("multiplegateways", params);
        assertProcessInstanceCompleted(processInstance);
    }
    ...
    public void testTimerAndGateway() throws Exception {
        ...
        org.kie.api.runtime.process.ProcessInstance instance = ksession.createProcessInstance("timer-process", new HashMap<String, Object>());
    ...
    private static class GetProcessVariableCommand implements GenericCommand<Object> {
        ...
        public GetProcessVariableCommand(long processInstanceId, String variableName) {
            FlowTest.GetProcessVariableCommand.this.processInstanceId = processInstanceId;
            FlowTest.GetProcessVariableCommand.this.variableName = variableName;
        }
