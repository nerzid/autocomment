...
public class ActivityTest extends JbpmBpmn2TestCase {
    ...
    public void testMinimalProcessMetaData() throws Exception {
        ...
        ksession.addEventListener(new DefaultProcessEventListener() {
            public void beforeNodeTriggered(ProcessNodeTriggeredEvent event) {
                ActivityTest.logger.debug("before node");
                Map<String, Object> metaData = event.getNodeInstance().getNode().getMetaData();
                for (Map.Entry<String, Object> entry : metaData.entrySet()) {
                    ActivityTest.logger.debug((((entry.getKey()) + " ") + (entry.getValue())));
                }
            ...
            public void afterVariableChanged(ProcessVariableChangedEvent event) {
                ActivityTest.logger.debug("after variable");
            ...
            public void afterProcessStarted(ProcessStartedEvent event) {
                ActivityTest.logger.debug("after process");
    ...
    public void testScriptTaskWithHistoryLog() throws Exception {
        ...
        ProcessInstance processInstance = ksession.startProcess("ScriptTask");
        assertProcessInstanceCompleted(processInstance);
        AuditLogService logService = new org.jbpm.process.audit.JPAAuditLogService(ksession.getEnvironment());
    ...
    public void testRuleTask() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-RuleTask.bpmn2", "BPMN2-RuleTask.drl");
        ksession = createKnowledgeSession(kbase);
    ...
    public void testRuleTask2() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-RuleTask2.bpmn2", "BPMN2-RuleTask2.drl");
        ksession = createKnowledgeSession(kbase);
        List<String> list = new ArrayList<String>();
        ksession.setGlobal("list", list);
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public void testRuleTaskSetVariableWithReconnect() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-RuleTask2.bpmn2", "BPMN2-RuleTaskSetVariableReconnect.drl");
        ksession = createKnowledgeSession(kbase);
        List<String> list = new ArrayList<String>();
        ksession.setGlobal("list", list);
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public void testRuleTaskWithFactsWithPersistence() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-RuleTaskWithFact.bpmn2", "BPMN2-RuleTask3.drl");
        ksession = createKnowledgeSession(kbase);
        ((KnowledgeCommandContext) (((CommandBasedStatefulKnowledgeSession) (ksession)).getCommandService().getContext())).getKieSession().addEventListener(new org.jbpm.process.instance.event.listeners.TriggerRulesEventListener(ksession));
    ...
    public void testUserTaskWithDataStoreScenario() throws Exception {
        ...
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", new org.jbpm.process.instance.impl.demo.DoNothingWorkItemHandler());
    ...
    public void testCallActivity2() throws Exception {
        KieBase kbase = createKnowledgeBase("BPMN2-CallActivity2.bpmn2", "BPMN2-CallActivitySubProcess.bpmn2");
        ksession = createKnowledgeSession(kbase);
        TestWorkItemHandler workItemHandler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", workItemHandler);
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public void testCallActivityByName() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-CallActivityByName.bpmn2", "BPMN2-CallActivitySubProcess.bpmn2", "BPMN2-CallActivitySubProcessV2.bpmn2");
        ksession = createKnowledgeSession(kbase);
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("x", "oldValue");
        ProcessInstance processInstance = ksession.startProcess("ParentProcess", params);
        assertProcessInstanceCompleted(processInstance);
        assertEquals("new value V2", ((WorkflowProcessInstance) (processInstance)).getVariable("y"));
    }
    ...
    public void testCallActivityWithTimer() throws Exception {
        ...
        long sessionId = ksession.getIdentifier();
        Environment env = ksession.getEnvironment();
        ActivityTest.logger.info("dispose");
        ksession.dispose();
        ksession = JPAKnowledgeService.loadStatefulKnowledgeSession(sessionId, kbase, null, env);
        ksession.addEventListener(countDownListener);
        countDownListener.waitTillCompleted();
    ...
    public void testSubProcess() throws Exception {
        ...
        ksession.addEventListener(new DefaultProcessEventListener() {
            public void afterProcessStarted(ProcessStartedEvent event) {
                ActivityTest.logger.debug(event.toString());
            }
    ...
    public void testAdHocSubProcess() throws Exception {
        ...
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", workItemHandler);
        ksession.fireAllRules();
        ActivityTest.logger.debug("Signaling Hello2");
    ...
    public void testAdHocSubProcessAutoCompleteDynamicSubProcess2() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-AdHocSubProcessAutoComplete.bpmn2", "BPMN2-AdHocSubProcess.drl", "BPMN2-ServiceProcess.bpmn2");
        ksession = createKnowledgeSession(kbase);
        TestWorkItemHandler workItemHandler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", workItemHandler);
        TestWorkItemHandler workItemHandler2 = new TestWorkItemHandler();
    ...
    public void testAdHocProcess() throws Exception {
        ...
        ksession = restoreSession(ksession, true);
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", new org.jbpm.process.instance.impl.demo.DoNothingWorkItemHandler());
        ActivityTest.logger.debug("Triggering node");
    ...
    public void testSendTask() throws Exception {
        ...
        ksession = createKnowledgeSession(kbase);
        ksession.getWorkItemManager().registerWorkItemHandler("Send Task", new org.jbpm.bpmn2.handler.SendTaskHandler());
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("s", "john");
    ...
    public void testCallActivityWithSubProcessWaitState() throws Exception {
        KieBase kbase = createKnowledgeBase("BPMN2-CallActivity.bpmn2", "BPMN2-CallActivitySubProcessWithBoundaryEvent.bpmn2");
        ksession = createKnowledgeSession(kbase);
        TestWorkItemHandler workItemHandler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", workItemHandler);
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public void testBusinessRuleTaskWithTransformation() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-RuleTaskWithTransformation.bpmn2", "BPMN2-RuleTaskWithTransformation.drl");
        ksession = createKnowledgeSession(kbase);
    ...
    public void testErrorBetweenProcessesProcess() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("subprocess/ErrorsBetweenProcess-Process.bpmn2", "subprocess/ErrorsBetweenProcess-SubProcess.bpmn2");
        ksession = createKnowledgeSession(kbase);
    ...
    public void testProcessCustomDescriptionMetaData() throws Exception {
        ...
        ProcessInstance processInstance = ksession.startProcess("Minimal", params);
        assertProcessInstanceCompleted(processInstance);
        String description = ((ProcessInstanceImpl) (processInstance)).getDescription();
    ...
    public void testMultipleBusinessRuleTaskWithDataInputsWithPersistence() throws Exception {
        ...
        ksession = createKnowledgeSession(kbase);
        ksession.addEventListener(new org.jbpm.process.instance.event.listeners.TriggerRulesEventListener(ksession));
    ...
    public void testAdHocSubProcessWithTerminateEndEvent() throws Exception {
        KieBase kbase = createKnowledgeBaseWithoutDumper("BPMN2-AdHocTerminateEndEvent.bpmn2");
        ksession = createKnowledgeSession(kbase);
        TestWorkItemHandler workItemHandler = new TestWorkItemHandler();
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", workItemHandler);
