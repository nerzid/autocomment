...
public class XPATHActionBuilder implements ActionBuilder {
    private static final Map macros = new HashMap(5);

    static {
        XPATHActionBuilder.macros.put("insert", new Macro() {
    ...
    public void build(final PackageBuildContext context, final DroolsAction action, final ActionDescr actionDescr, final ContextResolver contextResolver) {
        String text = XPATHActionBuilder.processMacros(actionDescr.getText());
        try {
