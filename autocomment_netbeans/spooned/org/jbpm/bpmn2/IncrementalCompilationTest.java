...
public class IncrementalCompilationTest extends AbstractBaseTest {
    ...
    public void testIncrementalProcessCompilation() throws Exception {
        ...
        assertEquals(4, results.getMessages(org.kie.api.builder.Message.Level.ERROR).size());
    ...
    private String getResource(String name) throws IOException {
        InputStream is = IncrementalCompilationTest.this.getClass().getResourceAsStream(name);
