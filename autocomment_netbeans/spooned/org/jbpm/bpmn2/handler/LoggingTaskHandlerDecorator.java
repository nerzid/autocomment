...
public class LoggingTaskHandlerDecorator extends AbstractExceptionHandlingTaskHandler {
    ...
    private Queue<LoggingTaskHandlerDecorator.WorkItemExceptionInfo> exceptionInfoList = new ArrayDeque<LoggingTaskHandlerDecorator.WorkItemExceptionInfo>(loggedExceptionsLimit);

    private String configuredMessage = "{0} thrown when work item {1} ({2}) was {3}ed in process instance {4}.";

    private List<LoggingTaskHandlerDecorator.InputParameter> configuredInputList = new ArrayList<LoggingTaskHandlerDecorator.InputParameter>();
    ...
    public synchronized List<LoggingTaskHandlerDecorator.WorkItemExceptionInfo> getWorkItemExceptionInfoList() {
        return new ArrayList<LoggingTaskHandlerDecorator.WorkItemExceptionInfo>(exceptionInfoList);
    }
...
WORK_ITEM_ID, WORK_ITEM_NAME, WORK_ITEM_METHOD, WORK_ITEM_HANDLER_TYPE, WORK_ITEM_PARAMETERS, SERVICE, OPERATION, PROCESS_INSTANCE_ID, EXCEPTION_CLASS;    }
}
