...
public class StandaloneBPMNProcessTest extends JbpmBpmn2TestCase {
    ...
    public void testEvaluationProcess() throws Exception {
        ...
        ksession.getWorkItemManager().registerWorkItemHandler("RegisterRequest", new org.jbpm.process.instance.impl.demo.SystemOutWorkItemHandler());
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("employee", "UserId-12345");
        ProcessInstance processInstance = ksession.startProcess("Evaluation", params);
        assertTrue(((processInstance.getState()) == (ProcessInstance.STATE_COMPLETED)));
    ...
    public void testCallActivity() throws Exception {
        ...
        if (!(kbuilder.getErrors().isEmpty())) {
            for (KnowledgeBuilderError error : kbuilder.getErrors()) {
                StandaloneBPMNProcessTest.logger.error("{}", error);
            }
