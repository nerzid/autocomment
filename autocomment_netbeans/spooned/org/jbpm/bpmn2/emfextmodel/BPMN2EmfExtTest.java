...
public class BPMN2EmfExtTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put(Resource.Factory.Registry.DEFAULT_EXTENSION, new org.jboss.drools.util.DroolsResourceFactoryImpl());
