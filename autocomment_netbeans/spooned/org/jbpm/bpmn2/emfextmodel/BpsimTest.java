...
public class BpsimTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put(Resource.Factory.Registry.DEFAULT_EXTENSION, new bpsim.util.BpsimResourceFactoryImpl());
        resourceSet.getPackageRegistry().put(BpsimPackage.eNS_URI, BpsimPackage.eINSTANCE);
    }
