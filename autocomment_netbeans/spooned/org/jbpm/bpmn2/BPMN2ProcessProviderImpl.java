...
public class BPMN2ProcessProviderImpl implements BPMN2ProcessProvider {
    static {
        ProcessDialectRegistry.setDialect("XPath", new org.jbpm.bpmn2.xpath.XPATHProcessDialect());
    }
    ...
    public void configurePackageBuilder(KnowledgeBuilder knowledgeBuilder) {
        ...
        if ((conf.getSemanticModules().getSemanticModule(BPMNSemanticModule.BPMN2_URI)) == null) {
            conf.addSemanticModule(new org.jbpm.bpmn2.xml.BPMNSemanticModule());
            conf.addSemanticModule(new org.jbpm.bpmn2.xml.BPMNDISemanticModule());
            conf.addSemanticModule(new org.jbpm.bpmn2.xml.BPMNExtensionsSemanticModule());
        } 
    }
}
