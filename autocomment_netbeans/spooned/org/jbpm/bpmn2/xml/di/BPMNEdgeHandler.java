...
public class BPMNEdgeHandler extends BaseAbstractHandler implements Handler {
    ...
    protected void initValidParents() {
        BPMNEdgeHandler.this.validParents = new HashSet<Class<?>>();
        BPMNEdgeHandler.this.validParents.add(ProcessInfo.class);
    }

    protected void initValidPeers() {
        BPMNEdgeHandler.this.validPeers = new HashSet<Class<?>>();
        BPMNEdgeHandler.this.validPeers.add(null);
        BPMNEdgeHandler.this.validPeers.add(NodeInfo.class);
        BPMNEdgeHandler.this.validPeers.add(BPMNEdgeHandler.ConnectionInfo.class);
    }

    public Object start(final String uri, final String localName, final Attributes attrs, final ExtensibleXmlParser parser) throws SAXException {
        parser.startElementBuilder(localName, attrs);
        final String elementRef = attrs.getValue("bpmnElement");
        BPMNEdgeHandler.ConnectionInfo info = new BPMNEdgeHandler.ConnectionInfo(elementRef);
    ...
    public Object end(final String uri, final String localName, final ExtensibleXmlParser parser) throws SAXException {
        ...
        BPMNEdgeHandler.ConnectionInfo connectionInfo = ((BPMNEdgeHandler.ConnectionInfo) (parser.getCurrent()));
    ...
    public Class<?> generateNodeFor() {
        return BPMNEdgeHandler.ConnectionInfo.class;
    }
    ...
    public static class ConnectionInfo {
        ...
        public ConnectionInfo(String elementRef) {
            BPMNEdgeHandler.ConnectionInfo.this.elementRef = elementRef;
        }
        ...
        public void setBendpoints(String bendpoints) {
            BPMNEdgeHandler.ConnectionInfo.this.bendpoints = bendpoints;
        }
    }
}
