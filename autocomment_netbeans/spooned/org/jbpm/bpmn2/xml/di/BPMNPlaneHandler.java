...
public class BPMNPlaneHandler extends BaseAbstractHandler implements Handler {
    ...
    protected void initValidParents() {
        BPMNPlaneHandler.this.validParents = new HashSet<Class<?>>();
        BPMNPlaneHandler.this.validParents.add(Definitions.class);
    }

    protected void initValidPeers() {
        BPMNPlaneHandler.this.validPeers = new HashSet<Class<?>>();
        BPMNPlaneHandler.this.validPeers.add(null);
        BPMNPlaneHandler.this.validPeers.add(Process.class);
    }

    public Object start(final String uri, final String localName, final Attributes attrs, final ExtensibleXmlParser parser) throws SAXException {
        parser.startElementBuilder(localName, attrs);
        final String processRef = attrs.getValue("bpmnElement");
        BPMNPlaneHandler.ProcessInfo info = new BPMNPlaneHandler.ProcessInfo(processRef);
        return info;
    }

    public Object end(final String uri, final String localName, final ExtensibleXmlParser parser) throws SAXException {
        parser.endElementBuilder();
        BPMNPlaneHandler.ProcessInfo processInfo = ((BPMNPlaneHandler.ProcessInfo) (parser.getCurrent()));
    ...
    public Class<?> generateNodeFor() {
        return BPMNPlaneHandler.ProcessInfo.class;
    }
    ...
    public static class ProcessInfo {
        ...
        public ProcessInfo(String processRef) {
            BPMNPlaneHandler.ProcessInfo.this.processRef = processRef;
        }
        ...
        public void addNodeInfo(NodeInfo nodeInfo) {
            BPMNPlaneHandler.ProcessInfo.this.nodeInfos.add(nodeInfo);
        }
