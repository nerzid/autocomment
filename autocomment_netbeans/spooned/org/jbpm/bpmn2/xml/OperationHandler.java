...
public class OperationHandler extends BaseAbstractHandler implements Handler {
    ...
    public OperationHandler() {
        if (((OperationHandler.this.validParents) == null) && ((OperationHandler.this.validPeers) == null)) {
            this.validParents = new HashSet();
            OperationHandler.this.validParents.add(Interface.class);
            this.validPeers = new HashSet();
            OperationHandler.this.validPeers.add(null);
            OperationHandler.this.validPeers.add(Operation.class);
