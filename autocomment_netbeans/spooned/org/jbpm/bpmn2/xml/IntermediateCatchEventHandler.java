...
public class IntermediateCatchEventHandler extends AbstractNodeHandler {
    ...
    protected void handleLinkNode(Element element, Node node, org.w3c.dom.Node xmlLinkNode, ExtensibleXmlParser parser) {
        ...
        node.setMetaData(IntermediateCatchEventHandler.LINK_NAME, name);
    ...
    protected void readDataOutputAssociation(org.w3c.dom.Node xmlNode, EventNode eventNode) {
        ...
        if ((subNode != null) && ("transformation".equals(subNode.getNodeName()))) {
            ...
            eventNode.setEventTransformer(new org.jbpm.process.core.event.EventTransformerImpl(transformation));
        } 
    }
