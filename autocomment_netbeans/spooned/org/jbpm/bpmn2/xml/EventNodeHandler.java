                ...
                if (type.startsWith("Error-")) {
                    ...
                    if (type.startsWith("Timer-")) {
                        ...
                        if ((duration != null) && (cycle != null)) {
                            xmlDump.append(((((((((((("      <timerEventDefinition>" + (EOL)) + "        <timeDuration xsi:type=\"tFormalExpression\">") + (org.drools.compiler.compiler.xml.XmlDumper.replaceIllegalChars(duration))) + "</timeDuration>") + (EOL)) + "        <timeCycle xsi:type=\"tFormalExpression\">") + (org.drools.compiler.compiler.xml.XmlDumper.replaceIllegalChars(cycle))) + "</timeCycle>") + (EOL)) + "      </timerEventDefinition>") + (EOL)));
                        }else
                            if (duration != null) {
                                xmlDump.append(((((((("      <timerEventDefinition>" + (EOL)) + "        <timeDuration xsi:type=\"tFormalExpression\">") + (org.drools.compiler.compiler.xml.XmlDumper.replaceIllegalChars(duration))) + "</timeDuration>") + (EOL)) + "      </timerEventDefinition>") + (EOL)));
                            }else {
                                xmlDump.append(((((((("      <timerEventDefinition>" + (EOL)) + "        <timeCycle xsi:type=\"tFormalExpression\">") + (org.drools.compiler.compiler.xml.XmlDumper.replaceIllegalChars(cycle))) + "</timeCycle>") + (EOL)) + "      </timerEventDefinition>") + (EOL)));
                            }
