...
public class StartEventHandler extends AbstractNodeHandler {
    ...
    protected void readDataOutputAssociation(org.w3c.dom.Node xmlNode, StartNode startNode) {
        ...
        if ((subNode != null) && ("transformation".equals(subNode.getNodeName()))) {
            ...
            startNode.setEventTransformer(new org.jbpm.process.core.event.EventTransformerImpl(transformation));
            subNode = subNode.getNextSibling();
        } 
        if (subNode != null) {
        ...
        while (xmlNode != null) {
            ...
            if ("timerEventDefinition".equals(nodeName)) {
                ...
                if ((parser.getParent()) instanceof EventSubProcessNode) {
                    ...
                    startNode.addTrigger(trigger);
                    ((EventSubProcessNode) (parser.getParent())).addTimer(timer, new org.jbpm.workflow.core.impl.DroolsConsequenceAction("java", ""));
                } 
            } 
            xmlNode = xmlNode.getNextSibling();
        }
