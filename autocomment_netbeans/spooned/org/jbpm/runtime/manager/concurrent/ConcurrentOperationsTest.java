...
public class ConcurrentOperationsTest extends AbstractBaseTest {
    ...
    public void testExecuteProcessWithAsyncHandler() throws Exception {
        ...
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder.Factory.get().newDefaultBuilder().userGroupCallback(userGroupCallback).addEnvironmentEntry("TRANSACTION_LOCK_ENABLED", true).registerableItemsFactory(new DefaultRegisterableItemsFactory() {
            ...
            public Map<String, WorkItemHandler> getWorkItemHandlers(RuntimeEngine runtime) {
                ...
                handlers.put("Log", new ConcurrentOperationsTest.AsyncWorkItemHandler(((RuntimeEngineImpl) (runtime)).getManager()));
                return handlers;
            }
    ...
    private class AsyncWorkItemHandler implements WorkItemHandler {
        ...
        AsyncWorkItemHandler(RuntimeManager runtimeManager) {
            ConcurrentOperationsTest.AsyncWorkItemHandler.this.runtimeManager = runtimeManager;
        }
