...
public class MigrationManager {
    ...
    public MigrationManager(MigrationSpec migrationSpec) {
        MigrationManager.this.report = new MigrationReport(migrationSpec);
        MigrationManager.this.migrationSpec = migrationSpec;
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    MigrationManager.logger.warn("Unexpected error during migration", e);
            ...
            MigrationManager.logger.error("Unexpected error during migration", e);
