...
public class DisposeSessionTransactionSynchronization extends OrderedTransactionSynchronization {
    ...
    public DisposeSessionTransactionSynchronization(RuntimeManager manager, RuntimeEngine runtime) {
        ...
        DisposeSessionTransactionSynchronization.this.manager = manager;
        DisposeSessionTransactionSynchronization.this.runtime = runtime;
    }
    ...
    public void afterCompletion(int status) {
        try {
            ...
            DisposeSessionTransactionSynchronization.logger.debug("Could not dispose runtime engine", e);
        }
    }
}
