...
public class SynchronizedRuntimeImpl extends RuntimeEngineImpl {
    ...
    public SynchronizedRuntimeImpl(KieSession ksession, InternalTaskService taskService) {
        ...
        if (taskService != null) {
            SynchronizedRuntimeImpl.this.synchronizedTaskService = new org.jbpm.runtime.manager.impl.task.SynchronizedTaskService(ksession, taskService);
        } 
    }
    ...
    public TaskService getTaskService() {
        ...
        return SynchronizedRuntimeImpl.this.synchronizedTaskService;
    }
}
