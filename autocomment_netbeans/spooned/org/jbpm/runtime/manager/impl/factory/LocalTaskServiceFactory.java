...
public class LocalTaskServiceFactory implements TaskServiceFactory {
    ...
    public LocalTaskServiceFactory(RuntimeEnvironment runtimeEnvironment) {
        LocalTaskServiceFactory.this.runtimeEnvironment = runtimeEnvironment;
    }
    ...
    public TaskService newTaskService() {
        ...
        if (emf != null) {
            HumanTaskConfigurator configurator = HumanTaskServiceFactory.newTaskServiceConfigurator().environment(runtimeEnvironment.getEnvironment()).entityManagerFactory(emf).userGroupCallback(runtimeEnvironment.getUserGroupCallback());
