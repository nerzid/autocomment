...
public class DefaultRuntimeEnvironment extends SimpleRuntimeEnvironment {
    ...
    public void init() {
        if (((usePersistence) && ((emf) == null)) && ((getEnvironmentTemplate().get(CMD_SCOPED_ENTITY_MANAGER)) == null)) {
            emf = EntityManagerFactoryManager.get().getOrCreate("org.jbpm.persistence.jpa");
        }
        // add to void{ENTITY_MANAGER_FACTORY} to DefaultRuntimeEnvironment{}
        addToEnvironment(ENTITY_MANAGER_FACTORY, emf);
        if ((this.mapper) == null) {
