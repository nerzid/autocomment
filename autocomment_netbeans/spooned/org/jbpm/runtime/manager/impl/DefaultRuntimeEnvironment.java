...
public class DefaultRuntimeEnvironment extends SimpleRuntimeEnvironment {
    ...
    public void init() {
        ...
        if ((DefaultRuntimeEnvironment.this.mapper) == null) {
            if (DefaultRuntimeEnvironment.this.usePersistence) {
                DefaultRuntimeEnvironment.this.mapper = new org.jbpm.runtime.manager.impl.mapper.JPAMapper(emf);
            } else {
                DefaultRuntimeEnvironment.this.mapper = new org.jbpm.runtime.manager.impl.mapper.InMemoryMapper();
            }
        } 
    }
    ...
    protected static GlobalSchedulerService discoverSchedulerService() {
        if ((System.getProperty("org.quartz.properties")) != null) {
            return new org.jbpm.process.core.timer.impl.QuartzSchedulerService();
        } else {
            ...
            if (!("true".equalsIgnoreCase(System.getProperty("org.kie.timer.ejb.disabled")))) {
                try {
                    ...
                    DefaultRuntimeEnvironment.logger.debug("Unable to find on initialize ejb schduler service due to {}", e.getMessage());
                }
            } 
        }
        return new org.jbpm.process.core.timer.impl.ThreadPoolSchedulerService(3);
    }
}
