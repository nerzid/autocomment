...
public class RuntimeManagerFactoryImpl implements RuntimeManagerFactory {
    ...
    protected SessionFactory getSessionFactory(RuntimeEnvironment environment) {
        ...
        if (environment.usePersistence()) {
            factory = new org.jbpm.runtime.manager.impl.factory.JPASessionFactory(environment);
        } else {
            factory = new org.jbpm.runtime.manager.impl.factory.InMemorySessionFactory(environment);
        }
        return factory;
    }
    ...
    protected TaskServiceFactory getTaskServiceFactory(RuntimeEnvironment environment) {
        ...
        taskServiceFactory = new org.jbpm.runtime.manager.impl.factory.LocalTaskServiceFactory(environment);
        return taskServiceFactory;
    }
    ...
    protected void initTimerService(RuntimeEnvironment environment, RuntimeManager manager) {
        if (environment instanceof SchedulerProvider) {
            ...
            if (schedulerService != null) {
                TimerService globalTs = new org.jbpm.process.core.timer.impl.GlobalTimerService(manager, schedulerService);
                ...
                if (!(schedulerService.isTransactional())) {
                    schedulerService.setInterceptor(new org.jbpm.runtime.manager.impl.tx.TransactionAwareSchedulerServiceInterceptor(environment, manager, schedulerService));
                } 
            } 
        } 
    }
