 ...
 */
// TODO: use the Ink
public class SynchronizedTaskService implements EventService<TaskLifeCycleEventListener> , InternalTaskService {
    ...
    @Override
    public List<TaskSummary> getTasksByVariousFields(String userId, List<Long> workItemIds, List<Long> taskIds, List<Long> procInstIds, List<String> busAdmins, List<String> potOwners, List<String> taskOwners, List<Status> status, List<String> language, boolean union) {
        synchronized(ksession) {
            if ((taskService) != null) {
