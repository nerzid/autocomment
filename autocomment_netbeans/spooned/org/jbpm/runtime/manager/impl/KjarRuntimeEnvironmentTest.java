...
public class KjarRuntimeEnvironmentTest extends AbstractBaseTest {
    ...
    public void setup() {
        ...
        ReleaseId releaseId = ks.newReleaseId(KjarRuntimeEnvironmentTest.GROUP_ID, KjarRuntimeEnvironmentTest.ARTIFACT_ID, KjarRuntimeEnvironmentTest.VERSION);
    ...
    public void testCustomTaskFromKjar() {
        KieServices ks = KieServices.Factory.get();
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder.Factory.get().newDefaultBuilder(ks.newReleaseId(KjarRuntimeEnvironmentTest.GROUP_ID, KjarRuntimeEnvironmentTest.ARTIFACT_ID, KjarRuntimeEnvironmentTest.VERSION)).userGroupCallback(userGroupCallback).get();
    ...
    public void testScriptTaskFromKjarUsingNamedKbaseKsession() {
        KieServices ks = KieServices.Factory.get();
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder.Factory.get().newDefaultBuilder(ks.newReleaseId(KjarRuntimeEnvironmentTest.GROUP_ID, KjarRuntimeEnvironmentTest.ARTIFACT_ID, KjarRuntimeEnvironmentTest.VERSION), "defaultKieBase", "defaultKieSession").userGroupCallback(userGroupCallback).get();
        manager = RuntimeManagerFactory.Factory.get().newSingletonRuntimeManager(environment);
        Assert.assertNotNull(manager);
        RuntimeEngine engine = manager.getRuntimeEngine(EmptyContext.get());
        Assert.assertNotNull(engine);
    ...
    public void testScriptTaskFromKjarByName() {
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder.Factory.get().newDefaultBuilder(KjarRuntimeEnvironmentTest.GROUP_ID, KjarRuntimeEnvironmentTest.ARTIFACT_ID, KjarRuntimeEnvironmentTest.VERSION).userGroupCallback(userGroupCallback).get();
        manager = RuntimeManagerFactory.Factory.get().newSingletonRuntimeManager(environment);
        Assert.assertNotNull(manager);
        RuntimeEngine engine = manager.getRuntimeEngine(EmptyContext.get());
        Assert.assertNotNull(engine);
    ...
    public void testScriptTaskFromKjarByNameNamedKbaseKsession() {
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder.Factory.get().newDefaultBuilder(KjarRuntimeEnvironmentTest.GROUP_ID, KjarRuntimeEnvironmentTest.ARTIFACT_ID, KjarRuntimeEnvironmentTest.VERSION, "defaultKieBase", "defaultKieSession").userGroupCallback(userGroupCallback).get();
        manager = RuntimeManagerFactory.Factory.get().newSingletonRuntimeManager(environment);
        Assert.assertNotNull(manager);
        RuntimeEngine engine = manager.getRuntimeEngine(EmptyContext.get());
        Assert.assertNotNull(engine);
    ...
    public void testScriptTaskFromClasspathContainer() {
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder.Factory.get().newClasspathKmoduleDefaultBuilder().userGroupCallback(userGroupCallback).get();
        manager = RuntimeManagerFactory.Factory.get().newSingletonRuntimeManager(environment);
        Assert.assertNotNull(manager);
        RuntimeEngine engine = manager.getRuntimeEngine(EmptyContext.get());
        Assert.assertNotNull(engine);
    ...
    public void testScriptTaskFromClasspathContainerNamedKbaseKsession() {
        RuntimeEnvironment environment = RuntimeEnvironmentBuilder.Factory.get().newClasspathKmoduleDefaultBuilder("defaultKieBase", "defaultKieSession").userGroupCallback(userGroupCallback).get();
        manager = RuntimeManagerFactory.Factory.get().newSingletonRuntimeManager(environment);
        Assert.assertNotNull(manager);
        RuntimeEngine engine = manager.getRuntimeEngine(EmptyContext.get());
        Assert.assertNotNull(engine);
    ...
    public void testXStreamUnmarshalCustomObject() {
        KieServices ks = KieServices.Factory.get();
        ReleaseId releaseId = ks.newReleaseId(KjarRuntimeEnvironmentTest.GROUP_ID, "xstream-test", KjarRuntimeEnvironmentTest.VERSION);
        ...
        Assert.assertNotNull(processClient);
        Assert.assertEquals("pv207.finepayment.Client", processClient.getClass().getName());
        Assert.assertEquals("Pavel", valueOf(processClient, "name"));
        Assert.assertEquals("true", valueOf(processClient, "exists"));
    }
    ...
    protected KieFileSystem createKieFileSystemWithKProject(KieServices ks) {
        ...
        kieBaseModel1.newKieSessionModel("defaultKieSession").setDefault(true).setType(KieSessionModel.KieSessionType.STATEFUL).setClockType(ClockTypeOption.get("realtime")).newWorkItemHandlerModel("Log", "new org.jbpm.process.instance.impl.demo.SystemOutWorkItemHandler()");
