...
public class DefaultRegisterableItemsFactory extends SimpleRegisterableItemsFactory {
    ...
    public List<ProcessEventListener> getProcessEventListeners(RuntimeEngine runtime) {
        ...
        if (descriptor == null) {
            ...
            try {
                ...
                DefaultRegisterableItemsFactory.logger.error("Unable to load jms audit properties from {}", "/jbpm.audit.jms.properties", e);
            }
        } 
    ...
    public List<TaskLifeCycleEventListener> getTaskListeners() {
        ...
        defaultListeners.add(new org.jbpm.services.task.audit.JPATaskLifeCycleEventListener(true));
        // add any custom listeners
    ...
    public AuditEventBuilder getAuditBuilder(RuntimeEngine engine) {
        if (((DefaultRegisterableItemsFactory.this.auditBuilder) != null) && ((DefaultRegisterableItemsFactory.this.auditBuilder) instanceof ManagedAuditEventBuilderImpl)) {
            String identifier = ((RuntimeEngineImpl) (engine)).getManager().getIdentifier();
            ((ManagedAuditEventBuilderImpl) (DefaultRegisterableItemsFactory.this.auditBuilder)).setOwnerId(identifier);
        } 
        return DefaultRegisterableItemsFactory.this.auditBuilder;
    }

    public void setAuditBuilder(AuditEventBuilder auditBuilder) {
        DefaultRegisterableItemsFactory.this.auditBuilder = auditBuilder;
    }
    ...
    protected Object getInstanceFromModel(ObjectModel model, ClassLoader classloader, Map<String, Object> contaxtParams) {
        ...
        if (resolver == null) {
            DefaultRegisterableItemsFactory.logger.warn("Unable to find ObjectModelResolver for {}", model.getResolver());
        } 
