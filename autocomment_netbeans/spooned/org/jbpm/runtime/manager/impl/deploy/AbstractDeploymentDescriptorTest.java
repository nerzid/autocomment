...
public abstract class AbstractDeploymentDescriptorTest extends AbstractBaseTest {
    ...
    protected KieFileSystem createKieFileSystemWithKProject(KieServices ks) {
        ...
        kieBaseModel1.newKieSessionModel("ksession-test").setDefault(true).setType(KieSessionModel.KieSessionType.STATEFUL).setClockType(ClockTypeOption.get("realtime"));
