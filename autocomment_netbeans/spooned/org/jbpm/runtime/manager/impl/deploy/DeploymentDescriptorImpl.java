...
public class DeploymentDescriptorImpl implements Serializable , DeploymentDescriptor {
    ...
    public DeploymentDescriptorImpl(String defaultPU) {
        DeploymentDescriptorImpl.this.persistenceUnit = defaultPU;
        DeploymentDescriptorImpl.this.auditPersistenceUnit = defaultPU;
    }
    ...
    public void setPersistenceUnit(String persistenceUnit) {
        DeploymentDescriptorImpl.this.persistenceUnit = persistenceUnit;
    }

    public void setAuditPersistenceUnit(String auditPersistenceUnit) {
        DeploymentDescriptorImpl.this.auditPersistenceUnit = auditPersistenceUnit;
    }

    public void setAuditMode(AuditMode auditMode) {
        DeploymentDescriptorImpl.this.auditMode = auditMode;
    }

    public void setPersistenceMode(PersistenceMode persistenceMode) {
        DeploymentDescriptorImpl.this.persistenceMode = persistenceMode;
    }

    public void setRuntimeStrategy(RuntimeStrategy runtimeStrategy) {
        DeploymentDescriptorImpl.this.runtimeStrategy = runtimeStrategy;
    }

    public void setMarshallingStrategies(List<ObjectModel> marshallingStrategies) {
        if (marshallingStrategies != null) {
            DeploymentDescriptorImpl.this.marshallingStrategies = new HashSet<ObjectModel>(marshallingStrategies);
        } 
    }

    public void setEventListeners(List<ObjectModel> eventListeners) {
        if (eventListeners != null) {
            DeploymentDescriptorImpl.this.eventListeners = new HashSet<ObjectModel>(eventListeners);
        } 
    }

    public void setTaskEventListeners(List<ObjectModel> taskEventListeners) {
        if (taskEventListeners != null) {
            DeploymentDescriptorImpl.this.taskEventListeners = new HashSet<ObjectModel>(taskEventListeners);
        } 
    }

    public void setGlobals(List<NamedObjectModel> globals) {
        if (globals != null) {
            DeploymentDescriptorImpl.this.globals = new HashSet<NamedObjectModel>(globals);
        } 
    }

    public void setWorkItemHandlers(List<NamedObjectModel> workItemHandlers) {
        if (workItemHandlers != null) {
            DeploymentDescriptorImpl.this.workItemHandlers = new HashSet<NamedObjectModel>(workItemHandlers);
        } 
    }

    public void setEnvironmentEntries(List<NamedObjectModel> environmentEntires) {
        if (environmentEntires != null) {
            DeploymentDescriptorImpl.this.environmentEntries = new HashSet<NamedObjectModel>(environmentEntires);
        } 
    }

    public void setConfiguration(List<NamedObjectModel> configuration) {
        if (configuration != null) {
            DeploymentDescriptorImpl.this.configuration = new HashSet<NamedObjectModel>(configuration);
        } 
    }

    public void setRequiredRoles(List<String> requiredRoles) {
        if (requiredRoles != null) {
            DeploymentDescriptorImpl.this.requiredRoles = new HashSet<String>(requiredRoles);
        } 
    }

    public void setClasses(List<String> classes) {
        if (classes != null) {
            DeploymentDescriptorImpl.this.classes = new ArrayList<String>(classes);
        } 
    }
    ...
    public void setLimitSerializationClasses(Boolean limitSerializationClasses) {
        DeploymentDescriptorImpl.this.limitSerializationClasses = limitSerializationClasses;
    }
    ...
    @Override
    public String toXml() {
        return DeploymentDescriptorIO.toXml(DeploymentDescriptorImpl.this);
    }
}
