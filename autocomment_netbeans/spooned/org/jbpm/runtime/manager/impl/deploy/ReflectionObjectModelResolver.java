        ...
        if (((model.getParameters()) == null) || (model.getParameters().isEmpty())) {
            ...
            for (Object param : model.getParameters()) {
                if (param instanceof ObjectModel) {
                    ReflectionObjectModelResolver.logger.debug("Parameter is of type ObjectModel (id: {}), trying to create instance based on that model", ((ObjectModel) (param)).getIdentifier());
            ...
            try {
                ReflectionObjectModelResolver.logger.debug("Creating instance of class {} with parameter types {} and parameter instances {}", clazz, parameterTypes, paramInstances);
