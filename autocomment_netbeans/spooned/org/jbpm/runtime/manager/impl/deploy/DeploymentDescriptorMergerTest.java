...
public class DeploymentDescriptorMergerTest {
    ...
    public void testDeploymentDesciptorMergeOverrideAll() {
        ...
        master.getBuilder().addMarshalingStrategy(new org.kie.internal.runtime.conf.ObjectModel("org.jbpm.test.CustomStrategy", new Object[]{ "param2" })).setLimitSerializationClasses(true);
    ...
    public void testDeploymentDesciptorMergeMergeCollections() {
        ...
        assertTrue(master.getLimitSerializationClasses());
        DeploymentDescriptor slave = new DeploymentDescriptorImpl("org.jbpm.domain");
        slave.getBuilder().auditMode(AuditMode.JMS).persistenceMode(PersistenceMode.JPA).persistenceUnit(null).auditPersistenceUnit("").addMarshalingStrategy(new org.kie.internal.runtime.conf.ObjectModel("org.jbpm.test.AnotherCustomStrategy", new Object[]{ "param2" })).setLimitSerializationClasses(false);
        assertNotNull(slave);
        assertEquals(null, slave.getPersistenceUnit());
        assertEquals("", slave.getAuditPersistenceUnit());
        assertEquals(AuditMode.JMS, slave.getAuditMode());
    ...
    public void testDeploymentDesciptorMergeHierarchy() {
        DeploymentDescriptor master = new DeploymentDescriptorImpl("org.jbpm.domain");
        master.getBuilder().addMarshalingStrategy(new org.kie.internal.runtime.conf.ObjectModel("org.jbpm.test.CustomStrategy", new Object[]{ "param2" }));
        assertNotNull(master);
        assertEquals("org.jbpm.domain", master.getPersistenceUnit());
        assertEquals("org.jbpm.domain", master.getAuditPersistenceUnit());
        assertEquals(AuditMode.JPA, master.getAuditMode());
    ...
    public void testDeploymentDesciptorMergeMergeCollectionsAvoidDuplicates() {
        ...
        assertEquals(0, master.getWorkItemHandlers().size());
        DeploymentDescriptor slave = new DeploymentDescriptorImpl("org.jbpm.domain");
        slave.getBuilder().auditMode(AuditMode.JMS).persistenceMode(PersistenceMode.JPA).persistenceUnit(null).auditPersistenceUnit("").addMarshalingStrategy(new org.kie.internal.runtime.conf.ObjectModel("org.jbpm.test.CustomStrategy", new Object[]{ "param2" }));
        assertNotNull(slave);
        assertEquals(null, slave.getPersistenceUnit());
        assertEquals("", slave.getAuditPersistenceUnit());
        assertEquals(AuditMode.JMS, slave.getAuditMode());
    ...
    private static final Pattern jarLocRegex = Pattern.compile(DeploymentDescriptorMergerTest.jarLocRegexStr);
    ...
    public void changeDefaultLimitSerializationClassesValueToTrueIn7x() throws Exception {
        ...
        InputStream testPropsStream = DeploymentDescriptorMergerTest.this.getClass().getResourceAsStream(("/" + testPropsFileName));
        ...
        Matcher matcher = DeploymentDescriptorMergerTest.jarLocRegex.matcher(projectVersionStr);
        assertTrue(("Fix regular expression: " + (DeploymentDescriptorMergerTest.jarLocRegexStr)), matcher.matches());
        double jarVersion = Double.parseDouble(matcher.group(1));
        DeploymentDescriptorImpl depDesc = new DeploymentDescriptorImpl();
        assertTrue("The default value of 'limitSerializationClasses is FALSE in 6.x and TRUE in 7.x", (((jarVersion < 7.0) && (!(depDesc.getLimitSerializationClasses()))) || ((jarVersion >= 7.0) && (depDesc.getLimitSerializationClasses()))));
    }
}
