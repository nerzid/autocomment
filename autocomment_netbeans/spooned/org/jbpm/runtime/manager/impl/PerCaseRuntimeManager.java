...
public class PerCaseRuntimeManager extends AbstractRuntimeManager {
    ...
    public PerCaseRuntimeManager(RuntimeEnvironment environment, SessionFactory factory, TaskServiceFactory taskServiceFactory, String identifier) {
        ...
        PerCaseRuntimeManager.this.factory = factory;
        PerCaseRuntimeManager.this.taskServiceFactory = taskServiceFactory;
        PerCaseRuntimeManager.this.mapper = ((org.kie.internal.runtime.manager.RuntimeEnvironment) (environment)).getMapper();
        PerCaseRuntimeManager.this.registry.register(PerCaseRuntimeManager.this);
    }
    ...
    public RuntimeEngine getRuntimeEngine(org.jbpm.runtime.manager.impl.Context<?> context) {
        ...
        if (!((context instanceof ProcessInstanceIdContext) || (context instanceof CaseContext))) {
            PerCaseRuntimeManager.logger.warn("ProcessInstanceIdContext or CaseContext shall be used when interacting with PerCase runtime manager");
        } 
        if (engineInitEager) {
            ...
            synchronized(PerCaseRuntimeManager.this) {
                ksessionId = mapper.findMapping(context, PerCaseRuntimeManager.this.identifier);
                if (ksessionId == null) {
                    ksession = factory.newKieSession();
                    ksessionId = ksession.getIdentifier();
                    if (context instanceof CaseContext) {
                        ksession.execute(new PerCaseRuntimeManager.SaveMappingCommand(mapper, context, ksessionId, getIdentifier()));
                    } 
                } else {
            ...
            ((RuntimeEngineImpl) (runtime)).setManager(PerCaseRuntimeManager.this);
            ((RuntimeEngineImpl) (runtime)).setContext(context);
            configureRuntimeOnTaskService(internalTaskService, runtime);
            registerDisposeCallback(runtime, new org.jbpm.runtime.manager.impl.tx.DisposeSessionTransactionSynchronization(PerCaseRuntimeManager.this, runtime));
            registerItems(runtime);
            attachManager(runtime);
            ksession.addEventListener(new PerCaseRuntimeManager.MaintainMappingListener(ksessionId, runtime, PerCaseRuntimeManager.this.identifier, ((String) (contextId))));
            if (context instanceof CaseContext) {
                ksession.getEnvironment().set("CaseId", context.getContextId());
            } else {
                Object contexts = mapper.findContextId(ksession.getIdentifier(), PerCaseRuntimeManager.this.identifier);
            ...
            runtime = new RuntimeEngineImpl(context, new PerCaseRuntimeManager.PerCaseInitializer());
            ((RuntimeEngineImpl) (runtime)).setManager(PerCaseRuntimeManager.this);
        }
        String caseId = null;
        ...
        Long ksessionId = mapper.findMapping(context, PerCaseRuntimeManager.this.identifier);
    ...
    public void signalEvent(String type, Object event) {
        ...
        Map<Object, RuntimeEngine> currentlyActive = PerCaseRuntimeManager.local.get();
    ...
    public boolean validate(Long ksessionId, Long processInstanceId) {
        Long mapped = PerCaseRuntimeManager.this.mapper.findMapping(ProcessInstanceIdContext.get(processInstanceId), PerCaseRuntimeManager.this.identifier);
    ...
    private class MaintainMappingListener extends DefaultProcessEventListener {
        ...
        MaintainMappingListener(Long ksessionId, RuntimeEngine runtime, String managerId, String caseId) {
            PerCaseRuntimeManager.MaintainMappingListener.this.ksessionId = ksessionId;
            PerCaseRuntimeManager.MaintainMappingListener.this.runtime = runtime;
            PerCaseRuntimeManager.MaintainMappingListener.this.managerId = managerId;
            PerCaseRuntimeManager.MaintainMappingListener.this.caseId = caseId;
        }
    ...
    public void setMapper(Mapper mapper) {
        PerCaseRuntimeManager.this.mapper = mapper;
    }
    ...
    protected RuntimeEngine findLocalRuntime(Object caseId) {
        ...
        Map<Object, RuntimeEngine> map = PerCaseRuntimeManager.local.get();
        if (map == null) {
            return null;
        } else {
    ...
    protected void saveLocalRuntime(Object caseId, Object processInstanceId, RuntimeEngine runtime) {
        ...
        if (map == null) {
            ...
            PerCaseRuntimeManager.local.set(map);
        } 
        if (caseId != null) {
    ...
    public void init() {
        ...
        try {
            ...
            initialKsession.execute(new PerCaseRuntimeManager.DestroyKSessionCommand(initialKsession, PerCaseRuntimeManager.this));
            if (!("false".equalsIgnoreCase(System.getProperty("org.jbpm.rm.init.timer")))) {
                if ((mapper) instanceof JPAMapper) {
                    List<Long> ksessionsToInit = ((JPAMapper) (mapper)).findKSessionToInit(PerCaseRuntimeManager.this.identifier);
                    for (Long id : ksessionsToInit) {
                        initialKsession = factory.findKieSessionById(id);
                        initialKsession.execute(new PerCaseRuntimeManager.DisposeKSessionCommand(initialKsession, PerCaseRuntimeManager.this));
                    }
                } 
            } 
            if (tm != null) {
            ...
            throw new RuntimeException(("Exception while initializing runtime manager " + (PerCaseRuntimeManager.this.identifier)), e);
        }
    }
    ...
    public void destroyCase(CaseContext caseContext) {
        ...
        if (localRuntime != null) {
            ...
            Long ksessionId = mapper.findMapping(caseContext, PerCaseRuntimeManager.this.identifier);
            if (ksessionId != null) {
                kieSession = factory.findKieSessionById(ksessionId);
            } 
        }
        List<GenericCommand<?>> cmds = new ArrayList<>();
        PerCaseRuntimeManager.RemoveMappingCommand removeMapping = new PerCaseRuntimeManager.RemoveMappingCommand(mapper, caseContext, getIdentifier());
        cmds.add(removeMapping);
        PerCaseRuntimeManager.DestroyKSessionCommand destroy = new PerCaseRuntimeManager.DestroyKSessionCommand(kieSession, PerCaseRuntimeManager.this);
        cmds.add(destroy);
        BatchExecutionCommand batchCmd = new org.drools.core.command.runtime.BatchExecutionCommandImpl(cmds);
    ...
    public void setCaseEventSupport(AbstractEventSupport<? extends EventListener> caseEventSupport) {
        PerCaseRuntimeManager.this.caseEventSupport = caseEventSupport;
    }
    ...
    private static class DestroyKSessionCommand implements GenericCommand<Void> {
        ...
        public DestroyKSessionCommand(KieSession initialKsession, AbstractRuntimeManager manager) {
            PerCaseRuntimeManager.DestroyKSessionCommand.this.initialKsession = initialKsession;
            PerCaseRuntimeManager.DestroyKSessionCommand.this.manager = manager;
        }
    ...
    private static class DisposeKSessionCommand implements GenericCommand<Void> {
        ...
        public DisposeKSessionCommand(KieSession initialKsession, AbstractRuntimeManager manager) {
            PerCaseRuntimeManager.DisposeKSessionCommand.this.initialKsession = initialKsession;
            PerCaseRuntimeManager.DisposeKSessionCommand.this.manager = manager;
        }
    ...
    private static class SaveMappingCommand implements GenericCommand<Void> {
        ...
        private org.jbpm.runtime.manager.impl.Context<?> caseContext;

        private Long ksessionId;

        private String ownerId;

        public SaveMappingCommand(Mapper mapper, org.jbpm.runtime.manager.impl.Context<?> caseContext, Long ksessionId, String ownerId) {
            PerCaseRuntimeManager.SaveMappingCommand.this.mapper = mapper;
            PerCaseRuntimeManager.SaveMappingCommand.this.caseContext = caseContext;
            PerCaseRuntimeManager.SaveMappingCommand.this.ksessionId = ksessionId;
            PerCaseRuntimeManager.SaveMappingCommand.this.ownerId = ownerId;
        }
    ...
    private static class RemoveMappingCommand implements GenericCommand<Void> {
        ...
        public RemoveMappingCommand(Mapper mapper, org.jbpm.runtime.manager.impl.Context<?> caseContext, String ownerId) {
            PerCaseRuntimeManager.RemoveMappingCommand.this.mapper = mapper;
            PerCaseRuntimeManager.RemoveMappingCommand.this.caseContext = caseContext;
            PerCaseRuntimeManager.RemoveMappingCommand.this.ownerId = ownerId;
        }
        ...
        public KieSession initKieSession(org.jbpm.runtime.manager.impl.Context<?> context, InternalRuntimeManager manager, RuntimeEngine engine) {
            ...
            synchronized(manager) {
                ...
                if (ksessionId == null) {
                    ...
                    ksessionId = ksession.getIdentifier();
                    if (context instanceof CaseContext) {
                        ksession.execute(new PerCaseRuntimeManager.SaveMappingCommand(mapper, context, ksessionId, manager.getIdentifier()));
                    } 
                } else {
                    ksession = factory.findKieSessionById(ksessionId);
                }
            ...
            ksession.addEventListener(new PerCaseRuntimeManager.MaintainMappingListener(ksessionId, engine, manager.getIdentifier(), contextId.toString()));
            if (context instanceof CaseContext) {
                ksession.getEnvironment().set("CaseId", context.getContextId());
            } else {
