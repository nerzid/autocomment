...
public class GenerateDeployemntDescriptorSchema {
    public static void main(String[] args) throws Exception {
        ...
        SchemaOutputResolver sor = new GenerateDeployemntDescriptorSchema.FileSchemaOutputResolver();
        // generate schema SchemaOutputResolver{sor} to JAXBContext{jaxbContext}
    ...
    private static class FileSchemaOutputResolver extends SchemaOutputResolver {
        public Result createOutput(String namespaceURI, String suggestedFileName) throws IOException {
            ...
            // set system String{file.toURI().toURL().toString()} to StreamResult{result}
