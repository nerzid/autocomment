...
public class BPMN2DataServiceImplMultiThreadTest extends AbstractKieServicesBaseTest {
    ...
    public void testBuildProcessDefinitionConcurrent() throws Exception {
        ...
        byte[] process1 = IoUtils.readBytesFromInputStream(BPMN2DataServiceImplMultiThreadTest.this.getClass().getResourceAsStream("/repo/processes/general/customtask.bpmn"));
        byte[] process2 = IoUtils.readBytesFromInputStream(BPMN2DataServiceImplMultiThreadTest.this.getClass().getResourceAsStream("/repo/processes/general/humanTask.bpmn"));
