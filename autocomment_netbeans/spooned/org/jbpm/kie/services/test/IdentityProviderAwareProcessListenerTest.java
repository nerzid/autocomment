...
public class IdentityProviderAwareProcessListenerTest extends AbstractKieServicesBaseTest {
    ...
    public void init() {
        ...
        final DeploymentDescriptor descriptor = new org.jbpm.runtime.manager.impl.deploy.DeploymentDescriptorImpl();
        descriptor.getBuilder().addEventListener(new org.kie.internal.runtime.conf.NamedObjectModel("mvel", "processIdentity", "new org.jbpm.kie.services.impl.IdentityProviderAwareProcessListener(ksession)"));
        ...
        Collection<ProcessDefinition> processDefinitions = runtimeDataService.getProcesses(new org.kie.api.runtime.query.QueryContext());
