...
public class RuntimeDataServiceImplTest extends AbstractKieServicesBaseTest {
    ...
    public void prepare() {
        configureServices();
        RuntimeDataServiceImplTest.logger.debug("Preparing kjar");
    ...
    public void testGetProcessesByDeploymentId() {
        ...
        definitions = runtimeDataService.getProcessesByDeploymentId(deploymentUnit.getIdentifier(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(definitions);
        Assert.assertEquals(5, definitions.size());
    ...
    public void testGetProcessesByDeploymentIdNull() {
        runtimeDataService.getProcessesByDeploymentId(null, new org.kie.api.runtime.query.QueryContext());
    }
    ...
    public void testGetProcessIds() {
        ...
        Assert.assertTrue(definitions.contains("UserTask"));
        Assert.assertTrue(definitions.contains("org.jboss.qa.bpms.HumanTask"));
        Assert.assertTrue(definitions.contains("AdHocSubProcess"));
        String origVer = deploymentUnit.getVersion();
        deploymentUnit.setVersion("LATEST");
        definitions = runtimeDataService.getProcessIds(deploymentUnit.getIdentifier(), new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(definitions);
        Assert.assertEquals(5, definitions.size());
        Assert.assertTrue(definitions.contains("org.jbpm.writedocument.empty"));
        Assert.assertTrue(definitions.contains("AdHocSubProcess"));
    ...
    public void testGetProcessIdsNull() {
        runtimeDataService.getProcessIds(null, new org.kie.api.runtime.query.QueryContext());
    }

    @Test
    public void testGetProcessesSortByProcessName() {
        Collection<ProcessDefinition> definitions = runtimeDataService.getProcesses(new org.kie.api.runtime.query.QueryContext("ProcessName", true));
        Assert.assertNotNull(definitions);
        Assert.assertEquals(5, definitions.size());
        List<String> expectedProcessIds = new ArrayList<String>();
        ...
        int index = 0;
        for (ProcessDefinition def : definitions) {
            Assert.assertEquals(def.getName(), expectedProcessIds.get(index));
            index++;
        }
    }
    ...
    public void testGetProcessesSortByProcessVersion() {
        Collection<ProcessDefinition> definitions = runtimeDataService.getProcesses(new org.kie.api.runtime.query.QueryContext("ProcessVersion", true));
        Assert.assertNotNull(definitions);
        Assert.assertEquals(5, definitions.size());
        List<String> expectedProcessIds = new ArrayList<String>();
        expectedProcessIds.add("UserTask");
        ...
        int index = 0;
        for (ProcessDefinition def : definitions) {
            Assert.assertEquals(def.getId(), expectedProcessIds.get(index));
            index++;
        }
    }
    ...
    public void testGetProcessInstances() {
        ...
        instances = runtimeDataService.getProcessInstances(new org.kie.api.runtime.query.QueryContext("log.processName", false));
        Assert.assertNotNull(instances);
        Assert.assertEquals(1, instances.size());
    ...
    public void testGetProcessInstancesByDeploymentIdNull() {
        runtimeDataService.getProcessInstancesByDeploymentId(null, Collections.<Integer>emptyList(), new org.kie.api.runtime.query.QueryContext());
    }
    ...
    public void testGetProcessInstancesByProcessNameAndStateAndInitiator() {
        ...
        // search for active only
        states.add(1);
        instances = runtimeDataService.getProcessInstancesByProcessName(states, "humanTaskSample", correctUser, new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(instances);
        Assert.assertEquals(1, instances.size());
        Assert.assertEquals(1, ((int) (instances.iterator().next().getState())));
    ...
    private void compareTaskSummaryLists(List<TaskSummary> queryBuilderList, List<TaskSummary> normalMethodList) {
        Assert.assertNotNull("Null normal method list", normalMethodList);
        Assert.assertEquals("TaskSummary list size: ", queryBuilderList.size(), normalMethodList.size());
        ...
        for (TaskSummary queryTaskSum : queryBuilderList) {
            Assert.assertTrue((("TaskSummary " + (queryTaskSum.getId())) + " not found in normal method list"), normalTaskSumIds.remove(queryTaskSum.getId()));
        }
        StringBuffer extraNormalTaskSumids = new StringBuffer();
        for (Long id : normalTaskSumIds) {
            extraNormalTaskSumids.append(id).append(",");
        }
        Assert.assertTrue(("Task ids not found in query builder list: " + extraNormalTaskSumids), normalTaskSumIds.isEmpty());
    }
    ...
    public void testGetTasksByVariableWithTaskQueryBuilder() {
        ...
        List<TaskSummary> tasksByVariable = runtimeDataService.taskSummaryQuery(userId).variableName(varName).build().getResultList();
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(1, tasksByVariable.size());
        compareTaskSummaryLists(tasksByVariable, runtimeDataService.getTasksByVariable(userId, varName, statuses, new org.kie.api.runtime.query.QueryContext()));
        processService.abortProcessInstance(processInstanceId);
        processInstanceId = null;
    }
    ...
    public void testGetTasksByVariableAndValueWithTaskQueryBuilder() {
        ...
        List<TaskSummary> tasksByVariable = runtimeDataService.taskSummaryQuery(userId).variableName(varName).and().variableValue(varValue).build().getResultList();
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(1, tasksByVariable.size());
        compareTaskSummaryLists(tasksByVariable, runtimeDataService.getTasksByVariableAndValue(userId, varName, varValue, statuses, new org.kie.api.runtime.query.QueryContext()));
        varValue = "Write";
        tasksByVariable = runtimeDataService.taskSummaryQuery(userId).variableName(varName).and().variableValue(varValue).build().getResultList();
        Assert.assertNotNull(tasksByVariable);
    ...
    public void testGetTasksByVariable() {
        ...
        String userId = "salaboy";
        String varName = "Comment";
        List<TaskSummary> tasksByVariable = runtimeDataService.getTasksByVariable(userId, varName, statuses, new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(1, tasksByVariable.size());
        varName = "ReviewComment";
        tasksByVariable = runtimeDataService.getTasksByVariable(userId, varName, statuses, new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(0, tasksByVariable.size());
        long taskId = tasks.get(0).getId();
    ...
    public void testGetTasksByVariableAndValue() {
        ...
        String varName = "Comment";
        String varValue = "Write a Document";
        List<TaskSummary> tasksByVariable = runtimeDataService.getTasksByVariableAndValue(userId, varName, varValue, statuses, new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(1, tasksByVariable.size());
        varValue = "Write";
        tasksByVariable = runtimeDataService.getTasksByVariableAndValue(userId, varName, varValue, statuses, new org.kie.api.runtime.query.QueryContext());
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(0, tasksByVariable.size());
        long taskId = tasks.get(0).getId();
        Map<String, Object> output = new HashMap<String, Object>();
    ...
    public void testGetTasksByVariableAndValueSorted() {
        ...
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(2, tasksByVariable.size());
        Assert.assertEquals(processInstanceId, tasksByVariable.get(0).getProcessInstanceId());
        Assert.assertEquals(processInstanceId2, tasksByVariable.get(1).getProcessInstanceId());
        ...
        Assert.assertNotNull(tasksByVariable);
        Assert.assertEquals(2, tasksByVariable.size());
        Assert.assertEquals(processInstanceId2, tasksByVariable.get(0).getProcessInstanceId());
        Assert.assertEquals(processInstanceId, tasksByVariable.get(1).getProcessInstanceId());
        processService.abortProcessInstance(processInstanceId);
        processInstanceId = null;
