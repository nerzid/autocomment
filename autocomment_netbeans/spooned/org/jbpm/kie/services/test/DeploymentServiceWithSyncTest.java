...
public class DeploymentServiceWithSyncTest extends AbstractKieServicesBaseTest {
    ...
    public void setCommandService(TransactionalCommandService commandService) {
        DeploymentServiceWithSyncTest.this.commandService = commandService;
    }
    ...
    public void cleanup() {
        ...
        int deleted = 0;
        deleted += commandService.execute(new org.jbpm.shared.services.impl.commands.UpdateStringCommand("delete from  DeploymentStoreEntry dse"));
        DeploymentServiceWithSyncTest.logger.info(("Deleted " + deleted));
