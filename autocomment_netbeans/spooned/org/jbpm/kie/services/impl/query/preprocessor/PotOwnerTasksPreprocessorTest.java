...
public class PotOwnerTasksPreprocessorTest {
    ...
    public void testSetUser() {
        ...
        assertEquals((((((("(((ID = " + role1) + ", ") + role2) + " AND (ACTUALOWNER =  OR ACTUALOWNER is_null )) OR ACTUALOWNER = ") + userId) + "))"), dataSetLookup.getFirstFilterOp().getColumnFilterList().get(0).toString());
    }
}
