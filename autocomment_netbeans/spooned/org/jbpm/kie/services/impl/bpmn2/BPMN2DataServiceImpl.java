...
public class BPMN2DataServiceImpl implements DefinitionService , DeploymentEventListener {
    ...
    public ProcessDefinition buildProcessDefinition(String deploymentId, String bpmn2Content, KieContainer kieContainer, boolean cache) throws IllegalArgumentException {
        ...
        kbuilder.add(new org.drools.core.io.impl.ByteArrayResource(bpmn2Content.getBytes()), ResourceType.BPMN2);
        if (kbuilder.hasErrors()) {
            for (KnowledgeBuilderError error : kbuilder.getErrors()) {
                BPMN2DataServiceImpl.logger.error("Error: {}", error.getMessage());
            }
            BPMN2DataServiceImpl.logger.debug("Process Cannot be Parsed! \n {} \n", bpmn2Content);
            return null;
        } 
