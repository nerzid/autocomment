...
public class ProcessServiceImpl implements VariablesAware , ProcessService {
    ...
    public void setDeploymentService(DeploymentService deploymentService) {
        ProcessServiceImpl.this.deploymentService = deploymentService;
    }

    public void setDataService(RuntimeDataService dataService) {
        ProcessServiceImpl.this.dataService = dataService;
    }
    ...
    public void abortProcessInstance(Long processInstanceId) {
        ...
        if (piDesc == null) {
            throw new org.jbpm.services.api.ProcessInstanceNotFoundException((("Process instance with id " + processInstanceId) + " was not found"));
        } 
        DeployedUnit deployedUnit = deploymentService.getDeployedUnit(piDesc.getDeploymentId());
        if (deployedUnit == null) {
            throw new org.jbpm.services.api.DeploymentNotFoundException(("No deployments available for " + (piDesc.getDeploymentId())));
        } 
        RuntimeManager manager = deployedUnit.getRuntimeManager();
    ...
    public void signalEvent(String deployment, String signalName, Object event) {
        ...
        if (deployedUnit == null) {
            throw new org.jbpm.services.api.DeploymentNotFoundException(("No deployments available for " + deployment));
        } 
        RuntimeManager manager = deployedUnit.getRuntimeManager();
        event = process(event, ((InternalRuntimeManager) (manager)).getEnvironment().getClassLoader());
    ...
    public void setProcessVariable(Long processInstanceId, String variableId, Object value) {
        ...
        KieSession ksession = engine.getKieSession();
        try {
            ksession.execute(new org.drools.core.command.runtime.process.SetProcessInstanceVariablesCommand(processInstanceId, Collections.singletonMap(variableId, value)));
        } finally {
            disposeRuntimeEngine(manager, engine);
        }
    }
    ...
    public void setProcessVariables(Long processInstanceId, Map<String, Object> variables) {
        ...
        KieSession ksession = engine.getKieSession();
        try {
            ksession.execute(new org.drools.core.command.runtime.process.SetProcessInstanceVariablesCommand(processInstanceId, variables));
        } finally {
            disposeRuntimeEngine(manager, engine);
        }
    }
    ...
    public Object getProcessInstanceVariable(Long processInstanceId, String variableName) {
        ...
        try {
            Object variable = ksession.execute(new GenericCommand<Object>() {
                ...
                @Override
                public Object execute(org.kie.api.runtime.manager.Context context) {
    ...
    public void completeWorkItem(Long id, Map<String, Object> results) {
        ...
        if (nodeDesc == null) {
            throw new org.jbpm.services.api.WorkItemNotFoundException((("Work item with id " + id) + " was not found"));
        } 
        DeployedUnit deployedUnit = deploymentService.getDeployedUnit(nodeDesc.getDeploymentId());
        if (deployedUnit == null) {
            throw new org.jbpm.services.api.DeploymentNotFoundException(("No deployments available for " + (nodeDesc.getDeploymentId())));
        } 
        RuntimeManager manager = deployedUnit.getRuntimeManager();
    ...
    protected void disallowWhenNotActive(DeployedUnit deployedUnit, Command<?> cmd) {
        if ((!(deployedUnit.isActive())) && (cmd instanceof StartProcessCommand)) {
            throw new org.jbpm.services.api.DeploymentNotFoundException((("Deployments " + (deployedUnit.getDeploymentUnit().getIdentifier())) + " is not active"));
        } 
    }
