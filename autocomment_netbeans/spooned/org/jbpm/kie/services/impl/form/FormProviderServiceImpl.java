...
public class FormProviderServiceImpl implements FormProviderService {
    ...
    public void setTaskService(TaskService taskService) {
        FormProviderServiceImpl.this.taskService = taskService;
    }

    public void setBpmn2Service(DefinitionService bpmn2Service) {
        FormProviderServiceImpl.this.bpmn2Service = bpmn2Service;
    }

    public void setDataService(RuntimeDataService dataService) {
        FormProviderServiceImpl.this.dataService = dataService;
    }

    public void setDeploymentService(DeploymentService deploymentService) {
        FormProviderServiceImpl.this.deploymentService = deploymentService;
    }

    public void setProviders(Set<FormProvider> providers) {
        FormProviderServiceImpl.this.providers = providers;
    }
