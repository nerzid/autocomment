...
public class FormProviderServiceImpl implements FormProviderService {
    ...
    public String getFormDisplayProcess(String deploymentId, String processId) {
        ...
        // put String{"process"} to Map{renderContext}
        renderContext.put("process", processDesc);
        // put String{"outputs"} to Map{renderContext}
        renderContext.put("outputs", processData);
        // put String{"marshallerContext"} to Map{renderContext}
        ...
        // warn String{"Unable to find form to render for process '{}'"} to Logger{FormProviderServiceImpl.logger}
        FormProviderServiceImpl.logger.warn("Unable to find form to render for process '{}'", processDesc.getName());
        return "";
    }
    ...
    public String getFormDisplayTask(long taskId) {
        ...
        // put String{"task"} to Map{renderContext}
        ...
        // warn String{"Unable to find form to render for task '{}' on process '{}'"} to Logger{FormProviderServiceImpl.logger}
        FormProviderServiceImpl.logger.warn("Unable to find form to render for task '{}' on process '{}'", name, (processDesc == null ? "" : processDesc.getName()));
        return "";
    }
