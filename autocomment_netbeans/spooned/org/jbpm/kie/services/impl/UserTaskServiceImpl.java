...
public class UserTaskServiceImpl implements VariablesAware , UserTaskService {
    ...
    public void setDeploymentService(DeploymentService deploymentService) {
        UserTaskServiceImpl.this.deploymentService = deploymentService;
    }

    public void setDataService(RuntimeDataService dataService) {
        UserTaskServiceImpl.this.dataService = dataService;
    }

    public void setNonProcessScopedTaskService(InternalTaskService nonProcessScopedTaskService) {
        UserTaskServiceImpl.this.nonProcessScopedTaskService = nonProcessScopedTaskService;
    }

    protected InternalTaskService getInternalTaskService() {
        return UserTaskServiceImpl.this.nonProcessScopedTaskService;
    }
    ...
    public void activate(Long taskId, String userId) {
        UserTaskInstanceDesc task = dataService.getTaskById(taskId);
        if (task == null) {
            throw new org.jbpm.services.api.TaskNotFoundException((("Task with id " + taskId) + " was not found"));
        } 
    ...
    public Long addAttachment(Long taskId, String userId, String name, Object attachment) {
        ...
        try {
            ...
            return ((InternalTaskService) (taskService)).execute(new org.jbpm.services.task.commands.AddAttachmentCommand(taskId, att, attachment));
        } finally {
            disposeRuntimeEngine(manager, engine);
        }
    }
    ...
    private class FalbackRuntimeManager implements RuntimeManager {
        ...
        public FalbackRuntimeManager(InternalTaskService taskService) {
            UserTaskServiceImpl.FalbackRuntimeManager.this.taskService = taskService;
        }
