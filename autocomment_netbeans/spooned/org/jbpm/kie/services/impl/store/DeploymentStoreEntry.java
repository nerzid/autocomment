...
@SequenceGenerator(allocationSize = 1, name = "deploymentStoreIdSeq", sequenceName = "DEPLOY_STORE_ID_SEQ")
public class DeploymentStoreEntry implements Serializable {
    private static final long serialVersionUID = 6669858787722894023L;

    @Id
    @GeneratedValue(generator = "deploymentStoreIdSeq", strategy = GenerationType.AUTO)
    @Column(name = "id")
    private Long id;
    ...
    public int hashCode() {
        ...
        result = (prime * result) + ((deploymentUnit) == null ? 0 : deploymentUnit.hashCode());
    ...
    public String toString() {
        return ((((((("DeploymentStoreEntry [id=" + (id)) + ", deploymentId=") + (deploymentId)) + ", state=") + (state)) + ", updateDate=") + (updateDate)) + "]";
    }
}
