...
public class CleanUpCommand extends TaskCommand<Void> {
    ...
    public Void execute(Context context) {
        ...
        // execute update String{"delete from  NodeInstanceLog nid"} to TaskPersistenceContext{persistenceContext}
        persistenceContext.executeUpdateString("delete from  NodeInstanceLog nid");
        // execute update String{"delete from  ProcessInstanceLog pid"} to TaskPersistenceContext{persistenceContext}
        persistenceContext.executeUpdateString("delete from  ProcessInstanceLog pid");
        // execute update String{"delete from  VariableInstanceLog vsd"} to TaskPersistenceContext{persistenceContext}
        persistenceContext.executeUpdateString("delete from  VariableInstanceLog vsd");
        // execute update String{"delete from  AuditTaskImpl vsd"} to TaskPersistenceContext{persistenceContext}
