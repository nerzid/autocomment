...
public class ProcessForEachTest extends AbstractBaseTest {
    ...
    public void testForEachLargeList() {
        ...
        ProcessInstance processInstance = ((ProcessInstance) (workingMemory.startProcess("org.drools.ForEach", params)));
        Assert.assertEquals(ProcessInstance.STATE_COMPLETED, processInstance.getState());
        Assert.assertEquals(10000, myList.size());
    }
    ...
    public void testForEachCancel() {
        ...
        Assert.assertEquals(4, workingMemory.getProcessInstances().size());
    ...
    public void testForEachCancelIndependent() {
        ...
        Assert.assertEquals(4, workingMemory.getProcessInstances().size());
        processInstance.setState(ProcessInstance.STATE_ABORTED);
        Assert.assertEquals(3, workingMemory.getProcessInstances().size());
    }
