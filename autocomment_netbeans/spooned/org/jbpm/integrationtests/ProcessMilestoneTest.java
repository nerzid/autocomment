...
public class ProcessMilestoneTest extends AbstractBaseTest {
    ...
    public void testMilestoneWithProcessInstanceConstraint() {
        ...
        for (DroolsError error : builder.getErrors().getErrors()) {
            ProcessMilestoneTest.logger.error(error.toString());
        }
        StatefulKnowledgeSession workingMemory = createKieSession(builder.getPackage());
        ...
        Assert.assertEquals(ProcessInstance.STATE_ACTIVE, processInstanceJohn.getState());
        ...
        Assert.assertEquals(ProcessInstance.STATE_ACTIVE, processInstanceJane.getState());
        workingMemory.insert(jane);
        workingMemory.fireAllRules();
        Assert.assertEquals(ProcessInstance.STATE_ACTIVE, processInstanceJohn.getState());
        Assert.assertEquals(ProcessInstance.STATE_COMPLETED, processInstanceJane.getState());
        workingMemory.insert(john);
        workingMemory.fireAllRules();
        Assert.assertEquals(ProcessInstance.STATE_COMPLETED, processInstanceJohn.getState());
    }
