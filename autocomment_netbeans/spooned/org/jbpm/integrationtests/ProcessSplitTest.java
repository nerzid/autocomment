...
public class ProcessSplitTest extends AbstractBaseTest {
    ...
    public void testSplitWithProcessInstanceConstraint() {
        ...
        Assert.assertEquals(ProcessInstance.STATE_COMPLETED, processInstance1.getState());
        Assert.assertEquals(ProcessInstance.STATE_COMPLETED, processInstance2.getState());
        Assert.assertEquals(ProcessInstance.STATE_COMPLETED, processInstance3.getState());
    ...
    public void testSplitWithProcessInstanceConstraint2() {
        ...
        for (KnowledgeBuilderError error : kbuilder.getErrors()) {
            ProcessSplitTest.logger.error(error.toString());
        }
