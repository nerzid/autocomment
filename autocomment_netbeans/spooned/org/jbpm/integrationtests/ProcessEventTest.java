...
public class ProcessEventTest extends AbstractBaseTest {
    ...
    public void testInternalNodeSignalEvent() {
        ...
        Assert.assertEquals("MyValue", ((VariableScopeInstance) (((org.jbpm.process.instance.ProcessInstance) (processInstance)).getContextInstance(VariableScope.VARIABLE_SCOPE))).getVariable("MyVar"));
    }
    ...
    public void testExternalEventCorrelation() throws Exception {
        ...
        ProcessInstance processInstance = session.startProcess("org.drools.core.event");
        Assert.assertEquals(ProcessInstance.STATE_ACTIVE, processInstance.getState());
        Assert.assertEquals("SomeText", ((VariableScopeInstance) (((org.jbpm.process.instance.ProcessInstance) (processInstance)).getContextInstance(VariableScope.VARIABLE_SCOPE))).getVariable("MyVar"));
        session = JbpmSerializationHelper.getSerialisedStatefulKnowledgeSession(session);
        processInstance = session.getProcessInstance(processInstance.getId());
    ...
    public void testInternalNodeSignalCompositeEvent() {
        ...
        Assert.assertEquals("Process did not complete!", ProcessInstance.STATE_COMPLETED, processInstance.getState());
        Assert.assertEquals("MyValue", ((VariableScopeInstance) (((org.jbpm.process.instance.ProcessInstance) (processInstance)).getContextInstance(VariableScope.VARIABLE_SCOPE))).getVariable("MyVar"));
    }
