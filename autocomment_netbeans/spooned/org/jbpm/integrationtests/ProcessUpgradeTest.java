...
public class ProcessUpgradeTest extends AbstractBaseTest {
    ...
    public void testDefaultUpgrade() throws Exception {
        ...
        builder.add(new org.drools.core.io.impl.ReaderResource(new StringReader(rule)), ResourceType.DRL);
        ...
        builder.add(new org.drools.core.io.impl.ReaderResource(new StringReader(process)), ResourceType.DRF);
        ...
        builder.add(new org.drools.core.io.impl.ReaderResource(new StringReader(process2)), ResourceType.DRF);
        kbase.addKnowledgePackages(builder.getKnowledgePackages());
        WorkflowProcessInstanceUpgrader.upgradeProcessInstance(session, processInstance.getId(), "org.test.ruleflow2", new HashMap<String, Long>());
        Assert.assertEquals("org.test.ruleflow2", processInstance.getProcessId());
    ...
    public void testCompositeMappingUpgrade() throws Exception {
        ...
        rule += "end";
        KnowledgeBuilder builder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        builder.add(new org.drools.core.io.impl.ByteArrayResource(rule.getBytes()), ResourceType.DRL);
