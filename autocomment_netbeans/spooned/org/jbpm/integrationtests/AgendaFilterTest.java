...
public class AgendaFilterTest extends AbstractBaseTest {
    ...
    public void testAgendaFilter() {
        ...
        // go !
        AgendaFilterTest.Message message = new AgendaFilterTest.Message();
        message.setMessage("Hello World");
        message.setStatus(AgendaFilterTest.Message.HELLO);
        ksession.insert(message);
        ksession.startProcess("process-test");
        AgendaFilterTest.SalienceFilter filter = new AgendaFilterTest.SalienceFilter();
    ...
    public static class Message {
        ...
        public String getMessage() {
            return AgendaFilterTest.Message.this.message;
        }

        public void setMessage(String message) {
            AgendaFilterTest.Message.this.message = message;
        }

        public int getStatus() {
            return AgendaFilterTest.Message.this.status;
        }

        public void setStatus(int status) {
            AgendaFilterTest.Message.this.status = status;
        }
    }
    ...
    public static class SalienceFilter implements AgendaFilter {
        ...
        public boolean accept(Match activation) {
            ...
            if (!nocancel) {
                AgendaFilterTest.logger.info("cancelling -> {}", rule.getName());
            } 
            return nocancel;
        }
    }
    ...
    public void testActivationCancelled() {
        ...
        ksession.addEventListener(new org.drools.core.event.DebugProcessEventListener());
        ...
        commands.add(new org.drools.core.command.runtime.rule.FireAllRulesCommand(new AgendaFilterTest.CancelAgendaFilter()));
        commands.add(new org.drools.core.command.runtime.rule.FireAllRulesCommand(new AgendaFilterTest.CancelAgendaFilter()));
        commands.add(new org.drools.core.command.runtime.rule.FireAllRulesCommand(new AgendaFilterTest.CancelAgendaFilter()));
