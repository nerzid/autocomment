...
public class DroolsValidator extends EObjectValidator {
     ...
     * @generated
     */
    protected static final int DIAGNOSTIC_CODE_COUNT = DroolsValidator.GENERATED_DIAGNOSTIC_CODE_COUNT;
    ...
    public boolean validatePriorityType_Min(BigInteger priorityType, DiagnosticChain diagnostics, Map<Object, Object> context) {
        boolean result = (priorityType.compareTo(DroolsValidator.PRIORITY_TYPE__MIN__VALUE)) >= 0;
        if ((!result) && (diagnostics != null))
            reportMinViolation(DroolsPackage.Literals.PRIORITY_TYPE, priorityType, DroolsValidator.PRIORITY_TYPE__MIN__VALUE, true, diagnostics, context);
