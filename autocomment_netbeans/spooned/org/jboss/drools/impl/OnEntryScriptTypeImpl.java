...
public class OnEntryScriptTypeImpl extends EObjectImpl implements OnEntryScriptType {
     ...
     * @ordered
     */
    protected String script = OnEntryScriptTypeImpl.SCRIPT_EDEFAULT;
     ...
     * @ordered
     */
    protected String scriptFormat = OnEntryScriptTypeImpl.SCRIPT_FORMAT_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.ON_ENTRY_SCRIPT_TYPE;
    }
    ...
    public void setScript(String newScript) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(OnEntryScriptTypeImpl.this, Notification.SET, DroolsPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT, oldScript, script));
    ...
    public void setScriptFormat(String newScriptFormat) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(OnEntryScriptTypeImpl.this, Notification.SET, DroolsPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT_FORMAT, oldScriptFormat, scriptFormat));
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            case DroolsPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT :
                setScript(OnEntryScriptTypeImpl.SCRIPT_EDEFAULT);
                return ;
            case DroolsPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT_FORMAT :
                setScriptFormat(OnEntryScriptTypeImpl.SCRIPT_FORMAT_EDEFAULT);
                return ;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case DroolsPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT :
                return (OnEntryScriptTypeImpl.SCRIPT_EDEFAULT) == null ? (script) != null : !(OnEntryScriptTypeImpl.SCRIPT_EDEFAULT.equals(script));
            case DroolsPackage.ON_ENTRY_SCRIPT_TYPE__SCRIPT_FORMAT :
                return (OnEntryScriptTypeImpl.SCRIPT_FORMAT_EDEFAULT) == null ? (scriptFormat) != null : !(OnEntryScriptTypeImpl.SCRIPT_FORMAT_EDEFAULT.equals(scriptFormat));
        }
