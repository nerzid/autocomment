...
public class DroolsPackageImpl extends EPackageImpl implements DroolsPackage {
    ...
    public static DroolsPackage init() {
        if (DroolsPackageImpl.isInited)
            return ((DroolsPackage) (EPackage.Registry.INSTANCE.getEPackage(DroolsPackage.eNS_URI)));
        ...
        DroolsPackageImpl.isInited = true;
        ...
        EValidator.Registry.INSTANCE.put(theDroolsPackage, new EValidator.Descriptor() {
    ...
    public void initializePackageContents() {
        ...
        initEReference(getDocumentRoot_Global(), DroolsPackageImpl.this.getGlobalType(), null, "global", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_Import(), DroolsPackageImpl.this.getImportType(), null, "import", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_MetaData(), DroolsPackageImpl.this.getMetaDataType(), null, "metaData", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_OnEntryScript(), DroolsPackageImpl.this.getOnEntryScriptType(), null, "onEntryScript", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getDocumentRoot_OnExitScript(), DroolsPackageImpl.this.getOnExitScriptType(), null, "onExitScript", null, 0, (-2), null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, (!(IS_RESOLVE_PROXIES)), (!(IS_UNSETTABLE)), IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEAttribute(getDocumentRoot_PackageName(), DroolsPackageImpl.this.getPackageNameType(), "packageName", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEAttribute(getDocumentRoot_Priority(), DroolsPackageImpl.this.getPriorityType(), "priority", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEAttribute(getDocumentRoot_RuleFlowGroup(), DroolsPackageImpl.this.getRuleFlowGroupType(), "ruleFlowGroup", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEAttribute(getDocumentRoot_TaskName(), DroolsPackageImpl.this.getTaskNameType(), "taskName", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEAttribute(getDocumentRoot_Version(), DroolsPackageImpl.this.getVersionType(), "version", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
    ...
    protected void createExtendedMetaDataAnnotations() {
        ...
        addAnnotation(getDocumentRoot_Global(), source, new String[]{ "kind" , "element" , "name" , "global" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_Import(), source, new String[]{ "kind" , "element" , "name" , "import" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_MetaData(), source, new String[]{ "kind" , "element" , "name" , "metaData" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_OnEntryScript(), source, new String[]{ "kind" , "element" , "name" , "onEntry-script" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_OnExitScript(), source, new String[]{ "kind" , "element" , "name" , "onExit-script" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_PackageName(), source, new String[]{ "kind" , "attribute" , "name" , "packageName" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_Priority(), source, new String[]{ "kind" , "attribute" , "name" , "priority" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_RuleFlowGroup(), source, new String[]{ "kind" , "attribute" , "name" , "ruleFlowGroup" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_TaskName(), source, new String[]{ "kind" , "attribute" , "name" , "taskName" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_Version(), source, new String[]{ "kind" , "attribute" , "name" , "version" , "namespace" , "##targetNamespace" });
        addAnnotation(globalTypeEClass, source, new String[]{ "name" , "global_._type" , "kind" , "empty" });
        addAnnotation(getGlobalType_Identifier(), source, new String[]{ "kind" , "attribute" , "name" , "identifier" });
        addAnnotation(getGlobalType_Type(), source, new String[]{ "kind" , "attribute" , "name" , "type" });
        addAnnotation(importTypeEClass, source, new String[]{ "name" , "import_._type" , "kind" , "empty" });
        addAnnotation(getImportType_Name(), source, new String[]{ "kind" , "attribute" , "name" , "name" });
        addAnnotation(metaDataTypeEClass, source, new String[]{ "name" , "metaData_._type" , "kind" , "elementOnly" });
        addAnnotation(getMetaDataType_MetaValue(), source, new String[]{ "kind" , "element" , "name" , "metaValue" , "namespace" , "##targetNamespace" });
        addAnnotation(getMetaDataType_Name(), source, new String[]{ "kind" , "attribute" , "name" , "name" });
        addAnnotation(onEntryScriptTypeEClass, source, new String[]{ "name" , "onEntry-script_._type" , "kind" , "elementOnly" });
        addAnnotation(getOnEntryScriptType_Script(), source, new String[]{ "kind" , "element" , "name" , "script" , "namespace" , "##targetNamespace" });
        addAnnotation(getOnEntryScriptType_ScriptFormat(), source, new String[]{ "kind" , "attribute" , "name" , "scriptFormat" });
        addAnnotation(onExitScriptTypeEClass, source, new String[]{ "name" , "onExit-script_._type" , "kind" , "elementOnly" });
        addAnnotation(getOnExitScriptType_Script(), source, new String[]{ "kind" , "element" , "name" , "script" , "namespace" , "##targetNamespace" });
        addAnnotation(getOnExitScriptType_ScriptFormat(), source, new String[]{ "kind" , "attribute" , "name" , "scriptFormat" });
        addAnnotation(packageNameTypeEDataType, source, new String[]{ "name" , "packageName_._type" , "baseType" , "http://www.eclipse.org/emf/2003/XMLType#string" });
        addAnnotation(priorityTypeEDataType, source, new String[]{ "name" , "priority_._type" , "baseType" , "http://www.eclipse.org/emf/2003/XMLType#integer" , "minInclusive" , "1" });
        addAnnotation(ruleFlowGroupTypeEDataType, source, new String[]{ "name" , "ruleFlowGroup_._type" , "baseType" , "http://www.eclipse.org/emf/2003/XMLType#string" });
        addAnnotation(taskNameTypeEDataType, source, new String[]{ "name" , "taskName_._type" , "baseType" , "http://www.eclipse.org/emf/2003/XMLType#string" });
        addAnnotation(versionTypeEDataType, source, new String[]{ "name" , "version_._type" , "baseType" , "http://www.eclipse.org/emf/2003/XMLType#string" });
    }
}
