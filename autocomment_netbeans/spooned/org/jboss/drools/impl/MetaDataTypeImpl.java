...
public class MetaDataTypeImpl extends EObjectImpl implements MetaDataType {
     ...
     * @ordered
     */
    protected String metaValue = MetaDataTypeImpl.META_VALUE_EDEFAULT;
     ...
     * @ordered
     */
    protected String name = MetaDataTypeImpl.NAME_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return Literals.META_DATA_TYPE;
    }
    ...
    public void setMetaValue(String newMetaValue) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(MetaDataTypeImpl.this, Notification.SET, DroolsPackage.META_DATA_TYPE__META_VALUE, oldMetaValue, metaValue));
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(MetaDataTypeImpl.this, Notification.SET, DroolsPackage.META_DATA_TYPE__NAME, oldName, name));
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            case DroolsPackage.META_DATA_TYPE__META_VALUE :
                setMetaValue(MetaDataTypeImpl.META_VALUE_EDEFAULT);
                return ;
            case DroolsPackage.META_DATA_TYPE__NAME :
                setName(MetaDataTypeImpl.NAME_EDEFAULT);
                return ;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            case DroolsPackage.META_DATA_TYPE__META_VALUE :
                return (MetaDataTypeImpl.META_VALUE_EDEFAULT) == null ? (metaValue) != null : !(MetaDataTypeImpl.META_VALUE_EDEFAULT.equals(metaValue));
            case DroolsPackage.META_DATA_TYPE__NAME :
                return (MetaDataTypeImpl.NAME_EDEFAULT) == null ? (name) != null : !(MetaDataTypeImpl.NAME_EDEFAULT.equals(name));
        }
