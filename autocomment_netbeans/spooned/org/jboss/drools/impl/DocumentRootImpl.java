...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
     ...
     * @ordered
     */
    protected String packageName = DocumentRootImpl.PACKAGE_NAME_EDEFAULT;
     ...
     * @ordered
     */
    protected BigInteger priority = DocumentRootImpl.PRIORITY_EDEFAULT;
     ...
     * @ordered
     */
    protected String ruleFlowGroup = DocumentRootImpl.RULE_FLOW_GROUP_EDEFAULT;
     ...
     * @ordered
     */
    protected String taskName = DocumentRootImpl.TASK_NAME_EDEFAULT;
     ...
     * @ordered
     */
    protected String version = DocumentRootImpl.VERSION_EDEFAULT;
    ...
    public FeatureMap getMixed() {
        if ((mixed) == null) {
            mixed = new org.eclipse.emf.ecore.util.BasicFeatureMap(DocumentRootImpl.this, DroolsPackage.DOCUMENT_ROOT__MIXED);
        } 
        return mixed;
    }
    ...
    public EMap<String, String> getXMLNSPrefixMap() {
        if ((xMLNSPrefixMap) == null) {
            xMLNSPrefixMap = new org.eclipse.emf.ecore.util.EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, DocumentRootImpl.this, DroolsPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
        } 
    ...
    public EMap<String, String> getXSISchemaLocation() {
        if ((xSISchemaLocation) == null) {
            xSISchemaLocation = new org.eclipse.emf.ecore.util.EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class, DocumentRootImpl.this, DroolsPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
        } 
    ...
    public void setPackageName(String newPackageName) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(DocumentRootImpl.this, Notification.SET, DroolsPackage.DOCUMENT_ROOT__PACKAGE_NAME, oldPackageName, packageName));
    ...
    public void setPriority(BigInteger newPriority) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(DocumentRootImpl.this, Notification.SET, DroolsPackage.DOCUMENT_ROOT__PRIORITY, oldPriority, priority));
    ...
    public void setRuleFlowGroup(String newRuleFlowGroup) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(DocumentRootImpl.this, Notification.SET, DroolsPackage.DOCUMENT_ROOT__RULE_FLOW_GROUP, oldRuleFlowGroup, ruleFlowGroup));
    ...
    public void setTaskName(String newTaskName) {
        ...
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(DocumentRootImpl.this, Notification.SET, DroolsPackage.DOCUMENT_ROOT__TASK_NAME, oldTaskName, taskName));
    ...
    public void setVersion(String newVersion) {
        ...
        version = newVersion;
        if (eNotificationRequired())
            eNotify(new org.eclipse.emf.ecore.impl.ENotificationImpl(DocumentRootImpl.this, Notification.SET, DroolsPackage.DOCUMENT_ROOT__VERSION, oldVersion, version));
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case DroolsPackage.DOCUMENT_ROOT__ON_EXIT_SCRIPT :
                ...
                return ;
            case DroolsPackage.DOCUMENT_ROOT__PACKAGE_NAME :
                setPackageName(DocumentRootImpl.PACKAGE_NAME_EDEFAULT);
                return ;
            case DroolsPackage.DOCUMENT_ROOT__PRIORITY :
                setPriority(DocumentRootImpl.PRIORITY_EDEFAULT);
                return ;
            case DroolsPackage.DOCUMENT_ROOT__RULE_FLOW_GROUP :
                setRuleFlowGroup(DocumentRootImpl.RULE_FLOW_GROUP_EDEFAULT);
                return ;
            case DroolsPackage.DOCUMENT_ROOT__TASK_NAME :
                setTaskName(DocumentRootImpl.TASK_NAME_EDEFAULT);
                return ;
            case DroolsPackage.DOCUMENT_ROOT__VERSION :
                setVersion(DocumentRootImpl.VERSION_EDEFAULT);
                return ;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case DroolsPackage.DOCUMENT_ROOT__PACKAGE_NAME :
                return (DocumentRootImpl.PACKAGE_NAME_EDEFAULT) == null ? (packageName) != null : !(DocumentRootImpl.PACKAGE_NAME_EDEFAULT.equals(packageName));
            case DroolsPackage.DOCUMENT_ROOT__PRIORITY :
                return (DocumentRootImpl.PRIORITY_EDEFAULT) == null ? (priority) != null : !(DocumentRootImpl.PRIORITY_EDEFAULT.equals(priority));
            case DroolsPackage.DOCUMENT_ROOT__RULE_FLOW_GROUP :
                return (DocumentRootImpl.RULE_FLOW_GROUP_EDEFAULT) == null ? (ruleFlowGroup) != null : !(DocumentRootImpl.RULE_FLOW_GROUP_EDEFAULT.equals(ruleFlowGroup));
            case DroolsPackage.DOCUMENT_ROOT__TASK_NAME :
                return (DocumentRootImpl.TASK_NAME_EDEFAULT) == null ? (taskName) != null : !(DocumentRootImpl.TASK_NAME_EDEFAULT.equals(taskName));
            case DroolsPackage.DOCUMENT_ROOT__VERSION :
                return (DocumentRootImpl.VERSION_EDEFAULT) == null ? (version) != null : !(DocumentRootImpl.VERSION_EDEFAULT.equals(version));
        }
