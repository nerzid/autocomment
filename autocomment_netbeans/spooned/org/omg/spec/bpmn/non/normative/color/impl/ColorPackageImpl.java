...
public class ColorPackageImpl extends EPackageImpl implements ColorPackage {
    ...
    public static ColorPackage init() {
        ...
        ColorPackageImpl.isInited = true;
        // Create package meta-data objects
        theColorPackage.createPackageContents();
        // Initialize created meta-data
        theColorPackage.initializePackageContents();
        // Register package validator
        EValidator.Registry.INSTANCE.put(theColorPackage, new EValidator.Descriptor() {
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getDocumentRoot_BackgroundColor(), ColorPackageImpl.this.getHexColor(), "backgroundColor", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEAttribute(getDocumentRoot_BorderColor(), ColorPackageImpl.this.getHexColor(), "borderColor", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
        initEAttribute(getDocumentRoot_Color(), ColorPackageImpl.this.getHexColor(), "color", null, 0, 1, null, (!(IS_TRANSIENT)), (!(IS_VOLATILE)), IS_CHANGEABLE, (!(IS_UNSETTABLE)), (!(IS_ID)), IS_UNIQUE, (!(IS_DERIVED)), IS_ORDERED);
    ...
    protected void createExtendedMetaDataAnnotations() {
        ...
        addAnnotation(getDocumentRoot_BackgroundColor(), source, new String[]{ "kind" , "attribute" , "name" , "background-color" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_BorderColor(), source, new String[]{ "kind" , "attribute" , "name" , "border-color" , "namespace" , "##targetNamespace" });
        addAnnotation(getDocumentRoot_Color(), source, new String[]{ "kind" , "attribute" , "name" , "color" , "namespace" , "##targetNamespace" });
        addAnnotation(hexColorEDataType, source, new String[]{ "name" , "HexColor" , "baseType" , "http://www.eclipse.org/emf/2003/XMLType#string" , "pattern" , "#[0-9a-fA-F]{6}" });
    }
}
