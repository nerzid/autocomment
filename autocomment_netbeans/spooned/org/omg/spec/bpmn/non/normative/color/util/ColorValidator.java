...
public class ColorValidator extends EObjectValidator {
     ...
     * @generated
     */
    protected static final int DIAGNOSTIC_CODE_COUNT = ColorValidator.GENERATED_DIAGNOSTIC_CODE_COUNT;
     ...
     */
    public static final PatternMatcher[][] HEX_COLOR__PATTERN__VALUES = new PatternMatcher[][]{ new PatternMatcher[]{ XMLTypeUtil.createPatternMatcher("#[0-9a-fA-F]{6}") } };
