...
public class AndFileFilter extends AbstractFileFilter implements Serializable , ConditionalFileFilter {
    ...
    public void addFileFilter(final IOFileFilter ioFileFilter) {
        AndFileFilter.this.fileFilters.add(ioFileFilter);
    }
    ...
    public List<IOFileFilter> getFileFilters() {
        return Collections.unmodifiableList(AndFileFilter.this.fileFilters);
    }
    ...
    public boolean removeFileFilter(final IOFileFilter ioFileFilter) {
        return AndFileFilter.this.fileFilters.remove(ioFileFilter);
    }
    ...
    public void setFileFilters(final List<IOFileFilter> fileFilters) {
        AndFileFilter.this.fileFilters.clear();
        AndFileFilter.this.fileFilters.addAll(fileFilters);
    }
    ...
    public boolean accept(final File file) {
        if (AndFileFilter.this.fileFilters.isEmpty()) {
            return false;
        } 
