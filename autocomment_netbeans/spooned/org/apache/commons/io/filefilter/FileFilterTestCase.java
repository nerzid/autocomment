...
public class FileFilterTestCase extends FileBasedTestCase {
    ...
    public void assertFiltering(final IOFileFilter filter, final File file, final boolean expected) throws Exception {
        ...
        Assert.assertEquals(((((("Filter(File) " + (filter.getClass().getName())) + " not ") + expected) + " for ") + file), expected, filter.accept(file));
        if ((file != null) && ((file.getParentFile()) != null)) {
            Assert.assertEquals(((((("Filter(File, String) " + (filter.getClass().getName())) + " not ") + expected) + " for ") + file), expected, filter.accept(file.getParentFile(), file.getName()));
        } else if (file == null) {
            Assert.assertEquals((((("Filter(File, String) " + (filter.getClass().getName())) + " not ") + expected) + " for null"), expected, filter.accept(file));
        } 
    ...
    public void testSuffix() throws Exception {
        ...
        assertFiltering(filter, new File("fred"), false);
        Assert.assertTrue(filter.accept(testFile.getParentFile(), testFile.getName()));
        Assert.assertTrue((!(filter.accept(fredFile.getParentFile(), fredFile.getName()))));
        final List<String> prefixes = Arrays.asList("ood", "red");
        final IOFileFilter listFilter = new SuffixFileFilter(prefixes);
        Assert.assertTrue((!(listFilter.accept(testFile.getParentFile(), testFile.getName()))));
        Assert.assertTrue(listFilter.accept(fredFile.getParentFile(), fredFile.getName()));
        try {
    ...
    public void testDirectory() throws Exception {
        ...
        Assert.assertSame(DirectoryFileFilter.DIRECTORY, DirectoryFileFilter.INSTANCE);
    }
    ...
    public void testNameFilter() throws Exception {
        ...
        assertFiltering(filter, new File("foo"), true);
        assertFiltering(filter, new File("bar"), true);
        assertFiltering(filter, new File("FOO"), FileFilterTestCase.WINDOWS);
        assertFiltering(filter, new File("BAR"), FileFilterTestCase.WINDOWS);
    ...
    public void testNameFilterNullArgument() throws Exception {
        ...
        try {
            ...
            Assert.fail("constructing a NameFileFilter with a null String argument should fail.");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testNameFilterNullListArgument() throws Exception {
        ...
        new NameFileFilter(test);
        Assert.fail("constructing a NameFileFilter with a null List argument should fail.");
    }
    ...
    public void testTrue() throws Exception {
        ...
        Assert.assertSame(TrueFileFilter.TRUE, TrueFileFilter.INSTANCE);
    }
    ...
    public void testFalse() throws Exception {
        ...
        Assert.assertSame(FalseFileFilter.FALSE, FalseFileFilter.INSTANCE);
    }
    ...
    public void testAnd() throws Exception {
        ...
        Assert.assertTrue(f.getFileFilters().isEmpty());
        Assert.assertNotNull(f.toString());// TODO better tests
    ...
    public void testOr() throws Exception {
        ...
        Assert.assertEquals(orFilter.getFileFilters(), filters);
        orFilter.removeFileFilter(trueFilter);
        assertFiltering(orFilter, testFile, false);
        orFilter.setFileFilters(filters);
        assertFiltering(orFilter, testFile, true);
        Assert.assertTrue(orFilter.accept(testFile.getParentFile(), testFile.getName()));
        orFilter.removeFileFilter(trueFilter);
        Assert.assertTrue((!(orFilter.accept(testFile.getParentFile(), testFile.getName()))));
        try {
    ...
    public void testDeprecatedWildcard() throws Exception {
        ...
        Assert.assertTrue(listFilter.accept(txtFile));
        Assert.assertTrue((!(listFilter.accept(bmpFile))));
        Assert.assertTrue((!(listFilter.accept(dir))));
        Assert.assertTrue(listFilter.accept(txtFile.getParentFile(), txtFile.getName()));
        Assert.assertTrue((!(listFilter.accept(bmpFile.getParentFile(), bmpFile.getName()))));
        Assert.assertTrue((!(listFilter.accept(dir.getParentFile(), dir.getName()))));
        try {
    ...
    public void testWildcard() throws Exception {
        ...
        assertFiltering(filter, new File("log.txt"), true);
        assertFiltering(filter, new File("log.TXT"), FileFilterTestCase.WINDOWS);
        ...
        assertFiltering(filter, new File("Test.java"), true);
        assertFiltering(filter, new File("Test.JAVA"), FileFilterTestCase.WINDOWS);
    ...
    public void testDelegateFileFilter() throws Exception {
        ...
        Assert.assertNotNull(filter.toString());// TODO better test
    ...
    public void testMakeSVNAware() throws Exception {
        ...
        File file = new File(getTestDirectory(), FileFilterTestCase.SVN_DIR_NAME);
        file.mkdirs();
        assertFiltering(filter1, file, false);
        assertFiltering(filter2, file, false);
        FileUtils.deleteDirectory(file);
        ...
        assertFiltering(filter1, file, true);
        assertFiltering(filter2, file, false);
        file = new File(getTestDirectory(), FileFilterTestCase.SVN_DIR_NAME);
        if (!(file.getParentFile().exists())) {
            throw new IOException((("Cannot create file " + file) + " as the parent directory does not exist"));
        } 
        final BufferedOutputStream output = new BufferedOutputStream(new FileOutputStream(file));
    ...
    public void testSizeFilter() throws Exception {
        ...
        final BufferedOutputStream output1 = new BufferedOutputStream(new FileOutputStream(smallFile));
        try {
    ...
    public void testHidden() throws Exception {
        final File hiddenDir = new File(FileFilterTestCase.SVN_DIR_NAME);
        if (hiddenDir.exists()) {
    ...
    public void testEmpty() throws Exception {
        ...
        final BufferedOutputStream output1 = new BufferedOutputStream(new FileOutputStream(emptyFile));
        try {
            TestUtils.generateTestData(output1, ((long) (0)));
        } finally {
            IOUtils.closeQuietly(output1);
        ...
        final BufferedOutputStream output = new BufferedOutputStream(new FileOutputStream(notEmptyFile));
        try {
            TestUtils.generateTestData(output, ((long) (32)));
        } finally {
            IOUtils.closeQuietly(output);
    ...
    public void testMakeDirectoryOnly() throws Exception {
        Assert.assertSame(DirectoryFileFilter.DIRECTORY, FileFilterUtils.makeDirectoryOnly(null));
    ...
    public void testMakeFileOnly() throws Exception {
        Assert.assertSame(FileFileFilter.FILE, FileFilterUtils.makeFileOnly(null));
    ...
    public void testFilterArray() throws Exception {
        ...
        Assert.assertEquals(fileA, filtered[0]);
    }
    ...
    public void testFilterList() throws Exception {
        ...
        Assert.assertTrue(filteredList.contains(fileA));
        Assert.assertFalse(filteredList.contains(fileB));
    }
    ...
    public void testFilterSet() throws Exception {
        ...
        Assert.assertTrue(filteredSet.contains(fileA));
        Assert.assertFalse(filteredSet.contains(fileB));
    }
    ...
    public void testFilterSetNullParameters() {
        ...
        Assert.assertEquals(0, filteredSet.size());
    }

    @Test
    public void testEnsureTestCoverage() {
        Assert.assertNotNull(new FileFilterUtils());// dummy for test coverage
    ...
    public void testDelegation() {
        ...
        Assert.assertNotNull(FileFilterUtils.asFileFilter(((FileFilter) (FalseFileFilter.INSTANCE))));
        Assert.assertNotNull(FileFilterUtils.asFileFilter(((FilenameFilter) (FalseFileFilter.INSTANCE))).toString());
    }
}
