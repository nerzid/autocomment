...
public class MagicNumberFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public MagicNumberFileFilter(final byte[] magicNumber, final long offset) {
        ...
        System.arraycopy(magicNumber, 0, MagicNumberFileFilter.this.magicNumbers, 0, magicNumber.length);
        this.byteOffset = offset;
    }
    ...
    public boolean accept(final File file) {
        if (((file != null) && (file.isFile())) && (file.canRead())) {
            ...
            try {
                final byte[] fileBytes = new byte[MagicNumberFileFilter.this.magicNumbers.length];
                ...
                return Arrays.equals(MagicNumberFileFilter.this.magicNumbers, fileBytes);
    ...
    public String toString() {
        ...
        // printable
        builder.append(",");
        builder.append(MagicNumberFileFilter.this.byteOffset);
        builder.append(")");
