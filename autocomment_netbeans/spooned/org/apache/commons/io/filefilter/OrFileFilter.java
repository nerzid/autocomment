...
public class OrFileFilter extends AbstractFileFilter implements Serializable , ConditionalFileFilter {
    ...
    public void addFileFilter(final IOFileFilter ioFileFilter) {
        OrFileFilter.this.fileFilters.add(ioFileFilter);
    }
    ...
    public List<IOFileFilter> getFileFilters() {
        return Collections.unmodifiableList(OrFileFilter.this.fileFilters);
    }
    ...
    public boolean removeFileFilter(final IOFileFilter ioFileFilter) {
        return OrFileFilter.this.fileFilters.remove(ioFileFilter);
    }
    ...
    public void setFileFilters(final List<IOFileFilter> fileFilters) {
        OrFileFilter.this.fileFilters.clear();
        OrFileFilter.this.fileFilters.addAll(fileFilters);
    }
