...
public class EndianUtils {
    ...
    public static long readSwappedLong(final byte[] data, final int offset) {
        final long low = EndianUtils.readSwappedInteger(data, offset);
        final long high = EndianUtils.readSwappedInteger(data, (offset + 4));
    ...
    public static int readSwappedUnsignedShort(final InputStream input) throws IOException {
        final int value1 = EndianUtils.read(input);
        final int value2 = EndianUtils.read(input);
    ...
    public static int readSwappedInteger(final InputStream input) throws IOException {
        final int value1 = EndianUtils.read(input);
        final int value2 = EndianUtils.read(input);
        final int value3 = EndianUtils.read(input);
        final int value4 = EndianUtils.read(input);
