...
public class TeeOutputStream extends ProxyOutputStream {
    ...
    public TeeOutputStream(final OutputStream out, final OutputStream branch) {
        super(out);
        TeeOutputStream.this.branch = branch;
    }
    ...
    public synchronized void write(final byte[] b) throws IOException {
        super.write(b);
        TeeOutputStream.this.branch.write(b);
    }
    ...
    public synchronized void write(final byte[] b, final int off, final int len) throws IOException {
        ...
        TeeOutputStream.this.branch.write(b, off, len);
    }
    ...
    public void flush() throws IOException {
        super.flush();
        TeeOutputStream.this.branch.flush();
    }
    ...
    public void close() throws IOException {
        try {
            ...
            TeeOutputStream.this.branch.close();
        }
    }
}
