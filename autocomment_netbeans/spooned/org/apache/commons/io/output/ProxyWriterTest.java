...
public class ProxyWriterTest {
    ...
    public void appendCharSequence() throws Exception {
        ...
        try {
            ...
            Assert.fail(("Appending CharSequence threw " + e));
        }
    ...
    public void appendChar() throws Exception {
        ...
        final ProxyWriter proxy = new ProxyWriter(writer);
        proxy.append('c');
        Assert.assertEquals("c", writer.toString());
        proxy.close();
    }
    ...
    public void writeString() throws Exception {
        ...
        try {
            ...
            Assert.fail(("Writing String threw " + e));
        }
        Assert.assertEquals("ABC", writer.toString());
        proxy.close();
    }
    ...
    public void writeCharArray() throws Exception {
        ...
        try {
            ...
            Assert.fail(("Writing char[] threw " + e));
        }
        Assert.assertEquals("ABC", writer.toString());
        proxy.close();
    }
    ...
    public void nullString() throws Exception {
        ...
        try {
            ...
            Assert.fail(("Writing null String threw " + e));
        }
        try {
    ...
    public void nullCharArray() throws Exception {
        ...
        try {
            ...
            Assert.fail(("Writing null char[] threw " + e));
        }
        try {
    ...
    public void nullCharSequencec() throws Exception {
        ...
        try {
            ...
            Assert.fail(("Appending null CharSequence threw " + e));
        }
        proxy.close();
    }
