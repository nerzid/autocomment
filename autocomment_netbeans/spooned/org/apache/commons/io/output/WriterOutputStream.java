...
public class WriterOutputStream extends OutputStream {
    ...
    public WriterOutputStream(final Writer writer, final CharsetDecoder decoder) {
        this(writer, decoder, WriterOutputStream.DEFAULT_BUFFER_SIZE, false);
    }
    ...
    public WriterOutputStream(final Writer writer, final Charset charset) {
        this(writer, charset, WriterOutputStream.DEFAULT_BUFFER_SIZE, false);
    }
    ...
    public WriterOutputStream(final Writer writer, final String charsetName) {
        this(writer, charsetName, WriterOutputStream.DEFAULT_BUFFER_SIZE, false);
    }
    ...
    public WriterOutputStream(final Writer writer) {
        this(writer, Charset.defaultCharset(), WriterOutputStream.DEFAULT_BUFFER_SIZE, false);
    }
