...
public class XmlStreamReader extends Reader {
    ...
    private static final ByteOrderMark[] XML_GUESS_BYTES = new ByteOrderMark[]{ new ByteOrderMark(XmlStreamReader.UTF_8, 60, 63, 120, 109) , new ByteOrderMark(XmlStreamReader.UTF_16BE, 0, 60, 0, 63) , new ByteOrderMark(XmlStreamReader.UTF_16LE, 60, 0, 63, 0) , new ByteOrderMark(XmlStreamReader.UTF_32BE, 0, 0, 0, 60, 0, 0, 0, 63, 0, 0, 0, 120, 0, 0, 0, 109) , new ByteOrderMark(XmlStreamReader.UTF_32LE, 60, 0, 0, 0, 63, 0, 0, 0, 120, 0, 0, 0, 109, 0, 0, 0) , new ByteOrderMark(XmlStreamReader.EBCDIC, 76, 111, 167, 148) };
    ...
    public XmlStreamReader(final InputStream is, final boolean lenient, final String defaultEncoding) throws IOException {
        ...
        final BOMInputStream bom = new BOMInputStream(new BufferedInputStream(is, XmlStreamReader.BUFFER_SIZE), false, XmlStreamReader.BOMS);
    ...
    String calculateRawEncoding(final String bomEnc, final String xmlGuessEnc, final String xmlEnc) throws IOException {
        ...
        if (bomEnc == null) {
            if ((xmlGuessEnc == null) || (xmlEnc == null)) {
                return (defaultEncoding) == null ? XmlStreamReader.UTF_8 : defaultEncoding;
            } 
            if ((xmlEnc.equals(XmlStreamReader.UTF_16)) && ((xmlGuessEnc.equals(XmlStreamReader.UTF_16BE)) || (xmlGuessEnc.equals(XmlStreamReader.UTF_16LE)))) {
                return xmlGuessEnc;
            } 
            return xmlEnc;
        } 
        // BOM is UTF-8
        if (bomEnc.equals(XmlStreamReader.UTF_8)) {
            if ((xmlGuessEnc != null) && (!(xmlGuessEnc.equals(XmlStreamReader.UTF_8)))) {
                final String msg = MessageFormat.format(XmlStreamReader.RAW_EX_1, bomEnc, xmlGuessEnc, xmlEnc);
        ...
        if ((bomEnc.equals(XmlStreamReader.UTF_16BE)) || (bomEnc.equals(XmlStreamReader.UTF_16LE))) {
        ...
        if ((bomEnc.equals(XmlStreamReader.UTF_32BE)) || (bomEnc.equals(XmlStreamReader.UTF_32LE))) {
            if ((xmlGuessEnc != null) && (!(xmlGuessEnc.equals(bomEnc)))) {
                final String msg = MessageFormat.format(XmlStreamReader.RAW_EX_1, bomEnc, xmlGuessEnc, xmlEnc);
                throw new XmlStreamReaderException(msg, bomEnc, xmlGuessEnc, xmlEnc);
            } 
        ...
        final String msg = MessageFormat.format(XmlStreamReader.RAW_EX_2, bomEnc, xmlGuessEnc, xmlEnc);
        throw new XmlStreamReaderException(msg, bomEnc, xmlGuessEnc, xmlEnc);
    }
    ...
    String calculateHttpEncoding(final String httpContentType, final String bomEnc, final String xmlGuessEnc, final String xmlEnc, final boolean lenient) throws IOException {
        ...
        if ((!appXml) && (!textXml)) {
            final String msg = MessageFormat.format(XmlStreamReader.HTTP_EX_3, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
        ...
        if (cTEnc == null) {
            if (appXml) {
                ...
                return (defaultEncoding) == null ? XmlStreamReader.US_ASCII : defaultEncoding;
            }
        } 
        // UTF-16BE or UTF-16LE content type encoding
        if ((cTEnc.equals(XmlStreamReader.UTF_16BE)) || (cTEnc.equals(XmlStreamReader.UTF_16LE))) {
            if (bomEnc != null) {
                final String msg = MessageFormat.format(XmlStreamReader.HTTP_EX_1, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
                throw new XmlStreamReaderException(msg, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
            } 
            return cTEnc;
        } 
        // UTF-16 content type encoding
        if (cTEnc.equals(XmlStreamReader.UTF_16)) {
            if ((bomEnc != null) && (bomEnc.startsWith(XmlStreamReader.UTF_16))) {
                return bomEnc;
            } 
            final String msg = MessageFormat.format(XmlStreamReader.HTTP_EX_2, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
            throw new XmlStreamReaderException(msg, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
        } 
        // UTF-32BE or UTF-132E content type encoding
        if ((cTEnc.equals(XmlStreamReader.UTF_32BE)) || (cTEnc.equals(XmlStreamReader.UTF_32LE))) {
            if (bomEnc != null) {
                final String msg = MessageFormat.format(XmlStreamReader.HTTP_EX_1, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
                throw new XmlStreamReaderException(msg, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
            } 
        ...
        if (cTEnc.equals(XmlStreamReader.UTF_32)) {
