...
public class ReaderInputStream extends InputStream {
    ...
    public ReaderInputStream(final Reader reader, final CharsetEncoder encoder) {
        this(reader, encoder, ReaderInputStream.DEFAULT_BUFFER_SIZE);
    }
    ...
    public ReaderInputStream(final Reader reader, final CharsetEncoder encoder, final int bufferSize) {
        ...
        ReaderInputStream.this.encoderIn.flip();
        this.encoderOut = ByteBuffer.allocate(128);
        ReaderInputStream.this.encoderOut.flip();
    }
    ...
    public ReaderInputStream(final Reader reader, final Charset charset) {
        this(reader, charset, ReaderInputStream.DEFAULT_BUFFER_SIZE);
    }
    ...
    public ReaderInputStream(final Reader reader, final String charsetName) {
        this(reader, charsetName, ReaderInputStream.DEFAULT_BUFFER_SIZE);
    }
