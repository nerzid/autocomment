...
public class ReversedLinesFileReaderTestSimple {
    ...
    public void testFileSizeIsExactMultipleOfBlockSize() throws IOException, URISyntaxException {
        ...
        final File testFile20Bytes = new File(ReversedLinesFileReaderTestSimple.this.getClass().getResource("/test-file-20byteslength.bin").toURI());
    ...
    public void testUnsupportedEncodingUTF16() throws IOException, URISyntaxException {
        final File testFileEmpty = new File(ReversedLinesFileReaderTestSimple.this.getClass().getResource("/test-file-empty.bin").toURI());
    ...
    public void testUnsupportedEncodingBig5() throws IOException, URISyntaxException {
        final File testFileEncodingBig5 = new File(ReversedLinesFileReaderTestSimple.this.getClass().getResource("/test-file-empty.bin").toURI());
