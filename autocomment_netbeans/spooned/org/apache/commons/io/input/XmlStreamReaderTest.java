...
public class XmlStreamReaderTest {
    ...
    protected void _testRawNoBomValid(final String encoding) throws Exception {
        InputStream is = getXmlStream("no-bom", XmlStreamReaderTest.XML1, encoding, encoding);
        XmlStreamReader xmlReader = new XmlStreamReader(is, false);
        assertEquals(xmlReader.getEncoding(), "UTF-8");
        xmlReader.close();
        is = getXmlStream("no-bom", XmlStreamReaderTest.XML2, encoding, encoding);
        xmlReader = new XmlStreamReader(is);
        assertEquals(xmlReader.getEncoding(), "UTF-8");
        xmlReader.close();
        is = getXmlStream("no-bom", XmlStreamReaderTest.XML3, encoding, encoding);
        xmlReader = new XmlStreamReader(is);
        assertEquals(xmlReader.getEncoding(), encoding);
        xmlReader.close();
        is = getXmlStream("no-bom", XmlStreamReaderTest.XML4, encoding, encoding);
        xmlReader = new XmlStreamReader(is);
        assertEquals(xmlReader.getEncoding(), encoding);
        xmlReader.close();
        is = getXmlStream("no-bom", XmlStreamReaderTest.XML5, encoding, encoding);
        xmlReader = new XmlStreamReader(is);
        assertEquals(xmlReader.getEncoding(), encoding);
        xmlReader.close();
    }
    ...
    protected void _testRawNoBomInvalid(final String encoding) throws Exception {
        final InputStream is = getXmlStream("no-bom", XmlStreamReaderTest.XML3, encoding, encoding);
        try {
    ...
    protected void _testRawBomValid(final String encoding) throws Exception {
        final InputStream is = getXmlStream((encoding + "-bom"), XmlStreamReaderTest.XML3, encoding, encoding);
    ...
    protected void _testRawBomInvalid(final String bomEnc, final String streamEnc, final String prologEnc) throws Exception {
        final InputStream is = getXmlStream(bomEnc, XmlStreamReaderTest.XML3, streamEnc, prologEnc);
    ...
    public void testRawContent() throws Exception {
        ...
        final String xml = getXML("no-bom", XmlStreamReaderTest.XML3, encoding, encoding);
    ...
    public void _testAlternateDefaultEncoding(final String cT, final String bomEnc, final String streamEnc, final String prologEnc, final String alternateEnc) throws Exception {
        final InputStream is = getXmlStream(bomEnc, (prologEnc == null ? XmlStreamReaderTest.XML1 : XmlStreamReaderTest.XML3), streamEnc, prologEnc);
    ...
    protected void _testHttpInvalid(final String cT, final String bomEnc, final String streamEnc, final String prologEnc) throws Exception {
        final InputStream is = getXmlStream(bomEnc, (prologEnc == null ? XmlStreamReaderTest.XML2 : XmlStreamReaderTest.XML3), streamEnc, prologEnc);
        try {
    ...
    public void testEncodingAttributeXML() throws Exception {
        final InputStream is = new ByteArrayInputStream(XmlStreamReaderTest.ENCODING_ATTRIBUTE_XML.getBytes("UTF-8"));
    ...
    static {
        XmlStreamReaderTest.BOMs.put("no-bom", XmlStreamReaderTest.NO_BOM_BYTES);
        XmlStreamReaderTest.BOMs.put("UTF-16BE-bom", XmlStreamReaderTest.UTF_16BE_BOM_BYTES);
        XmlStreamReaderTest.BOMs.put("UTF-16LE-bom", XmlStreamReaderTest.UTF_16LE_BOM_BYTES);
        XmlStreamReaderTest.BOMs.put("UTF-32BE-bom", XmlStreamReaderTest.UTF_32BE_BOM_BYTES);
        XmlStreamReaderTest.BOMs.put("UTF-32LE-bom", XmlStreamReaderTest.UTF_32LE_BOM_BYTES);
        XmlStreamReaderTest.BOMs.put("UTF-16-bom", XmlStreamReaderTest.NO_BOM_BYTES);// it's added by the writer
        
        XmlStreamReaderTest.BOMs.put("UTF-8-bom", XmlStreamReaderTest.UTF_8_BOM_BYTES);
    }
    ...
    static {
        XmlStreamReaderTest.XMLs.put(XmlStreamReaderTest.XML1, XmlStreamReaderTest.XML);
        XmlStreamReaderTest.XMLs.put(XmlStreamReaderTest.XML2, XmlStreamReaderTest.XML_WITH_PROLOG);
        XmlStreamReaderTest.XMLs.put(XmlStreamReaderTest.XML3, XmlStreamReaderTest.XML_WITH_PROLOG_AND_ENCODING_DOUBLE_QUOTES);
        XmlStreamReaderTest.XMLs.put(XmlStreamReaderTest.XML4, XmlStreamReaderTest.XML_WITH_PROLOG_AND_ENCODING_SINGLE_QUOTES);
        XmlStreamReaderTest.XMLs.put(XmlStreamReaderTest.XML5, XmlStreamReaderTest.XML_WITH_PROLOG_AND_ENCODING_SPACED_SINGLE_QUOTES);
    }
    ...
    protected InputStream getXmlStream(final String bomType, final String xmlType, final String streamEnc, final String prologEnc) throws IOException {
        ...
        int[] bom = XmlStreamReaderTest.BOMs.get(bomType);
        if (bom == null) {
            bom = new int[0];
        } 
    ...
    private String getXML(final String bomType, final String xmlType, final String streamEnc, final String prologEnc) {
        final MessageFormat xml = XmlStreamReaderTest.XMLs.get(xmlType);
        final String info = XmlStreamReaderTest.INFO.format(new Object[]{ bomType , xmlType , prologEnc });
