...
public class ReversedLinesFileReader implements Closeable {
    ...
    public ReversedLinesFileReader(final File file, final int blockSize, final Charset encoding) throws IOException {
        ...
        currentFilePart = new ReversedLinesFileReader.FilePart(totalBlockCount, lastBlockLength, null);
    }
    ...
    private class FilePart {
        ...
        private FilePart(final long no, final int length, final byte[] leftOverOfLastFilePart) throws IOException {
            ...
            ReversedLinesFileReader.FilePart.this.currentLastBytePos = (data.length) - 1;
            ReversedLinesFileReader.FilePart.this.leftOver = null;
        }
        ...
        private ReversedLinesFileReader.FilePart rollOver() throws IOException {
            ...
            if ((no) > 1) {
                return new ReversedLinesFileReader.FilePart(((no) - 1), blockSize, leftOver);
            } else {
