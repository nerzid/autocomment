...
public class XmlStreamReaderUtilitiesCompatibilityTest extends XmlStreamReaderUtilitiesTest {
    ...
    protected String calculateRawEncoding(final String bomEnc, final String xmlGuessEnc, final String xmlEnc, final String defaultEncoding) throws IOException {
        final XmlStreamReaderUtilitiesCompatibilityTest.MockXmlStreamReader mock = new XmlStreamReaderUtilitiesCompatibilityTest.MockXmlStreamReader(defaultEncoding);
    ...
    protected String calculateHttpEncoding(final String httpContentType, final String bomEnc, final String xmlGuessEnc, final String xmlEnc, final boolean lenient, final String defaultEncoding) throws IOException {
        final XmlStreamReaderUtilitiesCompatibilityTest.MockXmlStreamReader mock = new XmlStreamReaderUtilitiesCompatibilityTest.MockXmlStreamReader(defaultEncoding);
        String enc = mock.calculateHttpEncoding(XmlStreamReader.getContentTypeMime(httpContentType), XmlStreamReader.getContentTypeEncoding(httpContentType), bomEnc, xmlGuessEnc, xmlEnc, null, lenient);
        mock.close();
        return enc;
    }
