...
public class XmlStreamReader extends Reader {
    ...
    private void doLenientDetection(String httpContentType, XmlStreamReaderException ex) throws IOException {
        ...
        if (ex != null) {
            ...
            if (encoding == null) {
                encoding = ((defaultEncoding) == null) ? XmlStreamReader.UTF_8 : defaultEncoding;
            } 
    ...
    private void doRawStream(final InputStream is) throws IOException {
        final BufferedInputStream pis = new BufferedInputStream(is, XmlStreamReader.BUFFER_SIZE);
        final String bomEnc = XmlStreamReader.getBOMEncoding(pis);
        final String xmlGuessEnc = XmlStreamReader.getXMLGuessEncoding(pis);
        final String xmlEnc = XmlStreamReader.getXmlProlog(pis, xmlGuessEnc);
    ...
    private void doHttpStream(final InputStream is, final String httpContentType, final boolean lenient) throws IOException {
        final BufferedInputStream pis = new BufferedInputStream(is, XmlStreamReader.BUFFER_SIZE);
        final String cTMime = XmlStreamReader.getContentTypeMime(httpContentType);
        final String cTEnc = XmlStreamReader.getContentTypeEncoding(httpContentType);
        final String bomEnc = XmlStreamReader.getBOMEncoding(pis);
        final String xmlGuessEnc = XmlStreamReader.getXMLGuessEncoding(pis);
        final String xmlEnc = XmlStreamReader.getXmlProlog(pis, xmlGuessEnc);
    ...
    private void prepareReader(final InputStream is, final String encoding) throws IOException {
        ...
        XmlStreamReader.this.encoding = encoding;
    }
    ...
    String calculateRawEncoding(final String bomEnc, final String xmlGuessEnc, final String xmlEnc, final InputStream is) throws IOException {
        ...
        if (bomEnc == null) {
            if ((xmlGuessEnc == null) || (xmlEnc == null)) {
                encoding = ((defaultEncoding) == null) ? XmlStreamReader.UTF_8 : defaultEncoding;
            } else if ((xmlEnc.equals(XmlStreamReader.UTF_16)) && ((xmlGuessEnc.equals(XmlStreamReader.UTF_16BE)) || (xmlGuessEnc.equals(XmlStreamReader.UTF_16LE)))) {
                encoding = xmlGuessEnc;
            } else if ((xmlEnc.equals(XmlStreamReader.UTF_32)) && ((xmlGuessEnc.equals(XmlStreamReader.UTF_32BE)) || (xmlGuessEnc.equals(XmlStreamReader.UTF_32LE)))) {
                encoding = xmlGuessEnc;
            } else {
                encoding = xmlEnc;
            }
        } else if (bomEnc.equals(XmlStreamReader.UTF_8)) {
            if ((xmlGuessEnc != null) && (!(xmlGuessEnc.equals(XmlStreamReader.UTF_8)))) {
                throw new XmlStreamReaderException(XmlStreamReader.RAW_EX_1.format(new Object[]{ bomEnc , xmlGuessEnc , xmlEnc }), bomEnc, xmlGuessEnc, xmlEnc, is);
            } 
            if ((xmlEnc != null) && (!(xmlEnc.equals(XmlStreamReader.UTF_8)))) {
                throw new XmlStreamReaderException(XmlStreamReader.RAW_EX_1.format(new Object[]{ bomEnc , xmlGuessEnc , xmlEnc }), bomEnc, xmlGuessEnc, xmlEnc, is);
            } 
            encoding = XmlStreamReader.UTF_8;
        } else if ((bomEnc.equals(XmlStreamReader.UTF_16BE)) || (bomEnc.equals(XmlStreamReader.UTF_16LE))) {
            if ((xmlGuessEnc != null) && (!(xmlGuessEnc.equals(bomEnc)))) {
                throw new XmlStreamReaderException(XmlStreamReader.RAW_EX_1.format(new Object[]{ bomEnc , xmlGuessEnc , xmlEnc }), bomEnc, xmlGuessEnc, xmlEnc, is);
            } 
            if (((xmlEnc != null) && (!(xmlEnc.equals(XmlStreamReader.UTF_16)))) && (!(xmlEnc.equals(bomEnc)))) {
                throw new XmlStreamReaderException(XmlStreamReader.RAW_EX_1.format(new Object[]{ bomEnc , xmlGuessEnc , xmlEnc }), bomEnc, xmlGuessEnc, xmlEnc, is);
            } 
            encoding = bomEnc;
        } else if ((bomEnc.equals(XmlStreamReader.UTF_32BE)) || (bomEnc.equals(XmlStreamReader.UTF_32LE))) {
            if ((xmlGuessEnc != null) && (!(xmlGuessEnc.equals(bomEnc)))) {
                throw new XmlStreamReaderException(XmlStreamReader.RAW_EX_1.format(new Object[]{ bomEnc , xmlGuessEnc , xmlEnc }), bomEnc, xmlGuessEnc, xmlEnc, is);
            } 
            if (((xmlEnc != null) && (!(xmlEnc.equals(XmlStreamReader.UTF_32)))) && (!(xmlEnc.equals(bomEnc)))) {
                throw new XmlStreamReaderException(XmlStreamReader.RAW_EX_1.format(new Object[]{ bomEnc , xmlGuessEnc , xmlEnc }), bomEnc, xmlGuessEnc, xmlEnc, is);
            } 
            encoding = bomEnc;
        } else {
            throw new XmlStreamReaderException(XmlStreamReader.RAW_EX_2.format(new Object[]{ bomEnc , xmlGuessEnc , xmlEnc }), bomEnc, xmlGuessEnc, xmlEnc, is);
        }
        return encoding;
    }
    ...
    String calculateHttpEncoding(final String cTMime, final String cTEnc, final String bomEnc, final String xmlGuessEnc, final String xmlEnc, final InputStream is, final boolean lenient) throws IOException {
        ...
        if (lenient & (xmlEnc != null)) {
            ...
            final boolean appXml = XmlStreamReader.isAppXml(cTMime);
            final boolean textXml = XmlStreamReader.isTextXml(cTMime);
            if (appXml || textXml) {
                if (cTEnc == null) {
                    if (appXml) {
                        encoding = calculateRawEncoding(bomEnc, xmlGuessEnc, xmlEnc, is);
                    } else {
                        encoding = ((defaultEncoding) == null) ? XmlStreamReader.US_ASCII : defaultEncoding;
                    }
                } else if ((bomEnc != null) && ((cTEnc.equals(XmlStreamReader.UTF_16BE)) || (cTEnc.equals(XmlStreamReader.UTF_16LE)))) {
                    throw new XmlStreamReaderException(XmlStreamReader.HTTP_EX_1.format(new Object[]{ cTMime , cTEnc , bomEnc , xmlGuessEnc , xmlEnc }), cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc, is);
                } else if (cTEnc.equals(XmlStreamReader.UTF_16)) {
                    if ((bomEnc != null) && (bomEnc.startsWith(XmlStreamReader.UTF_16))) {
                        encoding = bomEnc;
                    } else {
                        throw new XmlStreamReaderException(XmlStreamReader.HTTP_EX_2.format(new Object[]{ cTMime , cTEnc , bomEnc , xmlGuessEnc , xmlEnc }), cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc, is);
                    }
                } else if ((bomEnc != null) && ((cTEnc.equals(XmlStreamReader.UTF_32BE)) || (cTEnc.equals(XmlStreamReader.UTF_32LE)))) {
                    throw new XmlStreamReaderException(XmlStreamReader.HTTP_EX_1.format(new Object[]{ cTMime , cTEnc , bomEnc , xmlGuessEnc , xmlEnc }), cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc, is);
                } else if (cTEnc.equals(XmlStreamReader.UTF_32)) {
                    if ((bomEnc != null) && (bomEnc.startsWith(XmlStreamReader.UTF_32))) {
                        encoding = bomEnc;
                    } else {
                        throw new XmlStreamReaderException(XmlStreamReader.HTTP_EX_2.format(new Object[]{ cTMime , cTEnc , bomEnc , xmlGuessEnc , xmlEnc }), cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc, is);
                    }
                ...
                throw new XmlStreamReaderException(XmlStreamReader.HTTP_EX_3.format(new Object[]{ cTMime , cTEnc , bomEnc , xmlGuessEnc , xmlEnc }), cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc, is);
            }
        }
        return encoding;
    }
    ...
    static String getBOMEncoding(final BufferedInputStream is) throws IOException {
        ...
        if (((bytes[0]) == 254) && ((bytes[1]) == 255)) {
            encoding = XmlStreamReader.UTF_16BE;
            is.reset();
            is.read();
            is.read();
        } else if (((bytes[0]) == 255) && ((bytes[1]) == 254)) {
            encoding = XmlStreamReader.UTF_16LE;
            is.reset();
            is.read();
            is.read();
    ...
    private static String getXMLGuessEncoding(final BufferedInputStream is) throws IOException {
        ...
        if (((((bytes[0]) == 0) && ((bytes[1]) == 60)) && ((bytes[2]) == 0)) && ((bytes[3]) == 63)) {
            ...
            encoding = XmlStreamReader.EBCDIC;
        } 
        return encoding;
    }
    ...
    private static String getXmlProlog(final BufferedInputStream is, final String guessedEnc) throws IOException {
        String encoding = null;
        if (guessedEnc != null) {
            final byte[] bytes = new byte[XmlStreamReader.BUFFER_SIZE];
            is.mark(XmlStreamReader.BUFFER_SIZE);
            int offset = 0;
            int max = XmlStreamReader.BUFFER_SIZE;
            int c = is.read(bytes, offset, max);
            int firstGT = -1;
            String xmlProlog = "";// avoid possible NPE warning (cannot happen; this just silences the warning)
            
            while (((c != (-1)) && (firstGT == (-1))) && (offset < (XmlStreamReader.BUFFER_SIZE))) {
                offset += c;
                max -= c;
