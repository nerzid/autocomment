...
public class NameFileComparator extends AbstractFileComparator implements Serializable {
     ...
     */
    public static final Comparator<File> NAME_REVERSE = new ReverseComparator(NameFileComparator.NAME_COMPARATOR);
     ...
     */
    public static final Comparator<File> NAME_INSENSITIVE_REVERSE = new ReverseComparator(NameFileComparator.NAME_INSENSITIVE_COMPARATOR);
     ...
     */
    public static final Comparator<File> NAME_SYSTEM_REVERSE = new ReverseComparator(NameFileComparator.NAME_SYSTEM_COMPARATOR);
