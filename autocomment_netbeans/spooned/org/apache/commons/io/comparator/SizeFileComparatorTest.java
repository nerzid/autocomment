...
public class SizeFileComparatorTest extends ComparatorAbstractTestCase {
    ...
    public void testNonexistantFile() {
        ...
        Assert.assertFalse(nonexistantFile.exists());
        Assert.assertTrue("less", ((comparator.compare(nonexistantFile, moreFile)) < 0));
    }
    ...
    public void testCompareDirectorySizes() {
        Assert.assertEquals("sumDirectoryContents=false", 0, comparator.compare(smallerDir, largerDir));
        Assert.assertEquals("less", (-1), SizeFileComparator.SIZE_SUMDIR_COMPARATOR.compare(smallerDir, largerDir));
        Assert.assertEquals("less", 1, SizeFileComparator.SIZE_SUMDIR_REVERSE.compare(smallerDir, largerDir));
    }
}
