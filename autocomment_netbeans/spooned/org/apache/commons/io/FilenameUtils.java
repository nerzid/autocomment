...
public class FilenameUtils {
    ...
    static boolean isSystemWindows() {
        return (FilenameUtils.SYSTEM_SEPARATOR) == (FilenameUtils.WINDOWS_SEPARATOR);
    }
    ...
    private static boolean isSeparator(final char ch) {
        return (ch == (FilenameUtils.UNIX_SEPARATOR)) || (ch == (FilenameUtils.WINDOWS_SEPARATOR));
    }
    ...
    public static String normalize(final String filename) {
        return FilenameUtils.doNormalize(filename, FilenameUtils.SYSTEM_SEPARATOR, true);
    }
    ...
    public static String normalizeNoEndSeparator(final String filename) {
        return FilenameUtils.doNormalize(filename, FilenameUtils.SYSTEM_SEPARATOR, false);
    }
