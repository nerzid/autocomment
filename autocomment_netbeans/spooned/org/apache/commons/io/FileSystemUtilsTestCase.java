...
public class FileSystemUtilsTestCase extends FileBasedTestCase {
    ...
    public void testGetFreeSpace_String() throws Exception {
        ...
        if ((File.separatorChar) == '/') {
            ...
            if (kilobyteBlock) {
                Assert.assertEquals(free, kb, 256.0);
            } else {
                Assert.assertEquals((free / 2.0), kb, 256.0);
            }
        } else {
            @SuppressWarnings(value = "deprecation")
            final long bytes = FileSystemUtils.freeSpace("");
            final long kb = FileSystemUtils.freeSpaceKb("");
            Assert.assertEquals((((double) (bytes)) / 1024), kb, 256.0);
        }
    }
    ...
    public void testGetFreeSpaceOS_String_Windows() throws Exception {
        ...
        Assert.assertEquals(12345L, fsu.freeSpaceOS("", 1, false, (-1)));
        Assert.assertEquals((12345L / 1024), fsu.freeSpaceOS("", 1, true, (-1)));
    }
    ...
    public void testGetFreeSpaceOS_String_Unix() throws Exception {
        ...
        Assert.assertEquals(54321L, fsu.freeSpaceOS("", 2, false, (-1)));
        Assert.assertEquals(12345L, fsu.freeSpaceOS("", 2, true, (-1)));
    }
    ...
    public void testGetFreeSpaceWindows_String_ParseCommaFormatBytes() throws Exception {
        ...
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(41411551232L, fsu.freeSpaceWindows("", (-1)));
    }
    ...
    public void testGetFreeSpaceWindows_String_EmptyPath() throws Exception {
        ...
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines, "dir /a /-c ");
        Assert.assertEquals(41411551232L, fsu.freeSpaceWindows("", (-1)));
    }
    ...
    public void testGetFreeSpaceWindows_String_NormalResponse() throws Exception {
        final String lines = " Volume in drive C is HDD\n" + (" Volume Serial Number is XXXX-YYYY\n" + ("\n" + (" Directory of C:\\Documents and Settings\\Xxxx\n" + ("\n" + ("19/08/2005  22:43    <DIR>          .\n" + ("19/08/2005  22:43    <DIR>          ..\n" + ("11/08/2005  01:07                81 build.properties\n" + ("17/08/2005  21:44    <DIR>          Desktop\n" + ("               7 File(s)         180260 bytes\n" + "              10 Dir(s)     41411551232 bytes free")))))))));
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines, "dir /a /-c \"C:\"");
        Assert.assertEquals(41411551232L, fsu.freeSpaceWindows("C:", (-1)));
    }

    @Test
    public void testGetFreeSpaceWindows_String_StripDrive() throws Exception {
        final String lines = " Volume in drive C is HDD\n" + (" Volume Serial Number is XXXX-YYYY\n" + ("\n" + (" Directory of C:\\Documents and Settings\\Xxxx\n" + ("\n" + ("19/08/2005  22:43    <DIR>          .\n" + ("19/08/2005  22:43    <DIR>          ..\n" + ("11/08/2005  01:07                81 build.properties\n" + ("17/08/2005  21:44    <DIR>          Desktop\n" + ("               7 File(s)         180260 bytes\n" + "              10 Dir(s)     41411551232 bytes free")))))))));
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines, "dir /a /-c \"C:\\somedir\"");
        Assert.assertEquals(41411551232L, fsu.freeSpaceWindows("C:\\somedir", (-1)));
    }
    ...
    public void testGetFreeSpaceWindows_String_NoSuchDirectoryResponse() throws Exception {
        ...
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(1, lines);
        fsu.freeSpaceWindows("C:", (-1));
    }
    ...
    public void testGetFreeSpaceUnix_String_NormalResponseLinux() throws Exception {
        ...
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(189416L, fsu.freeSpaceUnix("/", false, false, (-1)));
    }
    ...
    public void testGetFreeSpaceUnix_String_NormalResponseFreeBSD() throws Exception {
        ...
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(15770L, fsu.freeSpaceUnix("/", false, false, (-1)));
    }
    ...
    public void testGetFreeSpaceUnix_String_NormalResponseKbLinux() throws Exception {
        ...
        final String lines = "Filesystem           1K-blocks      Used Available Use% Mounted on\n" + "/dev/xxx                497944    308528    189416  62% /";
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(189416L, fsu.freeSpaceUnix("/", true, false, (-1)));
    }
    ...
    public void testGetFreeSpaceUnix_String_NormalResponseKbFreeBSD() throws Exception {
        ...
        final String lines = "Filesystem  1K-blocks      Used    Avail Capacity  Mounted on\n" + "/dev/xxxxxx    128990    102902    15770    87%    /";
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(15770L, fsu.freeSpaceUnix("/", true, false, (-1)));
    }
    ...
    public void testGetFreeSpaceUnix_String_NormalResponseKbSolaris() throws Exception {
        ...
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(481163L, fsu.freeSpaceUnix("/dev/dsk/x0x0x0x0", true, false, (-1)));
    }
    ...
    public void testGetFreeSpaceUnix_String_LongResponse() throws Exception {
        ...
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(1472504L, fsu.freeSpaceUnix("/home/users/s", false, false, (-1)));
    }
    ...
    public void testGetFreeSpaceUnix_String_LongResponseKb() throws Exception {
        final String lines = "Filesystem           1K-blocks      Used Available Use% Mounted on\n" + ("xxx-yyyyyyy-zzz:/home/users/s\n" + "                      14428928  12956424   1472504  90% /home/users/s");
        final FileSystemUtils fsu = new FileSystemUtilsTestCase.MockFileSystemUtils(0, lines);
        Assert.assertEquals(1472504L, fsu.freeSpaceUnix("/home/users/s", true, false, (-1)));
    }
    ...
    static class MockFileSystemUtils extends FileSystemUtils {
        ...
        Process openProcess(final String[] params) {
            if ((cmd) != null) {
                Assert.assertEquals(cmd, params[((params.length) - 1)]);
            } 
            return new Process() {
                @Override
