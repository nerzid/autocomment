...
public final class FileAlterationMonitor implements Runnable {
    ...
    public synchronized void setThreadFactory(final ThreadFactory threadFactory) {
        FileAlterationMonitor.this.threadFactory = threadFactory;
    }
    ...
    public synchronized void start() throws Exception {
        ...
        if ((threadFactory) != null) {
            thread = threadFactory.newThread(FileAlterationMonitor.this);
        } else {
            thread = new Thread(FileAlterationMonitor.this);
        }
        thread.start();
    }
