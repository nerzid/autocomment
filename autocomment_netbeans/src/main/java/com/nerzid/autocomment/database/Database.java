...
public class Database {
    ...
    private static void createWordGroupTable() {
        ...
        try {
            psmt = conn.prepareStatement(""
                    ...
                    + MethodModel.COLUMN_ORIGINAL + " " + MethodModel.COLUMN_ORIGINAL_FIELD + ","
    ...
    private static void createParameterGroupTable() throws SQLException {
        PreparedStatement psmt = conn.prepareStatement(""
                ...
                + ParameterModel.COLUMN_ORIGINAL + " " + ParameterModel.COLUMN_ORIGINAL_FIELD + ","
    ...
    private static void createDataTypeTable() throws SQLException {
        PreparedStatement psmt = conn.prepareStatement(""
                ...
                + DataTypeModel.COLUMN_ORIGINAL + " " + DataTypeModel.COLUMN_ORIGINAL_FIELD + ","
